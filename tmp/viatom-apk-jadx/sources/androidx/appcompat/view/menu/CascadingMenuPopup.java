...
final class CascadingMenuPopup extends MenuPopup implements MenuPresenter, View.OnKeyListener, PopupWindow.OnDismissListener {
    ...
    private int getNextMenuPosition(int i10) {
        ListView listView = ((CascadingMenuInfo) a.e(1, this.mShowingMenus)).getListView();
        int[] iArr = new int[2];
    ...
    private void showMenu(@NonNull MenuBuilder menuBuilder) {
        ...
        if (this.mShowingMenus.size() > 0) {
            cascadingMenuInfo = (CascadingMenuInfo) a.e(1, this.mShowingMenus);
        ...
        if (viewFindParentViewForSubmenu != null) {
            ...
            if ((this.mDropDownGravity & 5) != 5) {
                width = z9 ? i10 + viewFindParentViewForSubmenu.getWidth() : i10 - iMeasureIndividualMenuWidth;
                ...
                width = i10 + iMeasureIndividualMenuWidth;
                menuPopupWindowCreatePopupWindow.setHorizontalOffset(width);
                menuPopupWindowCreatePopupWindow.setOverlapAnchor(true);
                menuPopupWindowCreatePopupWindow.setVerticalOffset(i11);
            } else {
    ...
    public ListView getListView() {
        ...
        return ((CascadingMenuInfo) a.e(1, this.mShowingMenus)).getListView();
    }
