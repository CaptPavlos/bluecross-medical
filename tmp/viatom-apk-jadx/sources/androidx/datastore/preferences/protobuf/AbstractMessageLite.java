...
public abstract class AbstractMessageLite<MessageType extends AbstractMessageLite<MessageType, BuilderType>, BuilderType extends Builder<MessageType, BuilderType>> implements MessageLite {
    ...
    public byte[] toByteArray() {
        try {
            ...
            androidx.privacysandbox.ads.adservices.adid.a.l(getSerializingExceptionMessage("byte array"), e);
            return null;
        }
    }
    ...
    public ByteString toByteString() {
        try {
            ...
            androidx.privacysandbox.ads.adservices.adid.a.l(getSerializingExceptionMessage("ByteString"), e);
            return null;
        }
    }
    ...
    public static abstract class Builder<MessageType extends AbstractMessageLite<MessageType, BuilderType>, BuilderType extends Builder<MessageType, BuilderType>> implements MessageLite.Builder {
        ...
        public BuilderType mergeFrom(ByteString byteString) throws InvalidProtocolBufferException {
            try {
                ...
                androidx.privacysandbox.ads.adservices.adid.a.l(getReadingExceptionMessage("ByteString"), e3);
                return null;
            }
        }
        ...
        public BuilderType mergeFrom(byte[] bArr, int i10, int i11) throws InvalidProtocolBufferException {
            try {
                ...
                androidx.privacysandbox.ads.adservices.adid.a.l(getReadingExceptionMessage("byte array"), e3);
                return null;
            }
        }
        ...
        public BuilderType mergeFrom(MessageLite messageLite) {
            ...
            a.n("mergeFrom(MessageLite) can only merge messages of the same type.");
            return null;
        }
