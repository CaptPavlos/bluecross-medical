...
public abstract class GeneratedMessageLite<MessageType extends GeneratedMessageLite<MessageType, BuilderType>, BuilderType extends Builder<MessageType, BuilderType>> extends AbstractMessageLite<MessageType, BuilderType> {
    ...
    public static class GeneratedExtension<ContainingType extends MessageLite, Type> extends ExtensionLite<ContainingType, Type> {
        ...
        public GeneratedExtension(ContainingType containingtype, Type type, MessageLite messageLite, ExtensionDescriptor extensionDescriptor, Class cls) {
            if (containingtype == null) {
                a.n("Null containingTypeDefaultInstance");
                throw null;
            }
            if (extensionDescriptor.getLiteType() == WireFormat.FieldType.MESSAGE && messageLite == null) {
                a.n("Null messageDefaultInstance");
                throw null;
            }
    ...
    public static final class SerializedForm implements Serializable {
        ...
        public Object readResolve() throws ObjectStreamException, NoSuchFieldException, SecurityException {
            try {
                ...
                androidx.privacysandbox.ads.adservices.adid.a.l("Unable to understand proto buffer", e);
                return null;
            } catch (ClassNotFoundException e3) {
                androidx.privacysandbox.ads.adservices.adid.a.k("Unable to find proto buffer class: ", this.messageClassName, e3);
                return null;
            } catch (IllegalAccessException e7) {
                androidx.privacysandbox.ads.adservices.adid.a.l("Unable to call parsePartialFrom", e7);
                return null;
            } catch (NoSuchFieldException e10) {
                androidx.privacysandbox.ads.adservices.adid.a.k("Unable to find DEFAULT_INSTANCE in ", this.messageClassName, e10);
                return null;
            } catch (SecurityException e11) {
                androidx.privacysandbox.ads.adservices.adid.a.k("Unable to call DEFAULT_INSTANCE in ", this.messageClassName, e11);
                return null;
            }
        }
    }
    ...
    public static <T extends GeneratedMessageLite<?, ?>> T getDefaultInstance(Class<T> cls) throws ClassNotFoundException {
        ...
        T t9 = (T) ((GeneratedMessageLite) UnsafeUtil.allocateInstance(cls)).getDefaultInstanceForType();
        if (t9 != null) {
    ...
    public static <ContainingType extends MessageLite, Type> GeneratedExtension<ContainingType, Type> newRepeatedGeneratedExtension(ContainingType containingtype, MessageLite messageLite, Internal.EnumLiteMap<?> enumLiteMap, int i10, WireFormat.FieldType fieldType, boolean z9, Class cls) {
        return new GeneratedExtension<>(containingtype, Collections.EMPTY_LIST, messageLite, new ExtensionDescriptor(enumLiteMap, i10, fieldType, true, z9), cls);
    }
    ...
    private static <T extends GeneratedMessageLite<T, ?>> T parsePartialDelimitedFrom(T t, InputStream inputStream, ExtensionRegistryLite extensionRegistryLite) throws IOException {
        try {
            ...
            T t9 = (T) parsePartialFrom(t, codedInputStreamNewInstance, extensionRegistryLite);
            try {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static <T extends GeneratedMessageLite<T, ?>> T parsePartialFrom(T t, byte[] bArr, int i10, int i11, ExtensionRegistryLite extensionRegistryLite) throws InvalidProtocolBufferException {
        if (i11 == 0) {
            return t;
        }
        T t9 = (T) t.newMutableInstance();
        try {
            Schema schemaSchemaFor = Protobuf.getInstance().schemaFor((Protobuf) t9);
            schemaSchemaFor.mergeFrom(t9, bArr, i10, i10 + i11, new ArrayDecoders.Registers(extensionRegistryLite));
            ...
            throw invalidProtocolBufferException.setUnfinishedMessage(t9);
        } catch (UninitializedMessageException e3) {
            throw e3.asInvalidProtocolBufferException().setUnfinishedMessage(t9);
        } catch (IOException e7) {
            if (e7.getCause() instanceof InvalidProtocolBufferException) {
                throw ((InvalidProtocolBufferException) e7.getCause());
            }
            throw new InvalidProtocolBufferException(e7).setUnfinishedMessage(t9);
    ...
    public int getSerializedSize(Schema schema) {
        if (isMutable()) {
            ...
            c.g(a3.a.f(iComputeSerializedSize, "serialized size must be non-negative, was "));
            return 0;
        }
    ...
    public void setMemoizedSerializedSize(int i10) {
        if (i10 < 0) {
            c.g(a3.a.f(i10, "serialized size must be non-negative, was "));
        } else {
    ...
    public static abstract class Builder<MessageType extends GeneratedMessageLite<MessageType, BuilderType>, BuilderType extends Builder<MessageType, BuilderType>> extends AbstractMessageLite.Builder<MessageType, BuilderType> {
        ...
        public Builder(MessageType messagetype) {
            ...
            if (messagetype.isMutable()) {
                a.n("Default instance must be immutable.");
                throw null;
            }
    ...
    public static abstract class ExtendableBuilder<MessageType extends ExtendableMessage<MessageType, BuilderType>, BuilderType extends ExtendableBuilder<MessageType, BuilderType>> extends Builder<MessageType, BuilderType> implements ExtendableMessageOrBuilder<MessageType, BuilderType> {
        ...
        private void verifyExtensionContainingType(GeneratedExtension<MessageType, ?> generatedExtension) {
            ...
            a.n("This extension is for a different message type.  Please make sure that you are not suppressing any generics type warnings.");
        }
    ...
    private static <T extends GeneratedMessageLite<T, ?>> T parsePartialFrom(T t, ByteString byteString, ExtensionRegistryLite extensionRegistryLite) throws InvalidProtocolBufferException {
        ...
        T t9 = (T) parsePartialFrom(t, codedInputStreamNewCodedInput, extensionRegistryLite);
        try {
