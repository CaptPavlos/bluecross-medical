...
public abstract class FragmentStatePagerAdapter extends PagerAdapter {
    ...
    public void destroyItem(@NonNull ViewGroup viewGroup, int i10, @NonNull Object obj) {
        ...
        arrayList.set(i10, fragment.isAdded() ? this.mFragmentManager.saveFragmentInstanceState(fragment) : null);
    ...
    public Parcelable saveState() {
        ...
        for (int i10 = 0; i10 < this.mFragments.size(); i10++) {
            ...
            if (fragment != null && fragment.isAdded()) {
                ...
                this.mFragmentManager.putFragment(bundle, a3.a.f(i10, "f"), fragment);
            }
        }
        return bundle;
    }
    ...
    public void startUpdate(@NonNull ViewGroup viewGroup) {
        ...
        androidx.core.view.accessibility.a.s(this, "ViewPager with adapter ", " requires a view id");
    }
