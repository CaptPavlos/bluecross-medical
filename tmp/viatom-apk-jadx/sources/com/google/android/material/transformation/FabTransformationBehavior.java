...
public abstract class FabTransformationBehavior extends ExpandableTransformationBehavior {
    ...
    private void createExpansionAnimation(@NonNull View view, View view2, boolean z9, boolean z10, @NonNull FabTransformationSpec fabTransformationSpec, float f, float f10, @NonNull List<Animator> list, @NonNull List<Animator.AnimatorListener> list2) {
        ...
        if (view2 instanceof CircularRevealWidget) {
            ...
            if (z9) {
                ...
                createPreFillRadialExpansion(view2, timing.getDelay(), i10, i11, f11, list);
    ...
    private void createPostFillRadialExpansion(View view, long j10, long j11, long j12, int i10, int i11, float f, @NonNull List<Animator> list) {
        long j13 = j10 + j11;
        if (j13 < j12) {
    ...
    private void createPreFillRadialExpansion(View view, long j10, int i10, int i11, float f, @NonNull List<Animator> list) {
        if (j10 > 0) {
            Animator animatorCreateCircularReveal = ViewAnimationUtils.createCircularReveal(view, i10, i11, f, f);
    ...
    public boolean layoutDependsOn(@NonNull CoordinatorLayout coordinatorLayout, @NonNull View view, @NonNull View view2) {
        if (view.getVisibility() == 8) {
            c.g("This behavior cannot be attached to a GONE view. Set the view to INVISIBLE instead.");
            return false;
        }
