...
final class Utf8 {
    ...
    public static class UnpairedSurrogateException extends IllegalArgumentException {
        public UnpairedSurrogateException(int i10, int i11) {
            super(a.u(i10, i11, "Unpaired surrogate at index ", " of "));
        }
    }
    ...
    public static abstract class Processor {
        ...
        public abstract int encodeUtf8(String str, byte[] bArr, int i10, int i11);
        ...
        public final void encodeUtf8Default(String str, ByteBuffer byteBuffer) {
            ...
            while (i11 < length) {
                try {
                    ...
                    androidx.core.view.accessibility.a.d(str.charAt(i11), Math.max(i11, (iPosition - byteBuffer.position()) + 1) + byteBuffer.position());
                    return;
                }
            }
            if (i11 == length) {
    ...
    public static final class UnsafeProcessor extends Processor {
        ...
        public String decodeUtf8Direct(ByteBuffer byteBuffer, int i10, int i11) throws InvalidProtocolBufferException {
            ...
            while (jAddressOffset < j10) {
                ...
                if (DecodeUtil.isOneByte(b11)) {
                    ...
                    jAddressOffset += 2;
                    DecodeUtil.handleTwoBytes(b11, UnsafeUtil.getByte(j11), cArr, i14);
                    i14++;
                } else if (DecodeUtil.isThreeBytes(b11)) {
                    if (j11 >= j10 - 1) {
                        throw InvalidProtocolBufferException.invalidUtf8();
                    ...
                    jAddressOffset += 3;
                    i12 = i14 + 1;
                    DecodeUtil.handleThreeBytes(b11, UnsafeUtil.getByte(j11), UnsafeUtil.getByte(j12), cArr, i14);
                } else {
                    if (j11 >= j10 - 2) {
                        throw InvalidProtocolBufferException.invalidUtf8();
                    }
                    ...
                    jAddressOffset += 4;
                    DecodeUtil.handleFourBytes(b11, b13, b14, UnsafeUtil.getByte(j13), cArr, i14);
                    i14 += 2;
                }
                i14 = i12;
            }
        ...
        @Override // androidx.datastore.preferences.protobuf.Utf8.Processor
        public int encodeUtf8(String str, byte[] bArr, int i10, int i11) {
            long j10;
            long j11;
            int i12;
            char cCharAt;
            ...
            if (length > i11 || bArr.length - i11 < i10) {
                androidx.core.view.accessibility.a.d(str.charAt(length - 1), i10 + i11);
                return 0;
            }
            int i13 = 0;
            while (true) {
            ...
            while (i13 < length) {
                ...
                if (cCharAt2 < 128 && j12 < j13) {
                    ...
                    if ((cCharAt2 >= 55296 && 57343 >= cCharAt2) || j12 > j13 - 3) {
                        ...
                        if (i14 != length) {
                            ...
                            if (Character.isSurrogatePair(cCharAt2, cCharAt3)) {
                                ...
                                UnsafeUtil.putByte(bArr, j12 + j11, (byte) (((codePoint >>> 12) & 63) | 128));
                                long j14 = j12 + 3;
                                UnsafeUtil.putByte(bArr, 2 + j12, (byte) (((codePoint >>> 6) & 63) | 128));
                                j12 += 4;
                    ...
                    long j15 = 2 + j12;
                    UnsafeUtil.putByte(bArr, j12 + j11, (byte) (((cCharAt2 >>> 6) & 63) | 128));
                    j12 += 3;
        ...
        public void encodeUtf8Direct(String str, ByteBuffer byteBuffer) {
            ...
            if (length > jLimit - jPosition) {
                androidx.core.view.accessibility.a.d(str.charAt(length - 1), byteBuffer.limit());
                return;
            }
            int i11 = 0;
            while (true) {
            ...
            while (i11 < length) {
                ...
                if (cCharAt2 < c10 && jPosition < jLimit) {
                    ...
                    j11 = j10;
                    long j15 = jPosition + j11;
                    UnsafeUtil.putByte(jPosition, (byte) ((cCharAt2 >>> 6) | 960));
                    jPosition += 2;
                    UnsafeUtil.putByte(j15, (byte) ((cCharAt2 & '?') | c10));
                    j12 = jAddressOffset;
                }
                c11 = c10;
                i11++;
