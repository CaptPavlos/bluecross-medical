...
class MetadataListReader {
    ...
    public static class InputStreamOpenTypeReader implements OpenTypeReader {
        ...
        private void read(@IntRange(from = FabTransformationScrimBehavior.COLLAPSE_DELAY, to = 4) int i10) throws IOException {
            if (this.mInputStream.read(this.mByteArray, 0, i10) == i10) {
                this.mPosition += i10;
            } else {
                com.google.gson.internal.a.m("read failed");
            }
        }
        ...
        public void skip(int i10) throws IOException {
            while (i10 > 0) {
                ...
                if (iSkip < 1) {
                    com.google.gson.internal.a.m("Skip didn't move at least 1 byte forward");
                    return;
                } else {
                    i10 -= iSkip;
    ...
    private static OffsetInfo findOffsetInfo(OpenTypeReader openTypeReader) throws IOException {
        ...
        if (unsignedShort > 100) {
            com.google.gson.internal.a.m("Cannot read metadata.");
            return null;
        }
