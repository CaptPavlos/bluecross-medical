...
public abstract class NavigationBarMenuView extends ViewGroup implements MenuView {
    ...
    private NavigationBarItemView createMenuItem(int i10, MenuItemImpl menuItemImpl, boolean z9, boolean z10) {
        ...
        int i14 = this.iconLabelHorizontalSpacing;
        if (i14 != -1) {
    ...
    private boolean isMenuStructureSame() {
        ...
        while (true) {
            ...
            if ((this.menu.getItemAt(i10) instanceof DividerMenuItem) && !(this.buttons[i10] instanceof NavigationBarDividerView)) {
                return false;
            }
            boolean z9 = this.menu.getItemAt(i10).hasSubMenu() && !(this.buttons[i10] instanceof NavigationBarSubheaderView);
            boolean z10 = (this.menu.getItemAt(i10).hasSubMenu() || (this.buttons[i10] instanceof NavigationBarItemView)) ? false : true;
            if (!(this.menu.getItemAt(i10) instanceof DividerMenuItem) && (z9 || z10)) {
                break;
            }
            i10++;
        }
    ...
    private void removeUnusedBadges() {
        ...
        for (int i10 = 0; i10 < this.menu.size(); i10++) {
            hashSet.add(Integer.valueOf(this.menu.getItemAt(i10).getItemId()));
        }
    ...
    public void buildMenuView() {
        ...
        for (int i11 = 0; i11 < size; i11++) {
            ...
            if (z9) {
                ...
                if (size2 > 0) {
                    a.n("Only one layer of submenu is supported; a submenu inside a submenu is not supported by the Navigation Bar.");
                    return;
                }
                ...
                size2--;
                navigationBarItemViewCreateMenuItem = createMenuItem(i11, (MenuItemImpl) itemAt, zIsShifting, true);
            } else {
                MenuItemImpl menuItemImpl = (MenuItemImpl) itemAt;
                boolean z10 = i10 >= this.collapsedMaxItemCount;
                i10++;
                navigationBarItemViewCreateMenuItem = createMenuItem(i11, menuItemImpl, zIsShifting, z10);
            }
            if (!z9 && itemAt.isCheckable() && this.selectedItemPosition == -1) {
                this.selectedItemPosition = i11;
            }
            this.buttons[i11] = navigationBarItemViewCreateMenuItem;
    ...
    public void setCollapsedMaxItemCount(int i10) {
        this.collapsedMaxItemCount = i10;
    }
    ...
    public void setHorizontalItemTextAppearanceActive(@StyleRes int i10) {
        this.horizontalItemTextAppearanceActive = i10;
        NavigationBarMenuItemView[] navigationBarMenuItemViewArr = this.buttons;
        if (navigationBarMenuItemViewArr != null) {
            for (NavigationBarMenuItemView navigationBarMenuItemView : navigationBarMenuItemViewArr) {
                if (navigationBarMenuItemView instanceof NavigationBarItemView) {
    ...
    public void setHorizontalItemTextAppearanceInactive(@StyleRes int i10) {
        this.horizontalItemTextAppearanceInactive = i10;
        NavigationBarMenuItemView[] navigationBarMenuItemViewArr = this.buttons;
        if (navigationBarMenuItemViewArr != null) {
            for (NavigationBarMenuItemView navigationBarMenuItemView : navigationBarMenuItemViewArr) {
                if (navigationBarMenuItemView instanceof NavigationBarItemView) {
    ...
    public void setItemActiveIndicatorExpandedHeight(@Px int i10) {
        this.itemActiveIndicatorExpandedHeight = i10;
        NavigationBarMenuItemView[] navigationBarMenuItemViewArr = this.buttons;
        if (navigationBarMenuItemViewArr != null) {
            for (NavigationBarMenuItemView navigationBarMenuItemView : navigationBarMenuItemViewArr) {
                if (navigationBarMenuItemView instanceof NavigationBarItemView) {
    ...
    public void setItemActiveIndicatorExpandedMarginHorizontal(@Px int i10) {
        this.itemActiveIndicatorExpandedMarginHorizontal = i10;
        NavigationBarMenuItemView[] navigationBarMenuItemViewArr = this.buttons;
        if (navigationBarMenuItemViewArr != null) {
            for (NavigationBarMenuItemView navigationBarMenuItemView : navigationBarMenuItemViewArr) {
                if (navigationBarMenuItemView instanceof NavigationBarItemView) {
    ...
    public void setItemActiveIndicatorExpandedWidth(@Px int i10) {
        this.itemActiveIndicatorExpandedWidth = i10;
        NavigationBarMenuItemView[] navigationBarMenuItemViewArr = this.buttons;
        if (navigationBarMenuItemViewArr != null) {
            for (NavigationBarMenuItemView navigationBarMenuItemView : navigationBarMenuItemViewArr) {
                if (navigationBarMenuItemView instanceof NavigationBarItemView) {
    ...
    public void updateMenuView() {
        ...
        for (int i12 = 0; i12 < size; i12++) {
            this.presenter.setUpdateSuspended(true);
            this.buttons[i12].setExpanded(this.expanded);
            NavigationBarMenuItemView navigationBarMenuItemView = this.buttons[i12];
            if (navigationBarMenuItemView instanceof NavigationBarItemView) {
                NavigationBarItemView navigationBarItemView = (NavigationBarItemView) navigationBarMenuItemView;
            ...
            if (this.menu.getItemAt(i12) instanceof MenuItemImpl) {
                this.buttons[i12].initialize((MenuItemImpl) this.menu.getItemAt(i12), 0);
            }
            this.presenter.setUpdateSuspended(false);
        }
    }
