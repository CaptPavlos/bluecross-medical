...
public class CoordinatorLayout extends ViewGroup implements NestedScrollingParent2, NestedScrollingParent3 {
    ...
    public CoordinatorLayout(@NonNull Context context, @Nullable AttributeSet attributeSet, @AttrRes int i10) {
        ...
        if (Build.VERSION.SDK_INT < 29) {
            ...
            context2 = context;
            coordinatorLayout = this;
            coordinatorLayout.saveAttributeDataForStyleable(context2, R.styleable.CoordinatorLayout, attributeSet, typedArrayObtainStyledAttributes, i10, 0);
        }
        ...
        if (resourceId != 0) {
            ...
            for (int i11 = 0; i11 < length; i11++) {
                coordinatorLayout.mKeylines[i11] = (int) (r12[i11] * f);
            }
        }
    ...
    public static Behavior parseBehavior(Context context, AttributeSet attributeSet, String str) throws NoSuchMethodException, SecurityException {
        ...
        try {
            ...
            a.l("Could not inflate Behavior subclass ".concat(str), e);
            return null;
        }
    }
    ...
    */
    ...
    public void onLayoutChild(@NonNull View view, int i10) {
        ...
        if (layoutParams.checkAnchorChanged()) {
            c.g("An anchor may not be changed after CoordinatorLayout measurement begins before layout is complete.");
            return;
        }
    ...
    */
    ...
    public static abstract class Behavior<V extends View> {
        ...
        public boolean onNestedFling(@NonNull CoordinatorLayout coordinatorLayout, @NonNull V v6, @NonNull View view, float f, float f10, boolean z9) {
            return false;
        }
        ...
        public void onNestedPreScroll(@NonNull CoordinatorLayout coordinatorLayout, @NonNull V v6, @NonNull View view, int i10, int i11, @NonNull int[] iArr, int i12) {
            if (i12 == 0) {
                onNestedPreScroll(coordinatorLayout, v6, view, i10, i11, iArr);
            }
        }
        ...
        public void onNestedScroll(@NonNull CoordinatorLayout coordinatorLayout, @NonNull V v6, @NonNull View view, int i10, int i11, int i12, int i13, int i14, @NonNull int[] iArr) {
            iArr[0] = iArr[0] + i12;
            iArr[1] = iArr[1] + i13;
            onNestedScroll(coordinatorLayout, v6, view, i10, i11, i12, i13, i14);
        }

        public void onNestedScrollAccepted(@NonNull CoordinatorLayout coordinatorLayout, @NonNull V v6, @NonNull View view, @NonNull View view2, int i10, int i11) {
            if (i11 == 0) {
                onNestedScrollAccepted(coordinatorLayout, v6, view, view2, i10);
            }
        }

        public boolean onRequestChildRectangleOnScreen(@NonNull CoordinatorLayout coordinatorLayout, @NonNull V v6, @NonNull Rect rect, boolean z9) {
            return false;
        }
        ...
        public boolean onStartNestedScroll(@NonNull CoordinatorLayout coordinatorLayout, @NonNull V v6, @NonNull View view, @NonNull View view2, int i10, int i11) {
            if (i11 == 0) {
                return onStartNestedScroll(coordinatorLayout, v6, view, view2, i10);
            }
            return false;
        }

        public void onStopNestedScroll(@NonNull CoordinatorLayout coordinatorLayout, @NonNull V v6, @NonNull View view, int i10) {
            if (i10 == 0) {
        ...
        @Deprecated
        public void onNestedPreScroll(@NonNull CoordinatorLayout coordinatorLayout, @NonNull V v6, @NonNull View view, int i10, int i11, @NonNull int[] iArr) {
        }

        @Deprecated
        public void onNestedScrollAccepted(@NonNull CoordinatorLayout coordinatorLayout, @NonNull V v6, @NonNull View view, @NonNull View view2, int i10) {
        }
        ...
        @Deprecated
        public boolean onStartNestedScroll(@NonNull CoordinatorLayout coordinatorLayout, @NonNull V v6, @NonNull View view, @NonNull View view2, int i10) {
            return false;
        }

        @Deprecated
        public void onNestedScroll(@NonNull CoordinatorLayout coordinatorLayout, @NonNull V v6, @NonNull View view, int i10, int i11, int i12, int i13, int i14) {
            if (i14 == 0) {
                onNestedScroll(coordinatorLayout, v6, view, i10, i11, i12, i13);
            }
        }

        @Deprecated
        public void onNestedScroll(@NonNull CoordinatorLayout coordinatorLayout, @NonNull V v6, @NonNull View view, int i10, int i11, int i12, int i13) {
        }
    ...
    public static class LayoutParams extends ViewGroup.MarginLayoutParams {
        ...
        private void resolveAnchorView(View view, CoordinatorLayout coordinatorLayout) {
            ...
            if (viewFindViewById == coordinatorLayout) {
                if (!coordinatorLayout.isInEditMode()) {
                    c.g("View can not be anchored to the the parent CoordinatorLayout");
                    return;
                } else {
                    this.mAnchorDirectChild = null;
                    this.mAnchorView = null;
            ...
            for (ViewParent parent = viewFindViewById.getParent(); parent != coordinatorLayout && parent != null; parent = parent.getParent()) {
                if (parent == view) {
                    if (!coordinatorLayout.isInEditMode()) {
                        c.g("Anchor must not be a descendant of the anchored view");
                        return;
                    } else {
                        this.mAnchorDirectChild = null;
                        this.mAnchorView = null;
        ...
        public void setNestedScrollAccepted(int i10, boolean z9) {
            if (i10 == 0) {
