...
public final class BrowserServiceFileProvider extends FileProvider {
    ...
    private static Uri generateUri(Context context, String str) {
        return new Uri.Builder().scheme(CONTENT_SCHEME).authority(context.getPackageName() + AUTHORITY_SUFFIX).path(a.x(FILE_SUB_DIR_NAME, str, FILE_EXTENSION)).build();
    }
    ...
    public static b loadBitmap(@NonNull final ContentResolver contentResolver, @NonNull final Uri uri) {
        ...
        AsyncTask.THREAD_POOL_EXECUTOR.execute(new Runnable() { // from class: androidx.browser.browseractions.BrowserServiceFileProvider.1
            ...
            public void run() throws IOException {
                try {
                    ParcelFileDescriptor parcelFileDescriptorOpenFileDescriptor = contentResolver.openFileDescriptor(uri, CampaignEx.JSON_KEY_AD_R);
    ...
    public static ResolvableFuture<Uri> saveBitmap(@NonNull Context context, @NonNull Bitmap bitmap, @NonNull String str, int i10) {
        ...
        sbW.append(Integer.toString(i10));
