...
public abstract class IntSet {
    ...
    public static /* synthetic */ String joinToString$default(IntSet intSet, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i10, CharSequence charSequence4, l lVar, int i11, Object obj) {
        int i12;
        if (obj != null) {
                ...
                if ((((~j10) << 7) & j10 & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    while (i18 < i17) {
                        if ((j10 & 255) < 128) {
                            ...
                            i12 = i16;
                            sb.append((CharSequence) lVar.invoke(Integer.valueOf(i19)));
                            i15++;
                        } else {
                            i12 = i16;
                        }
        ...
        while (true) {
            ...
            if ((((~j10) << 7) & j10 & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i12 = 0; i12 < i11; i12++) {
                    if ((255 & j10) < 128 && !((Boolean) lVar.invoke(Integer.valueOf(iArr[(i10 << 3) + i12]))).booleanValue()) {
                        return false;
                    }
                    j10 >>= 8;
                }
    ...
    */
    public final boolean any(g7.l r15) {
        ...
        L55:
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.collection.IntSet.any(g7.l):boolean");
    }
        ...
        while (true) {
            ...
            if ((((~j10) << 7) & j10 & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i13 = 0; i13 < i12; i13++) {
                    if ((255 & j10) < 128 && ((Boolean) lVar.invoke(Integer.valueOf(iArr[(i10 << 3) + i13]))).booleanValue()) {
                        i11++;
                    }
                    j10 >>= 8;
                }
    ...
    */
    ...
    public final int findElementIndex$collection(int i10) {
        ...
        while (true) {
            ...
            for (long j12 = (~j11) & (j11 - ScatterMapKt.BitmaskLsb) & (-9187201950435737472L); j12 != 0; j12 &= j12 - 1) {
                ...
                if (this.elements[iNumberOfTrailingZeros] == i10) {
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final int first(g7.l r15) {
        /*
            r14 = this;
            r15.getClass()
            int[] r0 = r14.elements
        ...
        L54:
            ...
            return r15
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.collection.IntSet.first(g7.l):int");
    }
