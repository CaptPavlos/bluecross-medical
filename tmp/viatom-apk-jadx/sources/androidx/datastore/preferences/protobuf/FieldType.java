    ...
    private static java.lang.reflect.Type getListParameter(Class<?> cls, java.lang.reflect.Type[] typeArr) {
        while (true) {
            ...
            if (cls == List.class) {
                ...
                a.j("Unable to identify parameter type for List<T>");
                return null;
            }
            ...
            if (!(genericSuperList instanceof ParameterizedType)) {
                ...
                for (int i11 = 0; i11 < actualTypeArguments.length; i11++) {
                    ...
                    if (type instanceof TypeVariable) {
                        ...
                        androidx.privacysandbox.ads.adservices.adid.a.i(type, "Unable to find replacement for ");
                        return null;
                    }
                }
