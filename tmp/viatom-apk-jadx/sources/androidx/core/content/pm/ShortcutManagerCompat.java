...
public class ShortcutManagerCompat {
    ...
    public static boolean addDynamicShortcuts(@NonNull Context context, @NonNull List<ShortcutInfoCompat> list) {
        ...
        if (i10 >= 25) {
            ...
            if (!b.e(context.getSystemService(b.l())).addDynamicShortcuts(arrayList)) {
                return false;
            }
        }
    ...
    public static Intent createShortcutResultIntent(@NonNull Context context, @NonNull ShortcutInfoCompat shortcutInfoCompat) {
        Intent intentCreateShortcutResultIntent = Build.VERSION.SDK_INT >= 26 ? b.e(context.getSystemService(b.l())).createShortcutResultIntent(shortcutInfoCompat.toShortcutInfo()) : null;
    ...
    public static void disableShortcuts(@NonNull Context context, @NonNull List<String> list, @Nullable CharSequence charSequence) {
        if (Build.VERSION.SDK_INT >= 25) {
            b.e(context.getSystemService(b.l())).disableShortcuts(list, charSequence);
        }
    ...
    public static void enableShortcuts(@NonNull Context context, @NonNull List<ShortcutInfoCompat> list) {
        ...
        if (Build.VERSION.SDK_INT >= 25) {
            ...
            b.e(context.getSystemService(b.l())).enableShortcuts(arrayList);
        }
        getShortcutInfoSaverInstance(context).addShortcuts(listRemoveShortcutsExcludedFromSurface);
        Iterator<ShortcutInfoChangeListener> it2 = getShortcutInfoListeners(context).iterator();
        while (it2.hasNext()) {
    ...
    public static List<ShortcutInfoCompat> getDynamicShortcuts(@NonNull Context context) {
        ...
        List<ShortcutInfo> dynamicShortcuts = b.e(context.getSystemService(b.l())).getDynamicShortcuts();
        ArrayList arrayList = new ArrayList(dynamicShortcuts.size());
        Iterator<ShortcutInfo> it = dynamicShortcuts.iterator();
        while (it.hasNext()) {
            arrayList.add(new ShortcutInfoCompat.Builder(context, b.d(it.next())).build());
        }
        return arrayList;
    }
    ...
    public static int getIconMaxHeight(@NonNull Context context) {
        ...
        return Build.VERSION.SDK_INT >= 25 ? b.e(context.getSystemService(b.l())).getIconMaxHeight() : getIconDimensionInternal(context, false);
    }

    public static int getIconMaxWidth(@NonNull Context context) {
        Preconditions.checkNotNull(context);
        return Build.VERSION.SDK_INT >= 25 ? b.e(context.getSystemService(b.l())).getIconMaxWidth() : getIconDimensionInternal(context, true);
    }

    public static int getMaxShortcutCountPerActivity(@NonNull Context context) {
        Preconditions.checkNotNull(context);
        if (Build.VERSION.SDK_INT >= 25) {
            return b.e(context.getSystemService(b.l())).getMaxShortcutCountPerActivity();
        }
        return 5;
    }
    ...
    public static List<ShortcutInfoCompat> getShortcuts(@NonNull Context context, int i10) {
        ...
        if (i11 >= 30) {
            return ShortcutInfoCompat.fromShortcuts(context, b.e(context.getSystemService(b.l())).getShortcuts(i10));
        }
        if (i11 < 25) {
            if ((i10 & 2) != 0) {
                try {
        ...
        ShortcutManager shortcutManagerE = b.e(context.getSystemService(b.l()));
        ArrayList arrayList = new ArrayList();
        if ((i10 & 1) != 0) {
            arrayList.addAll(shortcutManagerE.getManifestShortcuts());
        }
        if ((i10 & 2) != 0) {
            arrayList.addAll(shortcutManagerE.getDynamicShortcuts());
        }
        if ((i10 & 4) != 0) {
            arrayList.addAll(shortcutManagerE.getPinnedShortcuts());
        }
    ...
    public static boolean isRateLimitingActive(@NonNull Context context) {
        Preconditions.checkNotNull(context);
        return Build.VERSION.SDK_INT >= 25 ? b.e(context.getSystemService(b.l())).isRateLimitingActive() : getShortcuts(context, 3).size() == getMaxShortcutCountPerActivity(context);
    }

    public static boolean isRequestPinShortcutSupported(@NonNull Context context) {
        if (Build.VERSION.SDK_INT >= 26) {
            return b.e(context.getSystemService(b.l())).isRequestPinShortcutSupported();
        }
    ...
    public static boolean pushDynamicShortcut(@NonNull Context context, @NonNull ShortcutInfoCompat shortcutInfoCompat) {
        ...
        if (i10 >= 30) {
            b.e(context.getSystemService(b.l())).pushDynamicShortcut(shortcutInfoCompat.toShortcutInfo());
        } else if (i10 >= 25) {
            ShortcutManager shortcutManagerE = b.e(context.getSystemService(b.l()));
            if (shortcutManagerE.isRateLimitingActive()) {
                return false;
            }
            List<ShortcutInfo> dynamicShortcuts = shortcutManagerE.getDynamicShortcuts();
            if (dynamicShortcuts.size() >= maxShortcutCountPerActivity) {
                shortcutManagerE.removeDynamicShortcuts(Arrays.asList(Api25Impl.getShortcutInfoWithLowestRank(dynamicShortcuts)));
            }
            shortcutManagerE.addDynamicShortcuts(Arrays.asList(shortcutInfoCompat.toShortcutInfo()));
        }
    ...
    public static void removeAllDynamicShortcuts(@NonNull Context context) {
        if (Build.VERSION.SDK_INT >= 25) {
            b.e(context.getSystemService(b.l())).removeAllDynamicShortcuts();
        }
    ...
    public static void removeDynamicShortcuts(@NonNull Context context, @NonNull List<String> list) {
        if (Build.VERSION.SDK_INT >= 25) {
            b.e(context.getSystemService(b.l())).removeDynamicShortcuts(list);
        }
        getShortcutInfoSaverInstance(context).removeShortcuts(list);
        Iterator<ShortcutInfoChangeListener> it = getShortcutInfoListeners(context).iterator();
        while (it.hasNext()) {
    ...
    public static void removeLongLivedShortcuts(@NonNull Context context, @NonNull List<String> list) {
        ...
        b.e(context.getSystemService(b.l())).removeLongLivedShortcuts(list);
        getShortcutInfoSaverInstance(context).removeShortcuts(list);
        Iterator<ShortcutInfoChangeListener> it = getShortcutInfoListeners(context).iterator();
        while (it.hasNext()) {
            it.next().onShortcutRemoved(list);
    ...
    public static void reportShortcutUsed(@NonNull Context context, @NonNull String str) {
        ...
        if (Build.VERSION.SDK_INT >= 25) {
            b.e(context.getSystemService(b.l())).reportShortcutUsed(str);
        }
        Iterator<ShortcutInfoChangeListener> it = getShortcutInfoListeners(context).iterator();
        while (it.hasNext()) {
    ...
    public static boolean requestPinShortcut(@NonNull Context context, @NonNull ShortcutInfoCompat shortcutInfoCompat, @Nullable final IntentSender intentSender) throws PackageManager.NameNotFoundException {
        ...
        if (i10 >= 26) {
            return b.e(context.getSystemService(b.l())).requestPinShortcut(shortcutInfoCompat.toShortcutInfo(), intentSender);
        }
    ...
    public static boolean setDynamicShortcuts(@NonNull Context context, @NonNull List<ShortcutInfoCompat> list) {
        ...
        if (Build.VERSION.SDK_INT >= 25) {
            ...
            if (!b.e(context.getSystemService(b.l())).setDynamicShortcuts(arrayList)) {
                return false;
            }
        }
        getShortcutInfoSaverInstance(context).removeAllShortcuts();
    ...
    public static boolean updateShortcuts(@NonNull Context context, @NonNull List<ShortcutInfoCompat> list) {
        ...
        if (i10 >= 25) {
            ...
            if (!b.e(context.getSystemService(b.l())).updateShortcuts(arrayList)) {
                return false;
            }
        }
        getShortcutInfoSaverInstance(context).addShortcuts(listRemoveShortcutsExcludedFromSurface);
