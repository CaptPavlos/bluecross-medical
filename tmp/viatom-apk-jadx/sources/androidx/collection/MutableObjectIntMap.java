...
public final class MutableObjectIntMap<K> extends ObjectIntMap<K> {
    ...
    private final void resizeStorage(int i10) {
        ...
        while (i13 < i12) {
            if (((jArr[i13 >> 3] >> ((i13 & 7) << 3)) & 255) < 128) {
                ...
                iArr2[iFindFirstAvailableSlot] = iArr[i11];
            } else {
                i11 = i13;
            }
            i13 = i11 + 1;
    ...
    public final int getOrPut(K k10, g7.a aVar) {
        aVar.getClass();
    ...
    public final int put(K k10, int i10, int i11) {
        ...
        if (iFindIndex < 0) {
            ...
            i11 = this.values[iFindIndex];
        }
        this.keys[iFindIndex] = k10;
        this.values[iFindIndex] = i10;
        return i11;
    }
        ...
        while (true) {
            ...
            if ((((~j10) << 7) & j10 & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i12 = 0; i12 < i11; i12++) {
                    if ((255 & j10) < 128) {
                        int i13 = (i10 << 3) + i12;
                        if (((Boolean) pVar.invoke(this.keys[i13], Integer.valueOf(this.values[i13]))).booleanValue()) {
                            removeValueAt(i13);
                        }
                    }
                    j10 >>= 8;
    ...
    public /* synthetic */ MutableObjectIntMap(int i10, int i11, g gVar) {
        this((i11 & 1) != 0 ? 6 : i10);
    }
