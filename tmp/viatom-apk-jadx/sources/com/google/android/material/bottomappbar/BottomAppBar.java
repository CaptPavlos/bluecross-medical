...
public class BottomAppBar extends Toolbar implements CoordinatorLayout.AttachedBehavior {
    ...
    private void createMenuViewTranslationAnimation(final int i10, final boolean z9, @NonNull List<Animator> list) {
        ...
        if (Math.abs(actionMenuView.getTranslationX() - getActionMenuViewTranslationX(actionMenuView, i10, z9)) <= 1.0f) {
            ...
            objectAnimatorOfFloat.addListener(new AnimatorListenerAdapter() { // from class: com.google.android.material.bottomappbar.BottomAppBar.7
                ...
                public void onAnimationEnd(Animator animator) {
                    ...
                    BottomAppBar.this.translateActionMenuView(actionMenuView, i10, z9, z10);
                }
            });
    ...
    public void dispatchAnimationEnd() {
        ...
        int i11 = 0;
        while (i11 < size) {
            AnimationListener animationListener = arrayList.get(i11);
            i11++;
    ...
    public float getFabTranslationX(int i10) {
        ...
        View viewFindDependentView = findDependentView();
        int i11 = zIsLayoutRtl ? this.leftInset : this.rightInset;
        return ((getMeasuredWidth() / 2) - ((this.fabAlignmentModeEndMargin == -1 || viewFindDependentView == null) ? this.fabOffsetEndMode + i11 : ((viewFindDependentView.getMeasuredWidth() / 2) + this.fabAlignmentModeEndMargin) + i11)) * (zIsLayoutRtl ? -1 : 1);
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void maybeAnimateMenuView(int i10, boolean z9) {
        if (!isLaidOut()) {
            this.menuAnimatingWithFabAlignmentMode = false;
        ...
        createMenuViewTranslationAnimation(i10, z9, arrayList);
        AnimatorSet animatorSet = new AnimatorSet();
    ...
    private void maybeAnimateModeChange(int i10) {
        if (this.fabAlignmentMode == i10 || !isLaidOut()) {
            return;
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void translateActionMenuView(@NonNull final ActionMenuView actionMenuView, final int i10, final boolean z9, boolean z10) {
        Runnable runnable = new Runnable() { // from class: com.google.android.material.bottomappbar.BottomAppBar.8
            @Override // java.lang.Runnable
            public void run() {
                actionMenuView.setTranslationX(BottomAppBar.this.getActionMenuViewTranslationX(r0, i10, z9));
            }
        };
        if (z10) {
    ...
    public int getActionMenuViewTranslationX(@NonNull ActionMenuView actionMenuView, int i10, boolean z9) throws Resources.NotFoundException {
        int dimensionPixelOffset = 0;
        if (this.menuAlignmentMode != 1 && (i10 != 1 || !z9)) {
            return 0;
        }
        boolean zIsLayoutRtl = ViewUtils.isLayoutRtl(this);
        ...
        int i12 = zIsLayoutRtl ? this.rightInset : -this.leftInset;
    ...
    private void translateActionMenuView(@NonNull ActionMenuView actionMenuView, int i10, boolean z9) {
        translateActionMenuView(actionMenuView, i10, z9, false);
    }
