...
public class TypedArrayUtils {
    ...
    public static boolean getBoolean(@NonNull TypedArray typedArray, @StyleableRes int i10, @StyleableRes int i11, boolean z9) {
        return typedArray.getBoolean(i10, typedArray.getBoolean(i11, z9));
    }
    ...
    public static boolean getNamedBoolean(@NonNull TypedArray typedArray, @NonNull XmlPullParser xmlPullParser, @NonNull String str, @StyleableRes int i10, boolean z9) {
        return !hasAttribute(xmlPullParser, str) ? z9 : typedArray.getBoolean(i10, z9);
    }
    ...
    public static float getNamedFloat(@NonNull TypedArray typedArray, @NonNull XmlPullParser xmlPullParser, @NonNull String str, @StyleableRes int i10, float f) {
        return !hasAttribute(xmlPullParser, str) ? f : typedArray.getFloat(i10, f);
    }
