...
final class SingleSampleMediaPeriod implements MediaPeriod, Loader.Callback<SourceLoadable> {
    ...
    public SingleSampleMediaPeriod(DataSpec dataSpec, DataSource.Factory factory, Format format, long j10, int i10, MediaSourceEventListener.EventDispatcher eventDispatcher, boolean z9) {
    ...
    public final void onLoadCanceled(SourceLoadable sourceLoadable, long j10, long j11, boolean z9) {
    ...
    @Override // com.mbridge.msdk.playercommon.exoplayer2.upstream.Loader.Callback
    public final int onLoadError(SourceLoadable sourceLoadable, long j10, long j11, IOException iOException) {
        int i10 = this.errorCount + 1;
        this.errorCount = i10;
        boolean z9 = this.treatLoadErrorsAsEndOfStream && i10 >= this.minLoadableRetryCount;
        this.eventDispatcher.loadError(sourceLoadable.dataSpec, 1, -1, this.format, 0, null, 0L, this.durationUs, j10, j11, sourceLoadable.sampleSize, iOException, z9);
        if (!z9) {
            return 0;
        }
        this.loadingFinished = true;
