...
public abstract class SimpleDecoderAudioRenderer extends BaseRenderer implements MediaClock {
    ...
    public SimpleDecoderAudioRenderer(Handler handler, AudioRendererEventListener audioRendererEventListener, DrmSessionManager<ExoMediaCrypto> drmSessionManager, boolean z9, AudioSink audioSink) {
        super(1);
    ...
    private boolean shouldWaitForKeys(boolean z9) throws ExoPlaybackException {
        DrmSession<ExoMediaCrypto> drmSession = this.drmSession;
        if (drmSession == null || (!z9 && this.playClearSamplesWithoutKeys)) {
            return false;
        }
    ...
    @Override // com.mbridge.msdk.playercommon.exoplayer2.BaseRenderer
    public void onPositionReset(long j10, boolean z9) throws InterruptedException, ExoPlaybackException {
    ...
    public SimpleDecoderAudioRenderer(Handler handler, AudioRendererEventListener audioRendererEventListener, AudioCapabilities audioCapabilities, DrmSessionManager<ExoMediaCrypto> drmSessionManager, boolean z9, AudioProcessor... audioProcessorArr) {
        this(handler, audioRendererEventListener, drmSessionManager, z9, new DefaultAudioSink(audioCapabilities, audioProcessorArr));
    }
