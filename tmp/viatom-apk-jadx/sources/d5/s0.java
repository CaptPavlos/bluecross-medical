...
public final class s0 implements ViewBinding {
    ...
    public final RelativeLayout f7330a;
    ...
    public final ImageView f7334i;

    /* renamed from: j, reason: collision with root package name */
    public final ImageView f7335j;

    /* renamed from: k, reason: collision with root package name */
    public final ImageView f7336k;

    /* renamed from: l, reason: collision with root package name */
    public final LinearLayout f7337l;

    /* renamed from: m, reason: collision with root package name */
    public final LinearLayout f7338m;
    ...
    public final TextView f7341p;

    /* renamed from: q, reason: collision with root package name */
    public final TextView f7342q;

    /* renamed from: r, reason: collision with root package name */
    public final TextView f7343r;

    /* renamed from: s, reason: collision with root package name */
    public final TextView f7344s;
    public final UsernameTextView t;

    public s0(RelativeLayout relativeLayout, ImageView imageView, ImageView imageView2, ImageView imageView3, ImageView imageView4, ImageView imageView5, ImageView imageView6, ImageView imageView7, ImageView imageView8, ImageView imageView9, ImageView imageView10, LinearLayout linearLayout, LinearLayout linearLayout2, TextView textView, TextView textView2, TextView textView3, TextView textView4, TextView textView5, TextView textView6, UsernameTextView usernameTextView) {
        this.f7330a = relativeLayout;
        this.f7331b = imageView;
        this.f7332c = imageView2;
        this.f7333d = imageView3;
        this.e = imageView4;
        this.f = imageView5;
        this.g = imageView6;
        this.h = imageView7;
        this.f7334i = imageView8;
        this.f7335j = imageView9;
        this.f7336k = imageView10;
        this.f7337l = linearLayout;
        this.f7338m = linearLayout2;
        this.f7339n = textView;
        this.f7340o = textView2;
        this.f7341p = textView3;
        this.f7342q = textView4;
        this.f7343r = textView5;
        this.f7344s = textView6;
                                                                                    ...
                                                                                    if (textView5 != null) {
                                                                                        ...
                                                                                        if (textView6 != null) {
                                                                                            ...
                                                                                            if (usernameTextView != null) {
                                                                                                i10 = R.id.v_marks_review;
                                                                                                if (ViewBindings.findChildViewById(view, R.id.v_marks_review) != null) {
                                                                                                    return new s0((RelativeLayout) view, imageView, imageView2, imageView3, imageView4, imageView5, imageView6, imageView7, imageView8, imageView9, imageView10, linearLayout, linearLayout2, textView, textView2, textView3, textView4, textView5, textView6, usernameTextView);
                                                                                                }
                                                                                            }
                                                                                        }
                                                                                    }
