...
public abstract class ScatterMap<K, V> {
    ...
    public static /* synthetic */ String joinToString$default(ScatterMap scatterMap, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i10, CharSequence charSequence4, p pVar, int i11, Object obj) {
        if (obj != null) {
        ...
        p pVar2 = pVar;
        return scatterMap.joinToString(charSequence, charSequence2, charSequence3, i10, charSequence5, pVar2);
    }
        ...
        while (true) {
            ...
            if ((((~j10) << 7) & j10 & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i12 = 0; i12 < i11; i12++) {
                    if ((255 & j10) < 128) {
                        int i13 = (i10 << 3) + i12;
                        if (!((Boolean) pVar.invoke(objArr[i13], objArr2[i13])).booleanValue()) {
                            return false;
                        }
                    }
                    j10 >>= 8;
    ...
    public final String asDebugString$collection() {
        ...
        for (int i11 = 0; i11 < length; i11++) {
            sb.append(this.keys[i11]);
            sb.append(", ");
        }
        sb.append("], values=[");
        int length2 = this.values.length;
        for (int i12 = 0; i12 < length2; i12++) {
            sb.append(this.values[i12]);
            sb.append(", ");
        }
        sb.append("]}");
        return sb.toString();
        ...
        while (true) {
            ...
            if ((((~j10) << 7) & j10 & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i13 = 0; i13 < i12; i13++) {
                    if ((255 & j10) < 128) {
                        int i14 = (i10 << 3) + i13;
                        if (((Boolean) pVar.invoke(objArr[i14], objArr2[i14])).booleanValue()) {
                            i11++;
                        }
                    }
                    j10 >>= 8;
        ...
        while (true) {
            ...
            if ((((~j10) << 7) & j10 & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i12 = 0; i12 < i11; i12++) {
                    if ((255 & j10) < 128) {
                        int i13 = (i10 << 3) + i12;
                        pVar.invoke(objArr[i13], objArr2[i13]);
                    }
                    j10 >>= 8;
                }
                if (i11 != 8) {
    ...
    */
    ...
    public final V getOrElse(K k10, g7.a aVar) {
        aVar.getClass();
        V v6 = get(k10);
                    ...
                    while (i15 < i14) {
                        if ((j10 & 255) < 128) {
                            ...
                            if (pVar == null) {
                                ...
                                sbU.append((CharSequence) pVar.invoke(obj, obj2));
                            }
                            i12++;
                        } else {
                            objArr3 = objArr5;
    ...
    */
    ...
    /* compiled from: r8-map-id-41d83e727936d3330b608d725ba7b7c2e83c0817dc12ceb2aead6fdefac83833 */
    public class MapWrapper implements Map<K, V>, h7.a, j$.util.Map {
        public MapWrapper() {
        }
        ...
        @Override // java.util.Map, j$.util.Map
        public V merge(K k10, V v6, BiFunction<? super V, ? super V, ? extends V> biFunction) {
            throw new UnsupportedOperationException("Operation is not supported for read-only collection");
        }
