...
public class AnalyticsCollector implements Player.EventListener, AudioRendererEventListener, DefaultDrmSessionEventListener, MetadataOutput, MediaSourceEventListener, BandwidthMeter.EventListener, VideoRendererEventListener {
    ...
    public static final class MediaPeriodQueueTracker {
        ...
        public final WindowAndMediaPeriodId getLoadingMediaPeriod() {
            ...
            return (WindowAndMediaPeriodId) a.t(this.activeMediaPeriods, 1);
        }
    ...
    public final void onLoadError(int i10, @Nullable MediaSource.MediaPeriodId mediaPeriodId, MediaSourceEventListener.LoadEventInfo loadEventInfo, MediaSourceEventListener.MediaLoadData mediaLoadData, IOException iOException, boolean z9) {
        ...
        Iterator<AnalyticsListener> it = this.listeners.iterator();
        while (it.hasNext()) {
            it.next().onLoadError(eventTimeGenerateEventTime, loadEventInfo, mediaLoadData, iOException, z9);
        }
    }
    ...
    public final void onLoadingChanged(boolean z9) {
        ...
        Iterator<AnalyticsListener> it = this.listeners.iterator();
        while (it.hasNext()) {
            it.next().onLoadingChanged(eventTimeGeneratePlayingMediaPeriodEventTime, z9);
        }
    }
    ...
    public final void onPlayerStateChanged(boolean z9, int i10) {
        ...
        Iterator<AnalyticsListener> it = this.listeners.iterator();
        while (it.hasNext()) {
            it.next().onPlayerStateChanged(eventTimeGeneratePlayingMediaPeriodEventTime, z9, i10);
        }
    }
    ...
    public final void onShuffleModeEnabledChanged(boolean z9) {
        ...
        Iterator<AnalyticsListener> it = this.listeners.iterator();
        while (it.hasNext()) {
            it.next().onShuffleModeChanged(eventTimeGeneratePlayingMediaPeriodEventTime, z9);
        }
    }
    ...
    public final void onVideoSizeChanged(int i10, int i11, int i12, float f) {
        ...
        Iterator<AnalyticsListener> it = this.listeners.iterator();
        while (it.hasNext()) {
            it.next().onVideoSizeChanged(eventTimeGenerateReadingMediaPeriodEventTime, i10, i11, i12, f);
        }
    }
