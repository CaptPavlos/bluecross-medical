...
public final class MutableFloatLongMap extends FloatLongMap {
    ...
    private final void resizeStorage(int i10) {
        ...
        while (i12 < i11) {
            if (((jArr2[i12 >> 3] >> ((i12 & 7) << 3)) & 255) < 128) {
                ...
                int i16 = mutableFloatLongMap._capacity;
                ...
                jArr4[iFindFirstAvailableSlot] = jArr3[i12];
            } else {
                jArr = jArr2;
            }
            i12++;
    ...
    public final long getOrPut(float f, g7.a aVar) {
        aVar.getClass();
    ...
    public final long put(float f, long j10, long j11) {
        int iFindInsertIndex = findInsertIndex(f);
        if (iFindInsertIndex < 0) {
            iFindInsertIndex = ~iFindInsertIndex;
        } else {
            j11 = this.values[iFindInsertIndex];
        }
        this.keys[iFindInsertIndex] = f;
        this.values[iFindInsertIndex] = j10;
        return j11;
    }
    ...
    public final boolean remove(float f, long j10) {
        int iFindKeyIndex = findKeyIndex(f);
        if (iFindKeyIndex < 0 || this.values[iFindKeyIndex] != j10) {
            return false;
        }
        ...
        while (true) {
            ...
            if ((((~j10) << 7) & j10 & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i12 = 0; i12 < i11; i12++) {
                    if ((255 & j10) < 128) {
                        int i13 = (i10 << 3) + i12;
                        if (((Boolean) pVar.invoke(Float.valueOf(this.keys[i13]), Long.valueOf(this.values[i13]))).booleanValue()) {
                            removeValueAt(i13);
                        }
                    }
                    j10 >>= 8;
    ...
    public final void set(float f, long j10) {
        int iFindInsertIndex = findInsertIndex(f);
        if (iFindInsertIndex < 0) {
            iFindInsertIndex = ~iFindInsertIndex;
        }
    ...
    public /* synthetic */ MutableFloatLongMap(int i10, int i11, g gVar) {
        this((i11 & 1) != 0 ? 6 : i10);
    }
    ...
    public final void put(float f, long j10) {
        set(f, j10);
    }
