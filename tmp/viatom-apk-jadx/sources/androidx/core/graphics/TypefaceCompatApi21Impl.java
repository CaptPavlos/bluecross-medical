...
class TypefaceCompatApi21Impl extends TypefaceCompatBaseImpl {
    ...
    private static boolean addFontWeightStyle(Object obj, String str, int i10, boolean z9) throws NoSuchMethodException, ClassNotFoundException, SecurityException {
        init();
        try {
            return ((Boolean) sAddFontWeightStyle.invoke(obj, str, Integer.valueOf(i10), Boolean.valueOf(z9))).booleanValue();
    ...
    public Typeface createFromFontFamilyFilesResourceEntry(Context context, FontResourcesParserCompat.FontFamilyFilesResourceEntry fontFamilyFilesResourceEntry, Resources resources, int i10) throws NoSuchMethodException, ClassNotFoundException, SecurityException {
    ...
    @Override // androidx.core.graphics.TypefaceCompatBaseImpl
    public Typeface createFromFontInfo(Context context, CancellationSignal cancellationSignal, @NonNull FontsContractCompat.FontInfo[] fontInfoArr, int i10) throws IOException {
    ...
    public Typeface createWeightStyle(@NonNull Context context, @NonNull Typeface typeface, int i10, boolean z9) {
        ...
        try {
            typefaceCreateWeightStyle = WeightTypefaceApi21.createWeightStyle(typeface, i10, z9);
        } catch (RuntimeException unused) {
