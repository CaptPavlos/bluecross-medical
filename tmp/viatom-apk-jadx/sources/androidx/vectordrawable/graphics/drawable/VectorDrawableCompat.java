...
public class VectorDrawableCompat extends VectorDrawableCommon {
    ...
    public static int applyAlpha(int i10, float f) {
        return (i10 & ViewCompat.MEASURED_SIZE_MASK) | (((int) (Color.alpha(i10) * f)) << 24);
    }

    @Nullable
    public static VectorDrawableCompat create(@NonNull Resources resources, @DrawableRes int i10, @Nullable Resources.Theme theme) throws XmlPullParserException, Resources.NotFoundException, IOException {
        int next;
    ...
    private void printGroupTree(VGroup vGroup, int i10) {
        ...
        StringBuilder sbW = a.w(strConcat, "current group is :");
        sbW.append(vGroup.getGroupName());
        sbW.append(" rotation is ");
        sbW.append(vGroup.mRotate);
        Log.v(LOGTAG, sbW.toString());
    ...
    public static abstract class VPath extends VObject {
        ...
        public String nodesToString(PathParser.PathDataNode[] pathDataNodeArr) {
            ...
            for (int i10 = 0; i10 < pathDataNodeArr.length; i10++) {
                ...
                sbV.append(pathDataNodeArr[i10].mType);
                sbV.append(":");
                string = sbV.toString();
                for (float f : pathDataNodeArr[i10].mParams) {
                    StringBuilder sbV2 = a.v(string);
                    sbV2.append(f);
                    sbV2.append(",");
        ...
        public void printVPath(int i10) {
            ...
            StringBuilder sbW = a.w(strConcat, "current path is :");
            sbW.append(this.mPathName);
            sbW.append(" pathData is ");
            sbW.append(nodesToString(this.mNodes));
            Log.v(VectorDrawableCompat.LOGTAG, sbW.toString());
        }
    ...
    public static class VPathRenderer {
        ...
        private void drawPath(VGroup vGroup, VPath vPath, Canvas canvas, int i10, int i11, ColorFilter colorFilter) {
            float f = i10 / this.mViewportWidth;
            float f10 = i11 / this.mViewportHeight;
                ...
                if (vObject instanceof VGroup) {
                    ...
                    if (vObject instanceof VFullPath) {
                        ...
                        if (!(vObject instanceof VClipPath)) {
                            c.g("Unknown object in the tree!");
                            throw null;
                        }
