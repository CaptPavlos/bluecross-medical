...
public class DialogFragment extends Fragment implements DialogInterface.OnCancelListener, DialogInterface.OnDismissListener {
        ...
        this.mObserver = new Observer<LifecycleOwner>() { // from class: androidx.fragment.app.DialogFragment.4
            ...
            public void onChanged(LifecycleOwner lifecycleOwner) {
                ...
                if (viewRequireView.getParent() != null) {
                    androidx.window.layout.c.g("DialogFragment can not be attached to a container view");
                    return;
                }
                if (DialogFragment.this.mDialog != null) {
    ...
    public final Dialog requireDialog() {
        ...
        androidx.core.view.accessibility.a.s(this, "DialogFragment ", " does not have a Dialog.");
        return null;
    }
