...
public class MaterialAutoCompleteTextView extends AppCompatAutoCompleteTextView {
    ...
    public MaterialAutoCompleteTextView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i10) {
        ...
        if (typedArrayObtainStyledAttributes.hasValue(i12)) {
            this.dropDownBackgroundTint = ColorStateList.valueOf(typedArrayObtainStyledAttributes.getColor(i12, 0));
        }
        ...
        listPopupWindow.setOnItemClickListener(new AdapterView.OnItemClickListener() { // from class: com.google.android.material.textfield.MaterialAutoCompleteTextView.1
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i13, long j10) {
                ...
                Object selectedItem = i13 < 0 ? materialAutoCompleteTextView.modalListPopup.getSelectedItem() : materialAutoCompleteTextView.getAdapter().getItem(i13);
                ...
                if (onItemClickListener != null) {
                    if (view == null || i13 < 0) {
                        ...
                        i13 = MaterialAutoCompleteTextView.this.modalListPopup.getSelectedItemPosition();
                        j10 = MaterialAutoCompleteTextView.this.modalListPopup.getSelectedItemId();
                    }
                    onItemClickListener.onItemClick(MaterialAutoCompleteTextView.this.modalListPopup.getListView(), view, i13, j10);
                }
