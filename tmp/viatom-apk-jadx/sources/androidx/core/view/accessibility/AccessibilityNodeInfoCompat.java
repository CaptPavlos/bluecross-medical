...
public class AccessibilityNodeInfoCompat {
    ...
    public static class Api21Impl {
        ...
        @DoNotInline
        public static CollectionItemInfoCompat createCollectionItemInfo(int i10, int i11, int i12, int i13, boolean z9, boolean z10) {
            return new CollectionItemInfoCompat(AccessibilityNodeInfo.CollectionItemInfo.obtain(i10, i11, i12, i13, z9, z10));
        }
    }
    ...
    public static class Api30Impl {
        ...
        @DoNotInline
        public static Object createRangeInfo(int i10, float f, float f10, float f11) {
    ...
    public static class Api33Impl {
        ...
        @DoNotInline
        public static CollectionItemInfoCompat buildCollectionItemInfoCompat(boolean z9, int i10, int i11, int i12, int i13, boolean z10, String str, String str2) {
            return new CollectionItemInfoCompat(new AccessibilityNodeInfo.CollectionItemInfo.Builder().setHeading(z9).setColumnIndex(i10).setRowIndex(i11).setColumnSpan(i12).setRowSpan(i13).setSelected(z10).setRowTitle(str).setColumnTitle(str2).build());
        }
    ...
    private void setBooleanProperty(int i10, boolean z9) {
        Bundle extras = getExtras();
        if (extras != null) {
    ...
    public CharSequence getContainerTitle() {
        int i10 = Build.VERSION.SDK_INT;
        AccessibilityNodeInfo accessibilityNodeInfo = this.mInfo;
        return i10 >= 34 ? Api34Impl.getContainerTitle(accessibilityNodeInfo) : accessibilityNodeInfo.getExtras().getCharSequence(CONTAINER_TITLE_KEY);
    }
    ...
    public CharSequence getHintText() {
        int i10 = Build.VERSION.SDK_INT;
        AccessibilityNodeInfo accessibilityNodeInfo = this.mInfo;
        return i10 >= 26 ? accessibilityNodeInfo.getHintText() : accessibilityNodeInfo.getExtras().getCharSequence(HINT_TEXT_KEY);
    }
    ...
    public long getMinDurationBetweenContentChangesMillis() {
        int i10 = Build.VERSION.SDK_INT;
        AccessibilityNodeInfo accessibilityNodeInfo = this.mInfo;
        return i10 >= 34 ? Api34Impl.getMinDurationBetweenContentChangeMillis(accessibilityNodeInfo) : accessibilityNodeInfo.getExtras().getLong(MIN_DURATION_BETWEEN_CONTENT_CHANGES_KEY);
    }
    ...
    public CharSequence getPaneTitle() {
        int i10 = Build.VERSION.SDK_INT;
        AccessibilityNodeInfo accessibilityNodeInfo = this.mInfo;
        return i10 >= 28 ? accessibilityNodeInfo.getPaneTitle() : accessibilityNodeInfo.getExtras().getCharSequence(PANE_TITLE_KEY);
    }
    ...
    public CharSequence getStateDescription() {
        int i10 = Build.VERSION.SDK_INT;
        AccessibilityNodeInfo accessibilityNodeInfo = this.mInfo;
        return i10 >= 30 ? Api30Impl.getStateDescription(accessibilityNodeInfo) : accessibilityNodeInfo.getExtras().getCharSequence(STATE_DESCRIPTION_KEY);
    }
    ...
    public CharSequence getTooltipText() {
        int i10 = Build.VERSION.SDK_INT;
        AccessibilityNodeInfo accessibilityNodeInfo = this.mInfo;
        return i10 >= 28 ? accessibilityNodeInfo.getTooltipText() : accessibilityNodeInfo.getExtras().getCharSequence(TOOLTIP_TEXT_KEY);
    }
    ...
    public String getUniqueId() {
        int i10 = Build.VERSION.SDK_INT;
        AccessibilityNodeInfo accessibilityNodeInfo = this.mInfo;
        return i10 >= 33 ? Api33Impl.getUniqueId(accessibilityNodeInfo) : accessibilityNodeInfo.getExtras().getString(UNIQUE_ID_KEY);
    }
    ...
    public void setMinDurationBetweenContentChangesMillis(long j10) {
        ...
        AccessibilityNodeInfo accessibilityNodeInfo = this.mInfo;
        if (i10 >= 34) {
            Api34Impl.setMinDurationBetweenContentChangeMillis(accessibilityNodeInfo, j10);
        } else {
            accessibilityNodeInfo.getExtras().putLong(MIN_DURATION_BETWEEN_CONTENT_CHANGES_KEY, j10);
        }
    }
    ...
    public static class CollectionInfoCompat {
        ...
        public static CollectionInfoCompat obtain(int i10, int i11, boolean z9, int i12) {
            return new CollectionInfoCompat(AccessibilityNodeInfo.CollectionInfo.obtain(i10, i11, z9, i12));
        }
        ...
        public static CollectionInfoCompat obtain(int i10, int i11, boolean z9) {
            return new CollectionInfoCompat(AccessibilityNodeInfo.CollectionInfo.obtain(i10, i11, z9));
        }
    }
    ...
    public static class CollectionItemInfoCompat {
        ...
        public static CollectionItemInfoCompat obtain(int i10, int i11, int i12, int i13, boolean z9, boolean z10) {
            return new CollectionItemInfoCompat(AccessibilityNodeInfo.CollectionItemInfo.obtain(i10, i11, i12, i13, z9, z10));
        }
        ...
        public static CollectionItemInfoCompat obtain(int i10, int i11, int i12, int i13, boolean z9) {
            return new CollectionItemInfoCompat(AccessibilityNodeInfo.CollectionItemInfo.obtain(i10, i11, i12, i13, z9));
        }
    }
    ...
    public static final class TouchDelegateInfoCompat {
        ...
        @Nullable
        public Region getRegionAt(@IntRange(from = FabTransformationScrimBehavior.COLLAPSE_DELAY) int i10) {
            if (Build.VERSION.SDK_INT >= 29) {
    ...
    public static class RangeInfoCompat {
        ...
        public RangeInfoCompat(int i10, float f, float f10, float f11) {
            if (Build.VERSION.SDK_INT >= 30) {
                this.mInfo = Api30Impl.createRangeInfo(i10, f, f10, f11);
            } else {
                this.mInfo = AccessibilityNodeInfo.RangeInfo.obtain(i10, f, f10, f11);
            }
        }

        public static RangeInfoCompat obtain(int i10, float f, float f10, float f11) {
            return new RangeInfoCompat(AccessibilityNodeInfo.RangeInfo.obtain(i10, f, f10, f11));
        }
