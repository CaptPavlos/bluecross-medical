...
public final class DownloadManager {
    ...
    public static final class TaskState {
        ...
        private TaskState(int i10, DownloadAction downloadAction, int i11, float f, long j10, Throwable th) {
            this.taskId = i10;
    ...
    public void maybeStartTasks() {
        ...
        for (int i10 = 0; i10 < this.tasks.size(); i10++) {
            ...
            if (task.canStart() && ((z9 = (downloadAction = task.action).isRemoveAction) || !z10)) {
                boolean z11 = true;
                int i11 = 0;
                while (true) {
                    if (i11 >= i10) {
