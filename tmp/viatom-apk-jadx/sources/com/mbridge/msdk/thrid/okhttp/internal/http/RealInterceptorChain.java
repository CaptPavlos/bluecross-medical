...
public final class RealInterceptorChain implements Interceptor.Chain {
    ...
    public Response proceed(Request request, StreamAllocation streamAllocation, HttpCodec httpCodec, RealConnection realConnection) throws IOException {
        ...
        if (this.httpCodec != null && !this.connection.supportsUrl(request.url())) {
            a.q(this.interceptors.get(this.index - 1), "network interceptor ", " must retain the same host and port");
            return null;
        }
        if (this.httpCodec != null && this.calls > 1) {
            a.q(this.interceptors.get(this.index - 1), "network interceptor ", " must call proceed() exactly once");
            return null;
        }
        ...
        if (httpCodec != null && this.index + 1 < this.interceptors.size() && realInterceptorChain.calls != 1) {
            a.s(interceptor, "network interceptor ", " must call proceed() exactly once");
            return null;
        }
        if (responseIntercept != null) {
            ...
            a.s(interceptor, "interceptor ", " returned a response with no body");
            return null;
        }
