...
public abstract class MediaCodecRenderer extends BaseRenderer {
    ...
    public MediaCodecRenderer(int i10, MediaCodecSelector mediaCodecSelector, @Nullable DrmSessionManager<FrameworkMediaCrypto> drmSessionManager, boolean z9) {
        super(i10);
    ...
    private boolean drainOutputBuffer(long j10, long j11) throws ExoPlaybackException {
        ...
        if (zProcessOutputBuffer) {
            ...
            boolean z9 = (this.outputBufferInfo.flags & 4) != 0;
            resetOutputBuffer();
            if (!z9) {
                return true;
            }
    ...
    public MediaCodecInfo getDecoderInfo(MediaCodecSelector mediaCodecSelector, Format format, boolean z9) throws MediaCodecUtil.DecoderQueryException {
        return mediaCodecSelector.getDecoderInfo(format.sampleMimeType, z9);
    }
    ...
    */
    ...
    public abstract boolean processOutputBuffer(long j10, long j11, MediaCodec mediaCodec, ByteBuffer byteBuffer, int i10, int i11, long j12, boolean z9) throws ExoPlaybackException;
