...
final class VorbisReader extends StreamReader {
    ...
    private static int decodeBlockSize(byte b10, VorbisSetup vorbisSetup) {
        boolean z9 = vorbisSetup.modes[readBits(b10, vorbisSetup.iLogModes, 1)].blockFlag;
        VorbisUtil.VorbisIdHeader vorbisIdHeader = vorbisSetup.idHeader;
        return !z9 ? vorbisIdHeader.blockSize0 : vorbisIdHeader.blockSize1;
    }
    ...
    public final void onSeekEnd(long j10) {
        super.onSeekEnd(j10);
