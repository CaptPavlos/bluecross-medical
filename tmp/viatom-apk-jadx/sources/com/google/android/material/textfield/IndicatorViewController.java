...
final class IndicatorViewController {
    ...
    public IndicatorViewController(@NonNull TextInputLayout textInputLayout) {
        ...
        this.captionTranslationYAnimationDuration = MotionUtils.resolveThemeDuration(context, i10, DEFAULT_CAPTION_TRANSLATION_Y_ANIMATION_DURATION);
        ...
        this.captionFadeOutAnimationDuration = MotionUtils.resolveThemeDuration(context, i10, DEFAULT_CAPTION_FADE_ANIMATION_DURATION);
        int i11 = R.attr.motionEasingEmphasizedDecelerateInterpolator;
        this.captionTranslationYAnimationInterpolator = MotionUtils.resolveThemeInterpolator(context, i11, AnimationUtils.LINEAR_OUT_SLOW_IN_INTERPOLATOR);
        TimeInterpolator timeInterpolator = AnimationUtils.LINEAR_INTERPOLATOR;
        this.captionFadeInAnimationInterpolator = MotionUtils.resolveThemeInterpolator(context, i11, timeInterpolator);
    ...
    private void createCaptionAnimators(@NonNull List<Animator> list, boolean z9, @Nullable TextView textView, int i10, int i11, int i12) {
        if (textView == null || !z9) {
            return;
        }
        if (i10 == i12 || i10 == i11) {
            ObjectAnimator objectAnimatorCreateCaptionOpacityAnimator = createCaptionOpacityAnimator(textView, i12 == i10);
            if (i10 == i12 && i11 != 0) {
    ...
    private int getIndicatorPadding(boolean z9, @DimenRes int i10, int i11) {
        return z9 ? this.context.getResources().getDimensionPixelSize(i10) : i11;
    }
    ...
    private void updateCaptionViewsVisibility(final int i10, final int i11, boolean z9) {
        ...
        if (z9) {
            ...
            indicatorViewController.createCaptionAnimators(arrayList, this.helperTextEnabled, this.helperTextView, 2, i10, i11);
            indicatorViewController.createCaptionAnimators(arrayList, indicatorViewController.errorEnabled, indicatorViewController.errorView, 1, i10, i11);
