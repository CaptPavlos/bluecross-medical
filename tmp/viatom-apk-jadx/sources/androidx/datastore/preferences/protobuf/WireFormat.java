    ...
    public static Object readPrimitiveField(CodedInputStream codedInputStream, FieldType fieldType, Utf8Validation utf8Validation) throws IOException {
        switch (AnonymousClass1.$SwitchMap$com$google$protobuf$WireFormat$FieldType[fieldType.ordinal()]) {
            ...
            case 15:
                break;
            case 16:
                a.n("readPrimitiveField() cannot handle nested groups.");
                break;
            case 17:
                a.n("readPrimitiveField() cannot handle embedded messages.");
                break;
            case 18:
                a.n("readPrimitiveField() cannot handle enums.");
                break;
            default:
                a2.a.j("There is no way to get here, but the compiler thinks otherwise.");
                break;
        }
        return null;
    }
