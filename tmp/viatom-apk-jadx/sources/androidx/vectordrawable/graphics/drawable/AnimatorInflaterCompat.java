...
public class AnimatorInflaterCompat {
    ...
    */
    ...
    private static void distributeKeyframes(Keyframe[] keyframeArr, float f, int i10, int i11) {
        float f10 = f / ((i11 - i10) + 2);
        while (i10 <= i11) {
    ...
    private static void dumpKeyframes(Object[] objArr, String str) {
        ...
        for (int i10 = 0; i10 < length; i10++) {
            ...
            StringBuilder sbR = a.r(i10, "Keyframe ", ": fraction ");
            Object value = "null";
            sbR.append(keyframe.getFraction() < 0.0f ? "null" : Float.valueOf(keyframe.getFraction()));
            sbR.append(", , value : ");
    ...
    private static PropertyValuesHolder getPVH(TypedArray typedArray, int i10, int i11, int i12, String str) {
        ...
        int i13 = z9 ? typedValuePeekValue.type : 0;
        ...
        if (i10 == 4) {
            i10 = ((z9 && isColorType(i13)) || (z10 && isColorType(i14))) ? 3 : 0;
        }
        boolean z11 = i10 == 0;
    ...
    private static int inferValueTypeFromValues(TypedArray typedArray, int i10, int i11) {
        ...
        if (z9 && isColorType(i12)) {
            return 3;
        }
        return (z10 && isColorType(i13)) ? 3 : 0;
    }
    ...
    public static Animator loadAnimator(Context context, Resources resources, Resources.Theme theme, @AnimatorRes int i10, float f) throws Resources.NotFoundException {
    ...
    private static Keyframe loadKeyframe(Context context, Resources resources, Resources.Theme theme, AttributeSet attributeSet, int i10, XmlPullParser xmlPullParser) throws XmlPullParserException, IOException {
        ...
        if (i10 == 4) {
            i10 = (z9 && isColorType(typedValuePeekNamedValue.type)) ? 3 : 0;
        }
        Keyframe keyframeOfInt = z9 ? i10 != 0 ? (i10 == 1 || i10 == 3) ? Keyframe.ofInt(namedFloat, TypedArrayUtils.getNamedInt(typedArrayObtainAttributes, xmlPullParser, "value", 0, 0)) : null : Keyframe.ofFloat(namedFloat, TypedArrayUtils.getNamedFloat(typedArrayObtainAttributes, xmlPullParser, "value", 0, 0.0f)) : i10 == 0 ? Keyframe.ofFloat(namedFloat) : Keyframe.ofInt(namedFloat);
    ...
    private static void setupObjectAnimator(ValueAnimator valueAnimator, TypedArray typedArray, int i10, float f, XmlPullParser xmlPullParser) {
    ...
    public static class PathDataEvaluator implements TypeEvaluator<PathParser.PathDataNode[]> {
        ...
        public PathParser.PathDataNode[] evaluate(float f, PathParser.PathDataNode[] pathDataNodeArr, PathParser.PathDataNode[] pathDataNodeArr2) {
            ...
            while (true) {
                ...
                pathDataNodeArr3[i10].interpolatePathDataNode(pathDataNodeArr[i10], pathDataNodeArr2[i10], f);
                i10++;
            }
        }
