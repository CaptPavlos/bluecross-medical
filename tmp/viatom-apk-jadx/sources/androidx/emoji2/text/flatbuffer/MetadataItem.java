...
public final class MetadataItem extends Table {
    ...
    public static int createMetadataItem(FlatBufferBuilder flatBufferBuilder, int i10, boolean z9, short s9, short s10, short s11, short s12, int i11) {
    ...
    public int codepoints(int i10) {
        ...
        return this.bb.getInt((i10 * 4) + __vector(i__offset));
    }
    ...
    public static final class Vector extends BaseVector {
        ...
        public MetadataItem get(MetadataItem metadataItem, int i10) {
            return metadataItem.__assign(Table.__indirect(__element(i10), this.bb), this.bb);
        }
