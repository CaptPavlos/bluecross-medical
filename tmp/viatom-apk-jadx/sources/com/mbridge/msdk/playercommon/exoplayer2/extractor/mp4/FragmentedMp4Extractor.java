...
public final class FragmentedMp4Extractor implements Extractor {
    ...
    public static final class TrackBundle {
        ...
        public final int outputSampleEncryptionData() {
            ...
            boolean z9 = this.fragment.sampleHasSubsampleEncryptionTable[this.currentSampleIndex];
            ParsableByteArray parsableByteArray3 = this.encryptionSignalByte;
            parsableByteArray3.data[0] = (byte) ((z9 ? 128 : 0) | length);
    ...
    private static void parseSaio(ParsableByteArray parsableByteArray, TrackFragment trackFragment) throws ParserException {
        ...
        if (unsignedIntToInt != 1) {
            a.i(a3.a.f(unsignedIntToInt, "Unexpected saio entry count: "));
        } else {
    ...
    private static void parseSaiz(TrackEncryptionBox trackEncryptionBox, ParsableByteArray parsableByteArray, TrackFragment trackFragment) throws ParserException {
        ...
        if (unsignedIntToInt != trackFragment.sampleCount) {
            StringBuilder sbR = a3.a.r(unsignedIntToInt, "Length mismatch: ", ", ");
            sbR.append(trackFragment.sampleCount);
            throw new ParserException(sbR.toString());
        }
        if (unsignedByte == 0) {
    ...
    private static void parseSenc(ParsableByteArray parsableByteArray, int i10, TrackFragment trackFragment) throws ParserException {
        ...
        if ((fullAtomFlags & 1) != 0) {
            a.i("Overriding TrackEncryptionBox parameters is unsupported.");
            return;
        }
    ...
    private static void parseSgpd(ParsableByteArray parsableByteArray, ParsableByteArray parsableByteArray2, String str, TrackFragment trackFragment) throws ParserException {
        ...
        if (parsableByteArray.readInt() != 1) {
            a.i("Entry count in sbgp != 1 (unsupported).");
            return;
        }
        ...
        if (fullAtomVersion == 1) {
            if (parsableByteArray2.readUnsignedInt() == 0) {
                a.i("Variable length description in sgpd found (unsupported)");
                return;
            }
        ...
        if (parsableByteArray2.readUnsignedInt() != 1) {
            a.i("Entry count in sgpd != 1 (unsupported).");
            return;
        }
        ...
        if (z9) {
            ...
            trackFragment.trackEncryptionBox = new TrackEncryptionBox(z9, str, unsignedByte2, bArr2, i14, i15, bArr3);
        }
    }
    ...
    private static Pair<Long, ChunkIndex> parseSidx(ParsableByteArray parsableByteArray, long j10) throws ParserException {
        ...
        while (i10 < unsignedShort) {
            ...
            if ((Integer.MIN_VALUE & i11) != 0) {
                a.i("Unhandled indirect reference");
                return null;
            }
    ...
    private static int parseTrun(TrackBundle trackBundle, int i10, long j10, int i11, ParsableByteArray parsableByteArray, int i12) {
        ...
        boolean z17 = z15;
        boolean z18 = (track.type != 2 || (i11 & 1) == 0) ? r27 : z16;
        int i16 = i12 + trackFragment.trunLength[i10];
        boolean z19 = z11;
        long j12 = track.timescale;
        int i17 = i12;
        long j13 = i10 > 0 ? trackFragment.nextFragmentDecodeTime : j10;
        while (i17 < i16) {
            int unsignedIntToInt2 = z12 ? parsableByteArray.readUnsignedIntToInt() : defaultSampleValues.duration;
            int unsignedIntToInt3 = z13 ? parsableByteArray.readUnsignedIntToInt() : defaultSampleValues.size;
            if (i17 == 0 && z19) {
                z10 = z18;
                i13 = unsignedIntToInt;
            } else if (z14) {
                z10 = z18;
            ...
            if (z17) {
                i14 = i13;
                i15 = i16;
                r72[i17] = (int) ((parsableByteArray.readInt() * 1000) / j12);
            } else {
                i14 = i13;
                i15 = i16;
                r72[i17] = r27;
            ...
            long j14 = j13;
            jArr3[i17] = Util.scaleLargeTimestamp(j13, 1000L, j12) - jScaleLargeTimestamp;
            iArr[i17] = unsignedIntToInt3;
            zArr[i17] = (((i14 >> 16) & 1) != 0 || (z10 && i17 != 0)) ? r27 : z16;
            j13 = j14 + unsignedIntToInt2;
            i17++;
            z18 = z10;
            i16 = i15;
        }
    ...
    private boolean readAtomHeader(ExtractorInput extractorInput) throws InterruptedException, IOException {
        ...
        if (this.atomSize < this.atomHeaderBytesRead) {
            a.i("Atom size less than header length (unsupported).");
            return false;
        }
        ...
        if (shouldParseContainerAtom(i11)) {
            ...
            if (this.atomHeaderBytesRead != 8) {
                a.i("Leaf atom defines extended atom size (unsupported).");
                return false;
            }
            long j11 = this.atomSize;
            if (j11 > 2147483647L) {
                a.i("Leaf atom with length > 2147483647 (unsupported).");
                return false;
            }
            ...
            if (this.atomSize > 2147483647L) {
                a.i("Skipping atom with length > 2147483647 (unsupported).");
                return false;
            }
            this.atomData = null;
            this.parserState = 1;
    ...
    private void readEncryptionData(ExtractorInput extractorInput) throws InterruptedException, IOException {
        ...
        if (position < 0) {
            a.i("Offset to encryption data was negative.");
        } else {
    ...
    private boolean readSample(ExtractorInput extractorInput) throws InterruptedException, IOException {
        ...
        if (this.parserState == 3) {
            if (this.currentTrackBundle == null) {
                ...
                if (nextFragmentRun == null) {
                    ...
                    if (position < 0) {
                        a.i("Offset to end of mdat was negative.");
                        return false;
                    }
                    extractorInput.skipFully(position);
                    enterReadingAtomHeaderState();
        ...
        r10.sampleMetadata(samplePresentationTime, z9, this.sampleSize, 0, cryptoData);
