...
public class AppCompatViewInflater {
    ...
    public static class DeclaredOnClickListener implements View.OnClickListener {
        ...
        private void resolveMethod(@Nullable Context context) {
            ...
            androidx.window.layout.c.i("Could not find method ", this.mMethodName, "(View) in a parent or ancestor Context for android:onClick attribute defined on view ", this.mHostView.getClass(), str);
        }
