...
public abstract class BaseTransientBottomBar<B extends BaseTransientBottomBar<B>> {
    ...
    public BaseTransientBottomBar(@NonNull Context context, @NonNull ViewGroup viewGroup, @NonNull View view, @NonNull com.google.android.material.snackbar.ContentViewCallback contentViewCallback) {
        ...
        this.bottomMarginGestureInsetRunnable = new Runnable() { // from class: com.google.android.material.snackbar.BaseTransientBottomBar.2
            ...
            public void run() {
                ...
                int i10 = BaseTransientBottomBar.this.extraBottomMarginGestureInset;
        ...
        if (viewGroup == null) {
            a.n("Transient bottom bar must have non-null parent");
            throw null;
        }
        if (view == null) {
            a.n("Transient bottom bar must have non-null content");
            throw null;
        }
        if (contentViewCallback == null) {
            a.n("Transient bottom bar must have non-null callback");
            throw null;
        }
        ...
        this.animationSlideDuration = MotionUtils.resolveThemeDuration(context, i10, 250);
        this.animationFadeInDuration = MotionUtils.resolveThemeDuration(context, i10, DEFAULT_ANIMATION_FADE_IN_DURATION);
        ...
        this.animationFadeInterpolator = MotionUtils.resolveThemeInterpolator(context, i11, DEFAULT_ANIMATION_FADE_INTERPOLATOR);
        this.animationScaleInterpolator = MotionUtils.resolveThemeInterpolator(context, i11, DEFAULT_ANIMATION_SCALE_INTERPOLATOR);
        this.animationSlideInterpolator = MotionUtils.resolveThemeInterpolator(context, i11, DEFAULT_ANIMATION_SLIDE_INTERPOLATOR);
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    @NonNull
    public static GradientDrawable createGradientDrawableBackground(@ColorInt int i10, @NonNull Resources resources) throws Resources.NotFoundException {
    ...
    public void updateMargins() {
        ...
        ViewGroup.MarginLayoutParams marginLayoutParams = (ViewGroup.MarginLayoutParams) layoutParams;
        int i10 = this.view.originalMargins.bottom + (getAnchorView() != null ? this.extraBottomMarginAnchorView : this.extraBottomMarginWindowInset);
        int i11 = this.view.originalMargins.left + this.extraLeftMarginWindowInset;
        int i12 = this.view.originalMargins.right + this.extraRightMarginWindowInset;
        int i13 = this.view.originalMargins.top;
    ...
    public B setAnchorView(@IdRes int i10) {
        ...
        a.n(a3.a.f(i10, "Unable to find anchor view with id: "));
        return null;
    }
