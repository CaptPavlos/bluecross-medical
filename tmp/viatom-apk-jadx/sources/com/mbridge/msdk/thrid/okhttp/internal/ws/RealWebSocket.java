...
public final class RealWebSocket implements WebSocket, WebSocketReader.FrameCallback {
    ...
    public RealWebSocket(Request request, WebSocketListener webSocketListener, Random random, long j10) {
        if (!ShareTarget.METHOD_GET.equals(request.method())) {
            c.f(request.method(), "Request must be GET: ");
            throw null;
        }
    ...
    public void checkResponse(Response response) throws ProtocolException {
        ...
        if (!"Upgrade".equalsIgnoreCase(strHeader)) {
            throw new ProtocolException(a.x("Expected 'Connection' header value 'Upgrade' but was '", strHeader, "'"));
        }
        String strHeader2 = response.header("Upgrade");
        if (!"websocket".equalsIgnoreCase(strHeader2)) {
            throw new ProtocolException(a.x("Expected 'Upgrade' header value 'websocket' but was '", strHeader2, "'"));
        }
        ...
        synchronized (this) {
            try {
                ...
                if (i10 != -1) {
                    ...
                    sb.append("ms (after ");
                    failWebSocket(new SocketTimeoutException(a3.a.n(sb, " successful ping/pongs)", i10 - 1)), null);
                    return;
                }
                try {
