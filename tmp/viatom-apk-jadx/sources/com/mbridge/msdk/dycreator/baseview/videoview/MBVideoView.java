...
public class MBVideoView extends FrameLayout implements Player.EventListener {
    ...
    public class AnonymousClass1 implements Runnable {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ MBVideoView f3163a;

        @Override // java.lang.Runnable
        public void run() {
            if (this.f3163a.f != null) {
                this.f3163a.f.onBufferingFail("Buffering timeout");
            }
        }
    }
    ...
    public MBVideoView(@NonNull Context context) {
        ...
        this.g = new SurfaceHolder.Callback() { // from class: com.mbridge.msdk.dycreator.baseview.videoview.MBVideoView.2
            ...
            public void surfaceCreated(@NonNull SurfaceHolder surfaceHolder) {
                try {
                    Player.VideoComponent videoComponent = MBVideoView.this.f3160c.getVideoComponent();
        ...
        this.f3162i = new Runnable() { // from class: com.mbridge.msdk.dycreator.baseview.videoview.MBVideoView.4
            @Override // java.lang.Runnable
            public void run() {
                try {
                    if (MBVideoView.this.f3160c == null || !MBVideoView.this.isPlaying()) {
                        return;
                    }
                    long currentPosition = MBVideoView.this.f3160c.getCurrentPosition();
                    long duration = MBVideoView.this.f3160c.getDuration();
                    int iRound = Math.round(currentPosition / 1000.0f);
                    int iRound2 = Math.round(duration / 1000.0f);
                    af.c("MBVideoView", "currentPosition:" + iRound + " duration:" + duration);
                    if (MBVideoView.this.f != null) {
    ...
    public boolean isPlaying() {
        ExoPlayer exoPlayer = this.f3160c;
        return exoPlayer != null && exoPlayer.getPlaybackState() == 3 && this.f3160c.getPlayWhenReady();
    }
    ...
    */
    ...
    public void onPlayerStateChanged(boolean z9, int i10) {
        af.b("MBVideoView", "onPlaybackStateChanged : " + i10);
        if (i10 == 1) {
    ...
    public void onPositionDiscontinuity(int i10) {
        this.f3160c.getCurrentWindowIndex();
    }
    ...
    public void setVideoUrl(String... strArr) {
        ...
        this.e = strArr;
        try {
            this.f3160c = ExoPlayerFactory.newSimpleInstance(new DefaultRenderersFactory(getContext()), new DefaultTrackSelector(), new DefaultLoadControl());
            ...
            this.f3160c.setRepeatMode(0);
            this.f3160c.prepare(concatenatingMediaSource);
            this.f3160c.addListener(this);
        } catch (Throwable th) {
            af.b("MBVideoView", th.getMessage());
            th.toString();
        }
