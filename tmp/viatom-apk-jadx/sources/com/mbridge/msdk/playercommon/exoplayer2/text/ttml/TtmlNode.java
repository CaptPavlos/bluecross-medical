...
final class TtmlNode {
    ...
    private void getEventTimes(TreeSet<Long> treeSet, boolean z9) {
        ...
        for (int i10 = 0; i10 < this.children.size(); i10++) {
            this.children.get(i10).getEventTimes(treeSet, z9 || zEquals);
        }
    }
    ...
    private void traverseForText(long j10, boolean z9, String str, Map<String, SpannableStringBuilder> map) {
        boolean z10;
        ...
        if (isActive(j10)) {
            ...
            while (i10 < getChildCount()) {
                ...
                child.traverseForText(j11, z10, str2, map2);
                i10++;
                j10 = j11;
                map = map2;
            }
    ...
    public final List<Cue> getCues(long j10, Map<String, TtmlStyle> map, Map<String, TtmlRegion> map2) {
