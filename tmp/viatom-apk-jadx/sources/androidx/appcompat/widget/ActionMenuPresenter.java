...
class ActionMenuPresenter extends BaseMenuPresenter implements ActionProvider.SubUiVisibilityListener {
    ...
    public boolean flagActionItems() {
        ...
        if (actionMenuPresenter.mStrictWidthLimit) {
            ...
            i10 = ((i13 % i18) / iMeasureChildForCells) + i18;
        } else {
        ...
        while (i19 < size) {
            ...
            if (menuItemImpl2.requiresActionButton()) {
                ...
                boolean z12 = (i17 > 0 || z11) && i13 > 0 && (!actionMenuPresenter.mStrictWidthLimit || iMeasureChildForCells > 0);
                boolean z13 = z12;
                i11 = size;
                if (z12) {
                    ...
                    z12 = z14 & (!actionMenuPresenter.mStrictWidthLimit ? i13 + i20 <= 0 : i13 < 0);
                }
                if (z12 && groupId2 != 0) {
