...
public final class g extends f {
    ...
    public static synchronized g a(Context context) {
        try {
            if (f3475a == null) {
                f3475a = new g(context.getApplicationContext());
            }
        } catch (Throwable th) {
            throw th;
        }
    ...
    @Override // com.mbridge.msdk.foundation.db.f
    public final void a(SQLiteDatabase sQLiteDatabase, int i10, int i11) throws SQLException {
        if (com.mbridge.msdk.e.d.a(sQLiteDatabase)) {
            c(sQLiteDatabase);
            b(sQLiteDatabase);
        }
    ...
    @Override // com.mbridge.msdk.foundation.db.f
    public final void b(SQLiteDatabase sQLiteDatabase, int i10, int i11) throws SQLException {
        if (com.mbridge.msdk.e.d.a(sQLiteDatabase)) {
            c(sQLiteDatabase);
            b(sQLiteDatabase);
        }
