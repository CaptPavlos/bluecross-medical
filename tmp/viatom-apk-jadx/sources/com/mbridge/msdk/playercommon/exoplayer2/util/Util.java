...
public final class Util {
    ...
    public static <T> int binarySearchCeil(List<? extends Comparable<? super T>> list, T t, boolean z9, boolean z10) {
        int i10;
        int i11;
        ...
        if (iBinarySearch < 0) {
            ...
            while (true) {
                i10 = iBinarySearch + 1;
                if (i10 >= size || list.get(i10).compareTo(t) != 0) {
                    break;
                }
                iBinarySearch = i10;
            }
        ...
        return z10 ? Math.min(list.size() - 1, i11) : i11;
    }

    public static <T> int binarySearchFloor(List<? extends Comparable<? super T>> list, T t, boolean z9, boolean z10) {
        int i10;
        int i11;
        int iBinarySearch = Collections.binarySearch(list, t);
        if (iBinarySearch < 0) {
            ...
            while (true) {
                i10 = iBinarySearch - 1;
                if (i10 < 0 || list.get(i10).compareTo(t) != 0) {
                    break;
                }
                iBinarySearch = i10;
            }
    ...
    */
    ...
    public static String getUserAgent(Context context, String str) {
        ...
        return a.o(sb, Build.VERSION.RELEASE, ") ExoPlayerLib/2.8.4");
    }
    ...
    public static long parseXsDateTime(String str) throws ParserException {
        ...
        if (!matcher.matches()) {
            com.google.gson.internal.a.i(a.i("Invalid date/time format: ", str));
            return 0L;
        }
        int i10 = 0;
        ...
        return i10 != 0 ? timeInMillis - (i10 * MBridgeCommon.DEFAULT_LOAD_TIMEOUT) : timeInMillis;
    }
    ...
    */
    ...
    public static long[] scaleLargeTimestamps(List<Long> list, long j10, long j11) {
        ...
        if (j11 >= j10 && j11 % j10 == 0) {
            ...
            double d8 = j10 / j11;
            while (i10 < size) {
                jArr[i10] = (long) (list.get(i10).longValue() * d8);
                i10++;
            }
        } else {
            long j13 = j10 / j11;
    ...
    public static float constrainValue(float f, float f10, float f11) {
    ...
    public static int binarySearchFloor(int[] iArr, int i10, boolean z9, boolean z10) {
        int i11;
        int i12;
    ...
    public static int binarySearchCeil(long[] jArr, long j10, boolean z9, boolean z10) {
        ...
        return z10 ? Math.min(jArr.length - 1, i11) : i11;
    }
