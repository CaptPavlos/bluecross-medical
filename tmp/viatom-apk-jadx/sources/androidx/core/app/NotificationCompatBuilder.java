...
class NotificationCompatBuilder implements NotificationBuilderWithBuilderAccessor {
    ...
    public NotificationCompatBuilder(NotificationCompat.Builder builder) {
        ...
        if (style instanceof NotificationCompat.CallStyle) {
            ...
            int i12 = 0;
            while (i12 < size) {
                NotificationCompat.Action action = actionsListWithSystemActions.get(i12);
                i12++;
                addAction(action);
            }
        } else {
            ...
            int i13 = 0;
            while (i13 < size2) {
                NotificationCompat.Action action2 = arrayList.get(i13);
                i13++;
                addAction(action2);
            }
        }
        ...
        if (builder.mInvisibleActions.size() > 0) {
            ...
            for (int i14 = 0; i14 < builder.mInvisibleActions.size(); i14++) {
                bundle4.putBundle(Integer.toString(i14), NotificationCompatJellybean.getBundleForAction(builder.mInvisibleActions.get(i14)));
            }
        ...
        if (i15 >= 28) {
            ...
            while (i11 < size3) {
                Person person = arrayList2.get(i11);
                i11++;
        ...
        if (i16 >= 31 && (i10 = builder.mFgsDeferBehavior) != 0) {
