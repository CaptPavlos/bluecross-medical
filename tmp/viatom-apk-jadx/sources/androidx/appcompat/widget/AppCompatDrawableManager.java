...
public final class AppCompatDrawableManager {
    ...
    public static synchronized void preload() {
        if (INSTANCE == null) {
            ...
            INSTANCE.mResourceManager.setHooks(new ResourceManagerInternal.ResourceManagerHooks() { // from class: androidx.appcompat.widget.AppCompatDrawableManager.1
                ...
                private LayerDrawable getRatingBarLayerDrawable(@NonNull ResourceManagerInternal resourceManagerInternal, @NonNull Context context, @DimenRes int i10) throws Resources.NotFoundException {
    ...
    public synchronized Drawable getDrawable(@NonNull Context context, @DrawableRes int i10, boolean z9) {
        return this.mResourceManager.getDrawable(context, i10, z9);
    }
}
