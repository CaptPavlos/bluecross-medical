...
public final class MutableIntLongMap extends IntLongMap {
    ...
    private final void resizeStorage(int i10) {
        ...
        while (i12 < i11) {
            if (((jArr2[i12 >> 3] >> ((i12 & 7) << 3)) & 255) < 128) {
                ...
                jArr5[i16] = (jArr5[i16] & (~(255 << i17))) | (j10 << i17);
                int i18 = mutableIntLongMap._capacity;
                int i19 = ((iFindFirstAvailableSlot - 7) & i18) + (i18 & 7);
                int i20 = i19 >> 3;
                int i21 = (i19 & 7) << 3;
                jArr = jArr2;
                jArr5[i20] = ((~(255 << i21)) & jArr5[i20]) | (j10 << i21);
    ...
    public final long getOrPut(int i10, g7.a aVar) {
        aVar.getClass();
        ...
        while (true) {
            ...
            if ((((~j10) << 7) & j10 & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i12 = 0; i12 < i11; i12++) {
                    if ((255 & j10) < 128) {
                        int i13 = (i10 << 3) + i12;
                        if (((Boolean) pVar.invoke(Integer.valueOf(this.keys[i13]), Long.valueOf(this.values[i13]))).booleanValue()) {
                            removeValueAt(i13);
                        }
                    }
                    j10 >>= 8;
    ...
    public /* synthetic */ MutableIntLongMap(int i10, int i11, g gVar) {
        this((i11 & 1) != 0 ? 6 : i10);
    }
