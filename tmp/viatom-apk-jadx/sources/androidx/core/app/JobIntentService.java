...
public abstract class JobIntentService extends Service {
    ...
    public static void enqueueWork(@NonNull Context context, @NonNull ComponentName componentName, int i10, @NonNull Intent intent) {
        if (intent == null) {
            com.google.gson.internal.a.n("work must not be null");
            return;
        }
        synchronized (sLock) {
    ...
    public static WorkEnqueuer getWorkEnqueuer(Context context, ComponentName componentName, boolean z9, int i10) {
        ...
        if (Build.VERSION.SDK_INT < 26) {
            ...
            if (!z9) {
                com.google.gson.internal.a.n("Can't be here without a job id");
                return null;
            }
    ...
    public static abstract class WorkEnqueuer {
        ...
        public void ensureJobId(int i10) {
            if (!this.mHasJobId) {
                ...
                StringBuilder sbR = a3.a.r(i10, "Given job ID ", " is different than previous ");
                sbR.append(this.mJobId);
