...
final class GradientColorInflaterCompat {
    ...
    private static ColorStops checkColors(@Nullable ColorStops colorStops, @ColorInt int i10, @ColorInt int i11, boolean z9, @ColorInt int i12) {
        return colorStops != null ? colorStops : z9 ? new ColorStops(i10, i12, i11) : new ColorStops(i10, i11);
    }
