...
public class NotificationCompat {
    ...
    public static class DecoratedCustomViewStyle extends Style {
        ...
        private RemoteViews createRemoteViews(RemoteViews remoteViews, boolean z9) throws Resources.NotFoundException {
            int iMin;
            int i10 = 0;
    ...
    public static Action getActionCompatFromAction(@NonNull Notification.Action action) {
        ...
        boolean z9 = i12 >= 24 ? Api20Impl.getExtras(action).getBoolean("android.support.allowGeneratedReplies") || Api24Impl.getAllowGeneratedReplies(action) : Api20Impl.getExtras(action).getBoolean("android.support.allowGeneratedReplies");
        ...
        return new Action(i10, action.title, action.actionIntent, Api20Impl.getExtras(action), remoteInputArr, (RemoteInput[]) null, z9, semanticAction, z10, zIsContextual, zIsAuthenticationRequired);
    }
        ...
        if (Build.VERSION.SDK_INT >= 28) {
            ...
            if (parcelableArrayList != null && !parcelableArrayList.isEmpty()) {
                ...
                while (i10 < size) {
                    ...
                    i10++;
                    arrayList.add(Person.fromAndroidPerson(androidx.constraintlayout.core.state.b.c(obj)));
                }
            }
        } else {
        ...
        public Builder(@NonNull Context context, @NonNull Notification notification) {
            ...
            if (Build.VERSION.SDK_INT >= 28 && (parcelableArrayList = notification.extras.getParcelableArrayList(NotificationCompat.EXTRA_PEOPLE_LIST)) != null && !parcelableArrayList.isEmpty()) {
                ...
                while (i10 < size) {
                    Object obj = parcelableArrayList.get(i10);
                    i10++;
                    addPerson(Person.fromAndroidPerson(androidx.constraintlayout.core.state.b.c(obj)));
                }
            }
    ...
    public static class CallStyle extends Style {
        ...
        private CallStyle(int i10, @NonNull Person person, @Nullable PendingIntent pendingIntent, @Nullable PendingIntent pendingIntent2, @Nullable PendingIntent pendingIntent3) {
            if (person == null || TextUtils.isEmpty(person.getName())) {
                com.google.gson.internal.a.n("person must have a non-empty a name");
                throw null;
            }
            this.mCallType = i10;
            this.mPerson = person;
        ...
        private Action makeAnswerAction() {
            ...
            return makeAction(z9 ? i10 : i11, z9 ? R.string.call_notification_answer_video_action : R.string.call_notification_answer_action, this.mAnswerButtonColor, R.color.call_notification_answer_color, pendingIntent);
        }
        ...
        private Action makeNegativeAction() {
            ...
            return pendingIntent == null ? makeAction(i10, R.string.call_notification_hang_up_action, num, R.color.call_notification_decline_color, this.mHangUpIntent) : makeAction(i10, R.string.call_notification_decline_action, num, R.color.call_notification_decline_color, pendingIntent);
        }
        ...
        public ArrayList<Action> getActionsListWithSystemActions() {
            ...
            if (arrayList2 != null) {
                ...
                while (i11 < size) {
                    ...
                    } else if (!isActionAddedByCallStyle(action2) && i10 > 1) {
                        arrayList.add(action2);
                        i10--;
                    }
        ...
        public void restoreFromCompatExtras(@NonNull Bundle bundle) {
            ...
            if (Build.VERSION.SDK_INT >= 28 && bundle.containsKey(NotificationCompat.EXTRA_CALL_PERSON)) {
                this.mPerson = Person.fromAndroidPerson(androidx.constraintlayout.core.state.b.c(bundle.getParcelable(NotificationCompat.EXTRA_CALL_PERSON)));
    ...
    public static class MessagingStyle extends Style {
        ...
        public MessagingStyle(@NonNull Person person) {
            if (TextUtils.isEmpty(person.getName())) {
                com.google.gson.internal.a.n("User's name must not be empty.");
                throw null;
            }
            this.mUser = person;
        }
        ...
        private Message findLatestIncomingMessage() {
            ...
            while (true) {
                ...
                if (size < 0) {
                    ...
                    return (Message) a3.a.e(1, this.mMessages);
                }
        ...
        public void apply(NotificationBuilderWithBuilderAccessor notificationBuilderWithBuilderAccessor) {
            ...
            if (i10 >= 24) {
                ...
                Notification.MessagingStyle messagingStyleCreateMessagingStyle = i10 >= 28 ? Api28Impl.createMessagingStyle(person.toAndroidPerson()) : Api24Impl.createMessagingStyle(person.getName());
    ...
    public static abstract class Style {
        ...
        public static class Api24Impl {
            ...
            @DoNotInline
            public static void setChronometerCountDown(RemoteViews remoteViews, int i10, boolean z9) {
    ...
    public static final class BubbleMetadata {
        ...
        public static final class Builder {
            ...
            public Builder(@NonNull PendingIntent pendingIntent, @NonNull IconCompat iconCompat) {
                if (pendingIntent == null) {
                    androidx.window.layout.c.k("Bubble requires non-null pending intent");
                    throw null;
                }
                if (iconCompat == null) {
                    androidx.window.layout.c.k("Bubbles require non-null icon");
                    throw null;
                }
                this.mPendingIntent = pendingIntent;
                this.mIcon = iconCompat;
            ...
            @NonNull
            private Builder setFlag(int i10, boolean z9) {
                int i11 = this.mFlags;
                if (z9) {
                    this.mFlags = i10 | i11;
                    return this;
            ...
            public BubbleMetadata build() {
                ...
                if (str == null && this.mPendingIntent == null) {
                    androidx.window.layout.c.k("Must supply pending intent or shortcut to bubble");
                    return null;
                }
                if (str == null && this.mIcon == null) {
                    androidx.window.layout.c.k("Must supply an icon or shortcut for the bubble");
                    return null;
                }
            ...
            public Builder setIcon(@NonNull IconCompat iconCompat) {
                if (this.mShortcutId != null) {
                    androidx.window.layout.c.g("Created as a shortcut bubble, cannot set an Icon. Consider using BubbleMetadata.Builder(PendingIntent,Icon) instead.");
                    return null;
                }
                if (iconCompat != null) {
                    this.mIcon = iconCompat;
            ...
            public Builder setIntent(@NonNull PendingIntent pendingIntent) {
                if (this.mShortcutId != null) {
                    androidx.window.layout.c.g("Created as a shortcut bubble, cannot set a PendingIntent. Consider using BubbleMetadata.Builder(PendingIntent,Icon) instead.");
                    return null;
                }
                if (pendingIntent != null) {
                    this.mPendingIntent = pendingIntent;
            ...
            public Builder(@NonNull String str) {
                if (!TextUtils.isEmpty(str)) {
                    ...
                    androidx.window.layout.c.k("Bubble requires a non-null shortcut id");
                    throw null;
                }
            }
    ...
    public static class Action {
        ...
        public static final class Builder {
            ...
            private void checkContextualActionNullFields() {
                if (this.mIsContextual && this.mIntent == null) {
                    androidx.window.layout.c.k("Contextual Actions must contain a valid PendingIntent");
                }
            }
        ...
        public Action(int i10, @Nullable CharSequence charSequence, @Nullable PendingIntent pendingIntent, @Nullable Bundle bundle, @Nullable RemoteInput[] remoteInputArr, @Nullable RemoteInput[] remoteInputArr2, boolean z9, int i11, boolean z10, boolean z11, boolean z12) {
            this(i10 != 0 ? IconCompat.createWithResource(null, "", i10) : null, charSequence, pendingIntent, bundle, remoteInputArr, remoteInputArr2, z9, i11, z10, z11, z12);
        }
