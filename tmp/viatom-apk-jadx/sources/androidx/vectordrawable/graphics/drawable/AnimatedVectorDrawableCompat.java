...
public class AnimatedVectorDrawableCompat extends VectorDrawableCommon implements Animatable2Compat {
    ...
    @Nullable
    public static AnimatedVectorDrawableCompat create(@NonNull Context context, @DrawableRes int i10) throws XmlPullParserException, Resources.NotFoundException, IOException {
        int next;
        if (Build.VERSION.SDK_INT >= 24) {
                ...
                if (ANIMATED_VECTOR.equals(name)) {
                    ...
                    if (resourceId2 != 0) {
                        ...
                        if (context == null) {
                            ...
                            c.g("Context can't be null when inflating animators");
                            return;
                        }
