...
public final class MaterialDynamicColors {
    ...
    public static double findDesiredChromaByTone(double d8, double d10, double d11, boolean z9) {
        ...
        if (hctFrom.getChroma() < d10) {
            ...
            while (hctFrom.getChroma() < d10) {
                d11 += z9 ? -1.0d : 1.0d;
                Hct hctFrom2 = Hct.from(d8, d10, d11);
                if (chroma > hctFrom2.getChroma() || Math.abs(hctFrom2.getChroma() - d10) < 0.4d) {
                    return d11;
                }
                if (Math.abs(hctFrom2.getChroma() - d10) < Math.abs(hctFrom.getChroma() - d10)) {
                    hctFrom = hctFrom2;
                }
    ...
    public DynamicColor error() {
        return new DynamicColor(CampaignEx.JSON_NATIVE_VIDEO_ERROR, new b(21), new b(23), true, new g(this, 13), null, new ContrastCurve(3.0d, 4.5d, 7.0d, 7.0d), new c(this, 11));
    }

    @NonNull
    public DynamicColor errorContainer() {
        int i10 = 13;
        return new DynamicColor("error_container", new d(7), new d(8), true, new g(this, i10), null, new ContrastCurve(1.0d, 1.0d, 3.0d, 4.5d), new c(this, i10));
    }
    ...
    public DynamicColor primary() {
        int i10 = 13;
        return new DynamicColor("primary", new d(12), new d(i10), true, new g(this, i10), null, new ContrastCurve(3.0d, 4.5d, 7.0d, 7.0d), new c(this, 15));
    }
