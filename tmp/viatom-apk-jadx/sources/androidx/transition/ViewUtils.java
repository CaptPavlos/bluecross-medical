...
class ViewUtils {
    ...
    public static void setLeftTopRightBottom(@NonNull View view, int i10, int i11, int i12, int i13) throws IllegalAccessException, NoSuchMethodException, SecurityException, IllegalArgumentException, InvocationTargetException {
    ...
    public static void setTransitionVisibility(@NonNull View view, int i10) throws IllegalAccessException, NoSuchFieldException, SecurityException, IllegalArgumentException {
