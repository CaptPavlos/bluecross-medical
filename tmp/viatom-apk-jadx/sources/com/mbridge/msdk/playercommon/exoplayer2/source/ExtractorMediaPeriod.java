...
final class ExtractorMediaPeriod implements ExtractorOutput, MediaPeriod, SampleQueue.UpstreamFormatChangedListener, Loader.Callback<ExtractingLoadable>, Loader.ReleaseCallback {
    ...
    public final class ExtractingLoadable implements Loader.Loadable {
        ...
        public final void setLoadPosition(long j10, long j11) {
    ...
    public static final class ExtractorHolder {
        ...
        public final Extractor selectExtractor(ExtractorInput extractorInput, Uri uri) throws InterruptedException, IOException {
            ...
            if (extractor3 == null) {
                throw new UnrecognizedInputFormatException(a.o(new StringBuilder("None of the available extractors ("), Util.getCommaDelimitedSimpleClassNames(this.extractors), ") could read the stream."), uri);
            }
    ...
    public interface Listener {
        void onSourceInfoRefreshed(long j10, boolean z9);
    }
    ...
    public final class SampleStreamImpl implements SampleStream {
        ...
        public final int readData(FormatHolder formatHolder, DecoderInputBuffer decoderInputBuffer, boolean z9) {
            return ExtractorMediaPeriod.this.readData(this.track, formatHolder, decoderInputBuffer, z9);
        }
    ...
    public void maybeFinishPrepare() {
        ...
        while (true) {
            ...
            this.trackIsAudioVideoFlags[i10] = z9;
    ...
    public final void discardBuffer(long j10, boolean z9) {
        int length = this.sampleQueues.length;
        for (int i10 = 0; i10 < length; i10++) {
            this.sampleQueues[i10].discardTo(j10, z9, this.trackEnabledStates[i10]);
        }
    }
    ...
    @Override // com.mbridge.msdk.playercommon.exoplayer2.upstream.Loader.Callback
    public final int onLoadError(ExtractingLoadable extractingLoadable, long j10, long j11, IOException iOException) {
        ...
        boolean z9 = extractedSamplesCount > this.extractedSamplesCountAtStartOfLoad;
    ...
    public final int readData(int i10, FormatHolder formatHolder, DecoderInputBuffer decoderInputBuffer, boolean z9) throws IllegalStateException {
        if (suppressRead()) {
            return -3;
        }
        int i11 = this.sampleQueues[i10].read(formatHolder, decoderInputBuffer, z9, this.loadingFinished, this.lastSeekPositionUs);
        if (i11 == -4) {
        ...
        for (int i14 = 0; i14 < trackSelectionArr.length; i14++) {
            if (sampleStreamArr[i14] == null && (trackSelection = trackSelectionArr[i14]) != null) {
                ...
                if (!z9) {
                    ...
                    sampleQueue.rewind();
                    z9 = sampleQueue.advanceTo(j10, true, true) == -1 && sampleQueue.getReadIndex() != 0;
                }
            }
        }
        if (this.enabledTrackCount == 0) {
    ...
    public final int skipData(int i10, long j10) {
        int iAdvanceToEnd = 0;
        if (suppressRead()) {
            return 0;
        }
