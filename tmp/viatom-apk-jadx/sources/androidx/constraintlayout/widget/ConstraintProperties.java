...
public class ConstraintProperties {
    ...
    public ConstraintProperties(View view) {
        ...
        if (!(layoutParams instanceof ConstraintLayout.LayoutParams)) {
            a.j("Only children of ConstraintLayout.LayoutParams supported");
            throw null;
        }
    ...
    public ConstraintProperties center(int i10, int i11, int i12, int i13, int i14, int i15, float f) {
        if (i12 < 0) {
            com.google.gson.internal.a.n("margin must be > 0");
            return null;
        }
        if (i15 < 0) {
            com.google.gson.internal.a.n("margin must be > 0");
        ...
        if (f <= 0.0f || f > 1.0f) {
            com.google.gson.internal.a.n("bias must be between 0 and 1 inclusive");
            return null;
        }
        if (i11 == 1 || i11 == 2) {
        ...
        switch (i10) {
            case 1:
                if (i12 == 1) {
                    ...
                    if (i12 != 2) {
                        com.google.gson.internal.a.n(a3.a.o(new StringBuilder("Left to "), sideToString(i12), " undefined"));
                        return null;
                    }
            ...
            case 2:
                if (i12 == 1) {
                    ...
                    if (i12 != 2) {
                        com.google.gson.internal.a.n(a3.a.o(new StringBuilder("right to "), sideToString(i12), " undefined"));
                        return null;
                    }
            ...
            default:
                ...
                sb.append(sideToString(i10));
                sb.append(" to ");
                com.google.gson.internal.a.n(a3.a.o(sb, sideToString(i12), " unknown"));
                return null;
        }
    }
    ...
    public ConstraintProperties goneMargin(int i10, int i11) {
        switch (i10) {
            ...
            case 4:
                ...
                return this;
            case 5:
                com.google.gson.internal.a.n("baseline does not support margins");
                return null;
            case 6:
            ...
            case 7:
                ...
                return this;
            default:
                com.google.gson.internal.a.n("unknown constraint");
                return null;
        }
    }
    ...
    public ConstraintProperties centerHorizontally(int i10, int i11, int i12, int i13, int i14, int i15, float f) {
        connect(1, i10, i11, i12);
        connect(2, i13, i14, i15);
        this.mParams.horizontalBias = f;
        return this;
    ...
    public ConstraintProperties centerHorizontallyRtl(int i10, int i11, int i12, int i13, int i14, int i15, float f) {
        connect(6, i10, i11, i12);
        connect(7, i13, i14, i15);
        this.mParams.horizontalBias = f;
        return this;
    ...
    public ConstraintProperties centerVertically(int i10, int i11, int i12, int i13, int i14, int i15, float f) {
        connect(3, i10, i11, i12);
        connect(4, i13, i14, i15);
        this.mParams.verticalBias = f;
        return this;
