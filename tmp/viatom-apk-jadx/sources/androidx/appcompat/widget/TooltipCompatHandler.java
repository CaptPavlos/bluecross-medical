...
class TooltipCompatHandler implements View.OnLongClickListener, View.OnHoverListener, View.OnAttachStateChangeListener {
    ...
    private TooltipCompatHandler(View view, CharSequence charSequence) {
        ...
        this.mShowRunnable = new Runnable(this) { // from class: androidx.appcompat.widget.c
            ...
            public final /* synthetic */ TooltipCompatHandler f442b;
    ...
    private boolean updateAnchorPos(MotionEvent motionEvent) {
        ...
        if (!this.mForceNextChangeSignificant && Math.abs(x3 - this.mAnchorX) <= this.mHoverSlop && Math.abs(y - this.mAnchorY) <= this.mHoverSlop) {
            return false;
        }
        this.mAnchorX = x3;
        this.mAnchorY = y;
    ...
    public void show(boolean z9) throws Resources.NotFoundException {
