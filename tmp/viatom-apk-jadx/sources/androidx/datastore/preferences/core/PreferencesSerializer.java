...
public final class PreferencesSerializer implements OkioSerializer<Preferences> {
    ...
    public Object readFrom(k kVar, w6.c cVar) throws IOException {
        PreferencesProto.PreferenceMap from = PreferencesMapCompat.Companion.readFrom(kVar.inputStream());
    ...
    @Override // androidx.datastore.core.okio.OkioSerializer
    public Object writeTo(Preferences preferences, j jVar, w6.c cVar) throws IOException {
        ...
        builderNewBuilder.build().writeTo(jVar.outputStream());
        return w.f12711a;
    }
