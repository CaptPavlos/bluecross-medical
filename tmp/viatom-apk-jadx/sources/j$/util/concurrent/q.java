...
public final class q extends l {
    ...
    public static final long f9393i;
    public r e;
    public volatile r f;
    ...
    static {
        ...
        h = aVar;
        f9393i = aVar.h(q.class, "lockState");
    }
    ...
    */
    public q(j$.util.concurrent.r r11) {
        ...
        L8:
            if (r11 == 0) goto L6c
            j$.util.concurrent.l r2 = r11.f9384d
        ...
        L19:
            ...
            goto L68
        L1b:
            java.lang.Object r4 = r11.f9382b
            int r5 = r11.f9381a
            r6 = r0
            r7 = r1
        L21:
            java.lang.Object r8 = r6.f9382b
            int r9 = r6.f9381a
            if (r9 <= r5) goto L29
            r8 = -1
            goto L51
    ...
    public final void d() {
        ...
        while (true) {
            ...
            if ((i10 & (-3)) == 0) {
                if (h.c(this, f9393i, i10, 1)) {
                    break;
                }
            } else if ((i10 & 2) == 0) {
                if (h.c(this, f9393i, i10, i10 | 2)) {
    ...
    */
    public final j$.util.concurrent.l a(int r9, java.lang.Object r10) {
        ...
        L1b:
            return r0
        L1c:
            j$.util.concurrent.l r0 = r0.f9384d
            r3 = r8
            goto L2
        L20:
            j$.sun.misc.a r2 = j$.util.concurrent.q.h
            long r4 = j$.util.concurrent.q.f9393i
            int r7 = r6 + 4
            r3 = r8
        ...
        L45:
            ...
            long r0 = j$.util.concurrent.q.f9393i
            int r10 = r10.e(r8, r0)
            if (r10 != r6) goto L58
    ...
    */
    ...
    public static r c(r rVar, r rVar2) {
        ...
        while (true) {
            ...
            if (!rVar4.f9394i || (rVar3 = rVar4.e) == null) {
                break;
            }
            r rVar5 = rVar3.f;
            if (rVar4 == rVar5) {
                r rVar6 = rVar3.g;
                if (rVar6 != null && rVar6.f9394i) {
                    rVar6.f9394i = false;
                    rVar4.f9394i = false;
                    rVar3.f9394i = true;
                    rVar2 = rVar3;
            ...
            } else if (rVar5 != null && rVar5.f9394i) {
                rVar5.f9394i = false;
                rVar4.f9394i = false;
                rVar3.f9394i = true;
                rVar2 = rVar3;
        ...
        while (rVar2 != null && rVar2 != rVar) {
            ...
            if (rVar4 == rVar2) {
                ...
                if (rVar5 != null) {
                    r rVar6 = rVar5.f;
                    r rVar7 = rVar5.g;
                    if ((rVar7 == null || !rVar7.f9394i) && (rVar6 == null || !rVar6.f9394i)) {
                        rVar5.f9394i = true;
                    } else {
                        if (rVar7 == null || !rVar7.f9394i) {
                            if (rVar6 != null) {
                                rVar6.f9394i = false;
                            }
                            rVar5.f9394i = true;
                        ...
                        if (rVar5 != null) {
                            rVar5.f9394i = rVar3 == null ? false : rVar3.f9394i;
                            r rVar8 = rVar5.g;
                            if (rVar8 != null) {
                                rVar8.f9394i = false;
                            }
                ...
                if (rVar4 != null) {
                    r rVar9 = rVar4.f;
                    r rVar10 = rVar4.g;
                    if ((rVar9 == null || !rVar9.f9394i) && (rVar10 == null || !rVar10.f9394i)) {
                        rVar4.f9394i = true;
                    } else {
                        if (rVar9 == null || !rVar9.f9394i) {
                            if (rVar10 != null) {
                                rVar10.f9394i = false;
                            }
                            rVar4.f9394i = true;
                        ...
                        if (rVar4 != null) {
                            rVar4.f9394i = rVar3 == null ? false : rVar3.f9394i;
                            r rVar11 = rVar4.f;
                            if (rVar11 != null) {
                                rVar11.f9394i = false;
                            }
