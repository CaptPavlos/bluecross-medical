...
interface Writer {
    ...
    void writeBool(int i10, boolean z9) throws IOException;

    void writeBoolList(int i10, List<Boolean> list, boolean z9) throws IOException;
    ...
    void writeDouble(int i10, double d8) throws IOException;

    void writeDoubleList(int i10, List<Double> list, boolean z9) throws IOException;
    ...
    void writeEnumList(int i10, List<Integer> list, boolean z9) throws IOException;

    void writeFixed32(int i10, int i11) throws IOException;

    void writeFixed32List(int i10, List<Integer> list, boolean z9) throws IOException;

    void writeFixed64(int i10, long j10) throws IOException;

    void writeFixed64List(int i10, List<Long> list, boolean z9) throws IOException;

    void writeFloat(int i10, float f) throws IOException;

    void writeFloatList(int i10, List<Float> list, boolean z9) throws IOException;
    ...
    void writeInt32List(int i10, List<Integer> list, boolean z9) throws IOException;

    void writeInt64(int i10, long j10) throws IOException;

    void writeInt64List(int i10, List<Long> list, boolean z9) throws IOException;
    ...
    void writeSFixed32List(int i10, List<Integer> list, boolean z9) throws IOException;

    void writeSFixed64(int i10, long j10) throws IOException;

    void writeSFixed64List(int i10, List<Long> list, boolean z9) throws IOException;

    void writeSInt32(int i10, int i11) throws IOException;

    void writeSInt32List(int i10, List<Integer> list, boolean z9) throws IOException;

    void writeSInt64(int i10, long j10) throws IOException;

    void writeSInt64List(int i10, List<Long> list, boolean z9) throws IOException;
    ...
    void writeUInt32List(int i10, List<Integer> list, boolean z9) throws IOException;

    void writeUInt64(int i10, long j10) throws IOException;

    void writeUInt64List(int i10, List<Long> list, boolean z9) throws IOException;
}
