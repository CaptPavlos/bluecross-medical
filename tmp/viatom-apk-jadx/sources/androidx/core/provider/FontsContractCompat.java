...
public class FontsContractCompat {
    ...
    public static class FontInfo {
        ...
        @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP_PREFIX})
        @Deprecated
        public FontInfo(@NonNull Uri uri, @IntRange(from = FabTransformationScrimBehavior.COLLAPSE_DELAY) int i10, @IntRange(from = 1, to = DownloadService.DEFAULT_FOREGROUND_NOTIFICATION_UPDATE_INTERVAL) int i11, boolean z9, int i12) {
        ...
        public static FontInfo create(@NonNull Uri uri, @IntRange(from = FabTransformationScrimBehavior.COLLAPSE_DELAY) int i10, @IntRange(from = 1, to = DownloadService.DEFAULT_FOREGROUND_NOTIFICATION_UPDATE_INTERVAL) int i11, boolean z9, int i12) {
            return new FontInfo(uri, i10, i11, z9, i12);
        }
    ...
    @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP_PREFIX})
    @Deprecated
    public static Typeface getFontSync(Context context, FontRequest fontRequest, @Nullable ResourcesCompat.FontCallback fontCallback, @Nullable Handler handler, boolean z9, int i10, int i11) {
        return requestFont(context, fontRequest, i11, z9, i10, ResourcesCompat.FontCallback.getHandler(handler), new TypefaceCompat.ResourcesCallbackAdapter(fontCallback));
    }
    ...
    @Nullable
    @RestrictTo({RestrictTo.Scope.LIBRARY})
    public static Typeface requestFont(@NonNull Context context, @NonNull FontRequest fontRequest, int i10, boolean z9, @IntRange(from = FabTransformationScrimBehavior.COLLAPSE_DELAY) int i11, @NonNull Handler handler, @NonNull FontRequestCallback fontRequestCallback) {
