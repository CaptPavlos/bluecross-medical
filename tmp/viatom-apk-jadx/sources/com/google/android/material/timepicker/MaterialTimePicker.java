...
public final class MaterialTimePicker extends DialogFragment implements TimePickerView.OnDoubleTapListener {
    ...
    private Pair<Integer, Integer> dataForMode(int i10) {
        ...
        com.google.gson.internal.a.n(a3.a.f(i10, "no icon for mode: "));
        return null;
    }
    ...
    public static final class Builder {
        ...
        @NonNull
        public Builder setHour(@IntRange(from = FabTransformationScrimBehavior.COLLAPSE_DELAY, to = 23) int i10) {
        ...
        @NonNull
        public Builder setMinute(@IntRange(from = FabTransformationScrimBehavior.COLLAPSE_DELAY, to = 59) int i10) {
            this.time.setMinute(i10);
            return this;
        }
