...
public final class MutableLongFloatMap extends LongFloatMap {
    ...
    private final void resizeStorage(int i10) {
        ...
        while (i12 < i11) {
            if (((jArr2[i12 >> 3] >> ((i12 & 7) << 3)) & 255) < 128) {
                ...
                int i14 = i13 ^ (i13 << 16);
                int iFindFirstAvailableSlot = mutableLongFloatMap.findFirstAvailableSlot(i14 >>> 7);
                long j11 = i14 & 127;
                ...
                int i17 = mutableLongFloatMap._capacity;
    ...
    public final float getOrPut(long j10, g7.a aVar) {
        aVar.getClass();
    ...
    public final float put(long j10, float f, float f10) {
        ...
        while (true) {
            ...
            if ((((~j10) << 7) & j10 & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i12 = 0; i12 < i11; i12++) {
                    if ((255 & j10) < 128) {
                        int i13 = (i10 << 3) + i12;
                        if (((Boolean) pVar.invoke(Long.valueOf(this.keys[i13]), Float.valueOf(this.values[i13]))).booleanValue()) {
                            removeValueAt(i13);
                        }
                    }
                    j10 >>= 8;
    ...
    public /* synthetic */ MutableLongFloatMap(int i10, int i11, g gVar) {
        this((i11 & 1) != 0 ? 6 : i10);
    }
