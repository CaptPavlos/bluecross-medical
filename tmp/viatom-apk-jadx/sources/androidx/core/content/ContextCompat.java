...
public class ContextCompat {
    ...
    public static String obtainAndCheckReceiverPermission(Context context) {
        ...
        a2.a.j(androidx.constraintlayout.core.widgets.analyzer.a.x("Permission ", str, " is required by your application to receive broadcasts, please add it to your manifest"));
        return null;
    }
    ...
    public static Intent registerReceiver(@NonNull Context context, @Nullable BroadcastReceiver broadcastReceiver, @NonNull IntentFilter intentFilter, @Nullable String str, @Nullable Handler handler, int i10) {
        int i11 = i10 & 1;
        if (i11 != 0 && (i10 & 4) != 0) {
            com.google.gson.internal.a.n("Cannot specify both RECEIVER_VISIBLE_TO_INSTANT_APPS and RECEIVER_NOT_EXPORTED");
            return null;
        }
        if (i11 != 0) {
            i10 |= 2;
        ...
        int i13 = i12 & 2;
        if (i13 == 0 && (i12 & 4) == 0) {
            com.google.gson.internal.a.n("One of either RECEIVER_EXPORTED or RECEIVER_NOT_EXPORTED is required");
            return null;
        }
        if (i13 == 0 || (i12 & 4) == 0) {
        ...
        com.google.gson.internal.a.n("Cannot specify both RECEIVER_EXPORTED and RECEIVER_NOT_EXPORTED");
        return null;
    }
