...
final class Sonic {
    ...
    public Sonic(int i10, int i11, float f, float f10, int i12) {
    ...
    private void adjustRate(float f, int i10) {
        int i11;
        int i12;
    ...
    private int insertPitchPeriod(short[] sArr, int i10, float f, int i11) {
        int i12;
        if (f < 0.5f) {
            i12 = (int) ((i11 * f) / (1.0f - f));
        } else {
            this.remainingInputToCopyFrameCount = (int) ((((2.0f * f) - 1.0f) * i11) / (1.0f - f));
            i12 = i11;
        }
        int i13 = i11 + i12;
    ...
    private short interpolate(short[] sArr, int i10, int i11, int i12) {
        ...
        int i17 = i16 - i13;
        int i18 = i16 - i15;
        return (short) ((((i18 - i17) * s10) + (s9 * i17)) / i18);
    }
    ...
    private int skipPitchPeriod(short[] sArr, int i10, float f, int i11) {
        int i12;
        if (f >= 2.0f) {
            i12 = (int) (i11 / (f - 1.0f));
        } else {
            this.remainingInputToCopyFrameCount = (int) (((2.0f - f) * i11) / (f - 1.0f));
            i12 = i11;
        }
    ...
    public final void queueEndOfStream() {
        ...
        float f = this.speed;
        float f10 = this.pitch;
        int i12 = this.outputFrameCount + ((int) ((((i11 / (f / f10)) + this.pitchFrameCount) / (this.rate * f10)) + 0.5f));
