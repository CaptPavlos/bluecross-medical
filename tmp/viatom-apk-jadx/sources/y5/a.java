...
public final class a extends RecyclerView.ViewHolder {
    ...
    public final g5.b f13794a;

    /* renamed from: b, reason: collision with root package name */
    public final ImageView f13795b;

    /* renamed from: c, reason: collision with root package name */
    public final TextView f13796c;
    ...
    public a(View view, g5.b bVar) {
        ...
        ((RelativeLayout) viewFindViewById7).setOnClickListener(new e5.s(this, 29));
    }
    ...
    public final void a(h5.f fVar) {
        ...
        context.getClass();
        this.f13795b.setImageDrawable(v5.n.c(context, fVar.f8526c));
        this.f13796c.setText(fVar.f8525b);
        this.f13797d.setText(fVar.e);
        long j10 = fVar.f8533n;
        Context context2 = this.itemView.getContext();
        context2.getClass();
        this.e.setText(l1.b.M(context2, j10));
