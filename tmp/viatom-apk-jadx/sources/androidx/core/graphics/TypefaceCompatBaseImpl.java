...
class TypefaceCompatBaseImpl {
    ...
    private static <T> T findBestFont(T[] tArr, int i10, boolean z9, StyleExtractor<T> styleExtractor) {
        T t = null;
        int i11 = Integer.MAX_VALUE;
        for (T t9 : tArr) {
            int iAbs = (Math.abs(styleExtractor.getWeight(t9) - i10) * 2) + (styleExtractor.isItalic(t9) == z9 ? 0 : 1);
            if (t == null || i11 > iAbs) {
                t = t9;
                i11 = iAbs;
            }
    ...
    public Typeface createWeightStyle(@NonNull Context context, @NonNull Typeface typeface, int i10, boolean z9) {
        ...
        try {
            typefaceCreateWeightStyle = WeightTypefaceApi14.createWeightStyle(this, context, typeface, i10, z9);
        } catch (RuntimeException unused) {
    ...
    private FontResourcesParserCompat.FontFileResourceEntry findBestEntry(FontResourcesParserCompat.FontFamilyFilesResourceEntry fontFamilyFilesResourceEntry, int i10, boolean z9) {
        return (FontResourcesParserCompat.FontFileResourceEntry) findBestFont(fontFamilyFilesResourceEntry.getEntries(), i10, z9, new StyleExtractor<FontResourcesParserCompat.FontFileResourceEntry>() { // from class: androidx.core.graphics.TypefaceCompatBaseImpl.3
            @Override // androidx.core.graphics.TypefaceCompatBaseImpl.StyleExtractor
            public int getWeight(FontResourcesParserCompat.FontFileResourceEntry fontFileResourceEntry) {
                return fontFileResourceEntry.getWeight();
            }
    ...
    @Nullable
    public Typeface createFromFontFamilyFilesResourceEntry(Context context, FontResourcesParserCompat.FontFamilyFilesResourceEntry fontFamilyFilesResourceEntry, Resources resources, int i10, boolean z9) throws NoSuchFieldException, SecurityException {
        FontResourcesParserCompat.FontFileResourceEntry fontFileResourceEntryFindBestEntry = findBestEntry(fontFamilyFilesResourceEntry, i10, z9);
        if (fontFileResourceEntryFindBestEntry == null) {
            return null;
        }
