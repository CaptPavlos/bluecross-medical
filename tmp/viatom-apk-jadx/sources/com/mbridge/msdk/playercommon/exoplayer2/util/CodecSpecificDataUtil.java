...
public final class CodecSpecificDataUtil {
    ...
    public static byte[] buildAacAudioSpecificConfig(int i10, int i11, int i12) {
        return new byte[]{(byte) (((i10 << 3) & 248) | ((i11 >> 1) & 7)), (byte) (((i11 << 7) & 128) | ((i12 << 3) & R.styleable.ConstraintSet_stateLabels))};
    }
    ...
    public static byte[] buildAacLcAudioSpecificConfig(int i10, int i11) {
        ...
        a.n(androidx.constraintlayout.core.widgets.analyzer.a.u(i10, i11, "Invalid sample rate or number of channels: ", ", "));
        return null;
    }
    ...
    public static Pair<Integer, Integer> parseAacAudioSpecificConfig(ParsableBitArray parsableBitArray, boolean z9) throws ParserException {
        ...
        if (z9) {
            if (aacAudioObjectType != 1 && aacAudioObjectType != 2 && aacAudioObjectType != 3 && aacAudioObjectType != 4 && aacAudioObjectType != 6 && aacAudioObjectType != 7 && aacAudioObjectType != 17) {
                switch (aacAudioObjectType) {
                    ...
                    case 23:
                        break;
                    default:
                        a.i(a3.a.f(aacAudioObjectType, "Unsupported audio object type: "));
                        return null;
                }
            }
            ...
            switch (aacAudioObjectType) {
                ...
                case 23:
                    ...
                    if (bits2 == 2 || bits2 == 3) {
                        a.i(a3.a.f(bits2, "Unsupported epConfig: "));
                        return null;
                    }
            }
        }
