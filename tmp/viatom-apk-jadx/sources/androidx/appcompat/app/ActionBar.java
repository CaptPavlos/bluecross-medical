...
public abstract class ActionBar {
    ...
    @Deprecated
    public abstract void addTab(Tab tab, int i10, boolean z9);
    ...
    public void setElevation(float f) {
        ...
        a2.a.m("Setting a non-zero elevation is not supported in this action bar configuration.");
    }
    ...
    public void setHideOffset(int i10) {
        ...
        a2.a.m("Setting an explicit action bar hide offset is not supported in this action bar configuration.");
    }

    public void setHideOnContentScrollEnabled(boolean z9) {
        if (z9) {
            a2.a.m("Hide on content scroll is not supported in this action bar configuration.");
        }
    }
