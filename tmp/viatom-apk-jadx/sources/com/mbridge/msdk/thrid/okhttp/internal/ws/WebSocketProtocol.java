...
public final class WebSocketProtocol {
    ...
    public static String closeCodeExceptionMessage(int i10) {
        if (i10 < 1000 || i10 >= 5000) {
            return a.f(i10, "Code must be in range [1000,5000): ");
        }
        if ((i10 < 1004 || i10 > 1006) && (i10 < 1012 || i10 > 2999)) {
            return null;
        }
        return a.g(i10, "Code ", " is reserved and may not be used.");
    }
    ...
    public static void validateCloseCode(int i10) {
        ...
        com.google.gson.internal.a.n(strCloseCodeExceptionMessage);
    }
}
