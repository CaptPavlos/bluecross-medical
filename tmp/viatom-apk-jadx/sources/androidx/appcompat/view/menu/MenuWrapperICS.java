...
public class MenuWrapperICS extends BaseMenuWrapper implements Menu {
    ...
    public MenuWrapperICS(Context context, SupportMenu supportMenu) {
        ...
        if (supportMenu != null) {
            ...
            a.n("Wrapped Object can not be null.");
            throw null;
        }
    }
    ...
    public void setGroupCheckable(int i10, boolean z9, boolean z10) {
        this.mWrappedObject.setGroupCheckable(i10, z9, z10);
    }

    @Override // android.view.Menu
    public void setGroupEnabled(int i10, boolean z9) {
        this.mWrappedObject.setGroupEnabled(i10, z9);
    }

    @Override // android.view.Menu
    public void setGroupVisible(int i10, boolean z9) {
        this.mWrappedObject.setGroupVisible(i10, z9);
    }
