...
final class MediaPeriodHolder {
    ...
    public final long applyTrackSelection(long j10, boolean z9, boolean[] zArr) {
        int i10 = 0;
        while (true) {
            ...
            if (z9 || !trackSelectorResult.isEquivalent(this.periodTrackSelectorResult, i10)) {
                z10 = false;
            }
            zArr2[i10] = z10;
            i10++;
    ...
    public final void continueLoading(long j10) {
        this.mediaPeriod.continueLoading(toPeriodTime(j10));
    }

    public final long getBufferedPositionUs(boolean z9) {
        if (!this.prepared) {
            return this.info.startPositionUs;
        }
        long bufferedPositionUs = this.mediaPeriod.getBufferedPositionUs();
        return (bufferedPositionUs == Long.MIN_VALUE && z9) ? this.info.durationUs : bufferedPositionUs;
    }
    ...
    public final long toPeriodTime(long j10) {
        return j10 - getRendererOffset();
    }

    public final long toRendererTime(long j10) {
        return j10 + getRendererOffset();
    }

    public final long applyTrackSelection(long j10, boolean z9) {
        return applyTrackSelection(j10, z9, new boolean[this.rendererCapabilities.length]);
    }
}
