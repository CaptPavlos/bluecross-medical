...
final class XingSeeker implements Mp3Extractor.Seeker {
    ...
    public static XingSeeker create(long j10, long j11, MpegAudioHeader mpegAudioHeader, ParsableByteArray parsableByteArray) {
        ...
        if (j10 != -1) {
            ...
            if (j10 != j12) {
                StringBuilder sbX = a.x("XING data size mismatch: ", ", ", j10);
                sbX.append(j12);
                Log.w(TAG, sbX.toString());
            }
        }
    ...
    public final SeekMap.SeekPoints getSeekPoints(long j10) {
        ...
        double d8 = (jConstrainValue * 100.0d) / this.durationUs;
        double d10 = 0.0d;
        if (d8 > 0.0d) {
            if (d8 >= 100.0d) {
                d10 = 256.0d;
    ...
    public final long getTimeUs(long j10) {
        ...
        double d8 = (j11 * 256.0d) / this.dataSize;
        int iBinarySearchFloor = Util.binarySearchFloor(this.tableOfContents, (long) d8, true, true);
        ...
        return Math.round((j12 == (iBinarySearchFloor == 99 ? 256L : this.tableOfContents[i10]) ? 0.0d : (d8 - j12) / (r8 - j12)) * (timeUsForTableIndex2 - timeUsForTableIndex)) + timeUsForTableIndex;
    }
