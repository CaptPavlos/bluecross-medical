...
public final class Id3Decoder implements MetadataDecoder {
    ...
    public static final class Id3Header {
        ...
        public Id3Header(int i10, boolean z9, int i11) {
    ...
    private static ChapterFrame decodeChapterFrame(ParsableByteArray parsableByteArray, int i10, int i11, boolean z9, int i12, FramePredicate framePredicate) throws Throwable {
        ...
        while (parsableByteArray.getPosition() < i15) {
            Id3Frame id3FrameDecodeFrame = decodeFrame(i11, parsableByteArray, z9, i12, framePredicate);
    ...
    private static ChapterTocFrame decodeChapterTOCFrame(ParsableByteArray parsableByteArray, int i10, int i11, boolean z9, int i12, FramePredicate framePredicate) throws Throwable {
        int position = parsableByteArray.getPosition();
        int iIndexOfZeroByte = indexOfZeroByte(parsableByteArray.data, position);
        String str = new String(parsableByteArray.data, position, iIndexOfZeroByte - position, "ISO-8859-1");
        parsableByteArray.setPosition(iIndexOfZeroByte + 1);
    ...
    /* JADX WARN: Removed duplicated region for block: B:166:0x0200 A[Catch: all -> 0x01fe, UnsupportedEncodingException -> 0x022d, TryCatch #5 {all -> 0x01fe, blocks: (B:168:0x020e, B:171:0x022d, B:163:0x01f9, B:166:0x0200), top: B:179:0x0115 }] */
    /* JADX WARN: Removed duplicated region for block: B:168:0x020e A[Catch: all -> 0x01fe, UnsupportedEncodingException -> 0x022d, TRY_LEAVE, TryCatch #5 {all -> 0x01fe, blocks: (B:168:0x020e, B:171:0x022d, B:163:0x01f9, B:166:0x0200), top: B:179:0x0115 }] */
    ...
    */
    ...
    private static Id3Header decodeHeader(ParsableByteArray parsableByteArray) {
        ...
        if (unsignedInt24 != ID3_TAG) {
            a.B(unsignedInt24, "Unexpected first three bytes of ID3 tag header: ", TAG);
            return null;
        }
        int unsignedByte = parsableByteArray.readUnsignedByte();
        ...
        if (unsignedByte == 2) {
            ...
            if (unsignedByte != 4) {
                a.B(unsignedByte, "Skipped ID3 tag with unsupported majorVersion=", TAG);
                return null;
            }
            if ((unsignedByte2 & 64) != 0) {
    ...
    */
    ...
    public final Metadata decode(byte[] bArr, int i10) throws Throwable {
        ArrayList arrayList = new ArrayList();
        ...
        while (parsableByteArray.bytesLeft() >= i11) {
            Id3Frame id3FrameDecodeFrame = decodeFrame(id3HeaderDecodeHeader.majorVersion, parsableByteArray, z9, i11, this.framePredicate);
            if (id3FrameDecodeFrame != null) {
                arrayList.add(id3FrameDecodeFrame);
            }
        }
