...
public class FragmentController {
    ...
    public void restoreSaveState(@Nullable Parcelable parcelable) {
        ...
        if (fragmentHostCallback instanceof ViewModelStoreOwner) {
            ...
            androidx.window.layout.c.g("Your FragmentHostCallback must implement ViewModelStoreOwner to call restoreSaveState(). Call restoreAllState()  if you're still using retainNestedNonConfig().");
        }
    }
