...
public abstract class AbstractResolvableFuture<V> implements b {
    ...
    public static Object getFutureValue(b bVar) {
        ...
        try {
            ...
            return new Failure(new IllegalArgumentException("get() threw CancellationException, despite reporting isCancelled() == false: " + bVar, e));
        } catch (ExecutionException e3) {
    ...
    public final V get(long j10, TimeUnit timeUnit) throws ExecutionException, InterruptedException, TimeoutException {
        ...
        StringBuilder sbX = a.x("Waited ", " ", j10);
        sbX.append(timeUnit.toString().toLowerCase(locale));
        String string3 = sbX.toString();
        if (nanos + 1000 < 0) {
    ...
    public String pendingToString() {
        Object obj = this.value;
        if (obj instanceof SetFuture) {
            return a.o(new StringBuilder("setFuture=["), userObjectToString(((SetFuture) obj).future), "]");
        }
