...
public abstract class FloatSet {
    ...
    public static /* synthetic */ String joinToString$default(FloatSet floatSet, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i10, CharSequence charSequence4, l lVar, int i11, Object obj) {
        int i12;
        if (obj != null) {
        ...
        while (true) {
            ...
            if ((((~j10) << 7) & j10 & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i12 = 0; i12 < i11; i12++) {
                    if ((255 & j10) < 128 && !((Boolean) lVar.invoke(Float.valueOf(fArr[(i10 << 3) + i12]))).booleanValue()) {
                        return false;
                    }
                    j10 >>= 8;
                }
    ...
    */
    public final boolean any(g7.l r15) {
        ...
        L55:
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.collection.FloatSet.any(g7.l):boolean");
    }
        ...
        while (true) {
            ...
            if ((((~j10) << 7) & j10 & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i13 = 0; i13 < i12; i13++) {
                    if ((255 & j10) < 128 && ((Boolean) lVar.invoke(Float.valueOf(fArr[(i10 << 3) + i13]))).booleanValue()) {
                        i11++;
                    }
                    j10 >>= 8;
                }
    ...
    */
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final float first(g7.l r15) {
        /*
            r14 = this;
            r15.getClass()
            float[] r0 = r14.elements
        ...
        L54:
            ...
            return r15
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.collection.FloatSet.first(g7.l):float");
    }
    ...
    public int hashCode() {
        ...
        while (true) {
            ...
            if ((((~j10) << 7) & j10 & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i12 = 0; i12 < i11; i12++) {
                    if ((255 & j10) < 128) {
                        iFloatToIntBits = Float.floatToIntBits(fArr[(i10 << 3) + i12]) + iFloatToIntBits;
                    }
                    j10 >>= 8;
                }
                if (i11 != 8) {
