...
public final class ConnectionSpec {
    ...
    public static final class Builder {
        ...
        public Builder allEnabledCipherSuites() {
            ...
            c.g("no cipher suites for cleartext connections");
            return null;
        }
        ...
        public Builder allEnabledTlsVersions() {
            ...
            c.g("no TLS versions for cleartext connections");
            return null;
        }
        ...
        public Builder supportsTlsExtensions(boolean z9) {
            ...
            c.g("no TLS extensions for cleartext connections");
            return null;
        }
        ...
        public Builder cipherSuites(String... strArr) {
            if (this.tls) {
                ...
                a.n("At least one cipher suite is required");
                return null;
            }
            c.g("no cipher suites for cleartext connections");
            return null;
        ...
        public Builder tlsVersions(String... strArr) {
            if (this.tls) {
                ...
                a.n("At least one TLS version is required");
                return null;
            }
            c.g("no TLS versions for cleartext connections");
            return null;
