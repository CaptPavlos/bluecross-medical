...
final class Sniffer {
    ...
    private static boolean sniffInternal(ExtractorInput extractorInput, boolean z9) throws InterruptedException, IOException {
        boolean z10;
        int i10;
        ...
        while (i12 < i11) {
            ...
            extractorInput.peekFully(parsableByteArray.data, z11 ? 1 : 0, 8);
            ...
            if (i13 != Atom.TYPE_moov) {
                ...
                if (i13 == Atom.TYPE_ftyp) {
                    ...
                    extractorInput.peekFully(parsableByteArray.data, z12 ? 1 : 0, i14);
                    int i15 = i14 / 4;
                    int i16 = 0;
                    while (true) {
                        if (i16 >= i15) {
