...
public class Chip extends AppCompatCheckBox implements ChipDrawable.Delegate, Shapeable, MaterialCheckable<Chip> {
    ...
    private void validateAttributes(@Nullable AttributeSet attributeSet) {
        ...
        if (attributeSet.getAttributeValue(NAMESPACE_ANDROID, "drawableLeft") != null) {
            a2.a.m("Please set left drawable using R.attr#chipIcon.");
            return;
        }
        if (attributeSet.getAttributeValue(NAMESPACE_ANDROID, "drawableStart") != null) {
            a2.a.m("Please set start drawable using R.attr#chipIcon.");
            return;
        }
        if (attributeSet.getAttributeValue(NAMESPACE_ANDROID, "drawableEnd") != null) {
            a2.a.m("Please set end drawable using R.attr#closeIcon.");
            return;
        }
        ...
        if (!attributeSet.getAttributeBooleanValue(NAMESPACE_ANDROID, "singleLine", true) || attributeSet.getAttributeIntValue(NAMESPACE_ANDROID, "lines", 1) != 1 || attributeSet.getAttributeIntValue(NAMESPACE_ANDROID, "minLines", 1) != 1 || attributeSet.getAttributeIntValue(NAMESPACE_ANDROID, "maxLines", 1) != 1) {
            a2.a.m("Chip does not support multi-line text");
    ...
    public void onFocusChanged(boolean z9, int i10, Rect rect) {
        ...
        if (this.touchHelperEnabled) {
            this.touchHelper.onFocusChanged(z9, i10, rect);
        }
    }
    ...
    public PointerIcon onResolvePointerIcon(@NonNull MotionEvent motionEvent, int i10) {
        return (getCloseIconTouchBounds().contains(motionEvent.getX(), motionEvent.getY()) && isEnabled()) ? PointerIcon.getSystemIcon(getContext(), PointerIconCompat.TYPE_HAND) : super.onResolvePointerIcon(motionEvent, i10);
    }
    ...
    */
    ...
    public void setEllipsize(TextUtils.TruncateAt truncateAt) {
        ...
        if (truncateAt == TextUtils.TruncateAt.MARQUEE) {
            a2.a.m("Text within a chip are not allowed to scroll.");
            return;
        }
    ...
    public void setTextSize(int i10, float f) {
        ...
        ChipDrawable chipDrawable = this.chipDrawable;
        if (chipDrawable != null) {
            chipDrawable.setTextSize(TypedValue.applyDimension(i10, f, getResources().getDisplayMetrics()));
        }
        updateTextPaintDrawState();
    }
    ...
    public void setCompoundDrawablesWithIntrinsicBounds(@Nullable Drawable drawable, @Nullable Drawable drawable2, @Nullable Drawable drawable3, @Nullable Drawable drawable4) {
        if (drawable != null) {
            ...
            a2.a.m("Please set right drawable using R.attr#closeIcon.");
        }
    }
