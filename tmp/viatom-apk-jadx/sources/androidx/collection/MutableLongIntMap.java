...
public final class MutableLongIntMap extends LongIntMap {
    ...
    private final void resizeStorage(int i10) {
        ...
        while (i12 < i11) {
            if (((jArr2[i12 >> 3] >> ((i12 & 7) << 3)) & 255) < 128) {
                ...
                int i14 = i13 ^ (i13 << 16);
                int iFindFirstAvailableSlot = mutableLongIntMap.findFirstAvailableSlot(i14 >>> 7);
                long j11 = i14 & 127;
                ...
                int i17 = mutableLongIntMap._capacity;
    ...
    public final int getOrPut(long j10, g7.a aVar) {
        aVar.getClass();
        ...
        while (true) {
            ...
            if ((((~j10) << 7) & j10 & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i12 = 0; i12 < i11; i12++) {
                    if ((255 & j10) < 128) {
                        int i13 = (i10 << 3) + i12;
                        if (((Boolean) pVar.invoke(Long.valueOf(this.keys[i13]), Integer.valueOf(this.values[i13]))).booleanValue()) {
                            removeValueAt(i13);
                        }
                    }
                    j10 >>= 8;
    ...
    public /* synthetic */ MutableLongIntMap(int i10, int i11, g gVar) {
        this((i11 & 1) != 0 ? 6 : i10);
    }
