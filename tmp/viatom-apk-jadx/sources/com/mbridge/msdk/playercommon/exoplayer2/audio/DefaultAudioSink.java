...
public final class DefaultAudioSink implements AudioSink {
    ...
    public final class PositionTrackerListener implements AudioTrackPositionTracker.Listener {
        ...
        public final void onPositionFramesMismatch(long j10, long j11, long j12, long j13) {
            StringBuilder sbX = a.x("Spurious audio timestamp (frame position mismatch): ", ", ", j10);
            sbX.append(j11);
            sbX.append(", ");
            sbX.append(j12);
            sbX.append(", ");
            sbX.append(j13);
            sbX.append(", ");
            sbX.append(DefaultAudioSink.this.getSubmittedFrames());
            sbX.append(", ");
            sbX.append(DefaultAudioSink.this.getWrittenFrames());
        ...
        public final void onSystemTimeUsMismatch(long j10, long j11, long j12, long j13) {
            StringBuilder sbX = a.x("Spurious audio timestamp (system clock mismatch): ", ", ", j10);
            sbX.append(j11);
            sbX.append(", ");
            sbX.append(j12);
            sbX.append(", ");
    ...
    public DefaultAudioSink(@Nullable AudioCapabilities audioCapabilities, AudioProcessorChain audioProcessorChain, boolean z9) {
        this.audioCapabilities = audioCapabilities;
        this.audioProcessorChain = (AudioProcessorChain) Assertions.checkNotNull(audioProcessorChain);
        this.enableConvertHighResIntPcmToFloat = z9;
    ...
    private long applySpeedup(long j10) {
        ...
        boolean zIsEmpty = this.playbackParametersCheckpoints.isEmpty();
        long j11 = this.playbackParametersOffsetUs;
        return zIsEmpty ? this.audioProcessorChain.getMediaDuration(j10 - this.playbackParametersPositionUs) + j11 : Util.getMediaDurationForPlayoutDuration(j10 - this.playbackParametersPositionUs, this.playbackParameters.speed) + j11;
    }
    ...
    */
    ...
    private static int getFramesPerEncodedSample(int i10, ByteBuffer byteBuffer) {
        ...
        if (i10 != 14) {
            c.g(a.f(i10, "Unexpected audio encoding: "));
            return 0;
        }
    ...
    private void writeBuffer(ByteBuffer byteBuffer, long j10) throws AudioSink.WriteException {
        ...
        if (byteBuffer.hasRemaining()) {
            ...
            boolean z9 = defaultAudioSink.isInputPcm;
            if (z9) {
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final void configure(int r18, int r19, int r20, int r21, @androidx.annotation.Nullable int[] r22, int r23, int r24) throws java.lang.IllegalStateException, com.mbridge.msdk.playercommon.exoplayer2.audio.AudioSink.ConfigurationException {
        /*
    ...
    @Override // com.mbridge.msdk.playercommon.exoplayer2.audio.AudioSink
    public final void enableTunnelingV21(int i10) throws IllegalStateException {
    ...
    public final long getCurrentPositionUs(boolean z9) {
        ...
        return this.startMediaTimeUs + applySkipping(applySpeedup(Math.min(this.audioTrackPositionTracker.getCurrentPositionUs(z9), framesToDurationUs(getWrittenFrames()))));
    }
    ...
    @Override // com.mbridge.msdk.playercommon.exoplayer2.audio.AudioSink
    public final boolean handleBuffer(ByteBuffer byteBuffer, long j10) throws AudioSink.InitializationException, IllegalStateException, AudioSink.WriteException {
        boolean z9;
        ...
        if (this.inputBuffer != null) {
            ...
            if (this.startMediaTimeState == 0) {
                ...
                if (this.startMediaTimeState == 1 && Math.abs(jInputFramesToDurationUs - j10) > 200000) {
                    StringBuilder sbX = a.x("Discontinuity detected [expected ", ", got ", jInputFramesToDurationUs);
                    sbX.append(j10);
                    sbX.append("]");
                    Log.e(TAG, sbX.toString());
    ...
    @Override // com.mbridge.msdk.playercommon.exoplayer2.audio.AudioSink
    public final void setAudioSessionId(int i10) throws IllegalStateException {
    ...
    public DefaultAudioSink(@Nullable AudioCapabilities audioCapabilities, AudioProcessor[] audioProcessorArr, boolean z9) {
        this(audioCapabilities, new DefaultAudioProcessorChain(audioProcessorArr), z9);
    }
