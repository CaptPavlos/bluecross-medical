...
public abstract class CodedInputStream {
    ...
    public final int setRecursionLimit(int i10) {
        if (i10 < 0) {
            a.n(a3.a.f(i10, "Recursion limit cannot be negative: "));
            return 0;
        }
    ...
    public final int setSizeLimit(int i10) {
        if (i10 < 0) {
            a.n(a3.a.f(i10, "Size limit cannot be negative: "));
            return 0;
        }
    ...
    public static final class StreamDecoder extends CodedInputStream {
        ...
        private byte[] readRawBytesSlowPath(int i10, boolean z9) throws IOException {
            byte[] rawBytesSlowPathOneChunk = readRawBytesSlowPathOneChunk(i10);
            if (rawBytesSlowPathOneChunk != null) {
        ...
        private boolean tryRefillBuffer(int i10) throws IOException {
            ...
            if (i11 + i10 <= this.bufferSize) {
                c.g(a3.a.g(i10, "refillBuffer() called when ", " bytes were already available in buffer"));
                return false;
            }
    ...
    public static final class ArrayDecoder extends CodedInputStream {
        ...
        private ArrayDecoder(byte[] bArr, int i10, int i11, boolean z9) {
            super();
            this.currentLimit = Integer.MAX_VALUE;
            this.buffer = bArr;
            this.limit = i11 + i10;
    ...
    public static final class IterableDirectByteBufferDecoder extends CodedInputStream {
        ...
        private IterableDirectByteBufferDecoder(Iterable<ByteBuffer> iterable, int i10, boolean z9) {
            super();
            this.currentLimit = Integer.MAX_VALUE;
    ...
    public static CodedInputStream newInstance(byte[] bArr, int i10, int i11, boolean z9) {
        ArrayDecoder arrayDecoder = new ArrayDecoder(bArr, i10, i11, z9);
        try {
