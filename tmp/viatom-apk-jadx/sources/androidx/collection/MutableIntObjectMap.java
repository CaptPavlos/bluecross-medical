...
public final class MutableIntObjectMap<V> extends IntObjectMap<V> {
    ...
    private final void resizeStorage(int i10) {
        ...
        while (i12 < i11) {
            if (((jArr2[i12 >> 3] >> ((i12 & 7) << 3)) & 255) < 128) {
                ...
                int i18 = mutableIntObjectMap._capacity;
    ...
    public final V getOrPut(int i10, g7.a aVar) {
        aVar.getClass();
        V v6 = get(i10);
        if (v6 != null) {
            return v6;
    ...
    public final V put(int i10, V v6) {
        int iFindAbsoluteInsertIndex = findAbsoluteInsertIndex(i10);
        Object[] objArr = this.values;
        V v9 = (V) objArr[iFindAbsoluteInsertIndex];
        this.keys[iFindAbsoluteInsertIndex] = i10;
    ...
    */
        ...
        while (true) {
            ...
            if ((((~j10) << 7) & j10 & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i12 = 0; i12 < i11; i12++) {
                    if ((255 & j10) < 128) {
                        int i13 = (i10 << 3) + i12;
                        if (((Boolean) pVar.invoke(Integer.valueOf(this.keys[i13]), this.values[i13])).booleanValue()) {
                            removeValueAt(i13);
                        }
                    }
                    j10 >>= 8;
    ...
    public final void set(int i10, V v6) {
        int iFindAbsoluteInsertIndex = findAbsoluteInsertIndex(i10);
        this.keys[iFindAbsoluteInsertIndex] = i10;
    ...
    public /* synthetic */ MutableIntObjectMap(int i10, int i11, g gVar) {
        this((i11 & 1) != 0 ? 6 : i10);
    }
