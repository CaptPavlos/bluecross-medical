    ...
    public static boolean populateHeader(int i10, MpegAudioHeader mpegAudioHeader) {
        ...
        if (i12 == 3) {
            ...
            if (i11 == 3) {
                ...
                i = i12 == 1 ? 576 : 1152;
                int i21 = i12 == 1 ? DefaultOggSeeker.MATCH_RANGE : 144000;
                i16 = i;
                i17 = i20 + ((i21 * i15) / i19);
            }
            i16 = i;
        ...
        mpegAudioHeader.setValues(i11, MIME_TYPE_BY_LAYER[3 - i12], i17, i19, ((i10 >> 6) & 3) == 3 ? 1 : 2, i15 * 1000, i16);
        return true;
    }
