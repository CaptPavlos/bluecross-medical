...
public final class TaskStackBuilder implements Iterable<Intent> {
    ...
    public PendingIntent getPendingIntent(int i10, int i11, @Nullable Bundle bundle) {
        if (this.mIntents.isEmpty()) {
            androidx.window.layout.c.g("No intents added to TaskStackBuilder; cannot getPendingIntent");
            return null;
        }
    ...
    public void startActivities(@Nullable Bundle bundle) {
        if (this.mIntents.isEmpty()) {
            androidx.window.layout.c.g("No intents added to TaskStackBuilder; cannot startActivities");
            return;
        }
        Intent[] intentArr = (Intent[]) this.mIntents.toArray(new Intent[0]);
        intentArr[0] = new Intent(intentArr[0]).addFlags(268484608);
