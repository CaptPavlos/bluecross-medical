...
public final class Mp4Extractor implements Extractor, SeekMap {
    ...
    private int getTrackIndexOfNextReadSample(long j10) {
        ...
        return (j11 == Long.MAX_VALUE || !z9 || j12 < j11 + MAXIMUM_READ_AHEAD_BYTES_STREAM) ? i11 : i10;
    }

    private ArrayList<TrackSampleTable> getTrackSampleTables(Atom.ContainerAtom containerAtom, GaplessInfoHolder gaplessInfoHolder, boolean z9) throws ParserException {
        boolean z10;
        ...
        while (i10 < containerAtom.containerChildren.size()) {
            ...
            if (containerAtom2.type != Atom.TYPE_trak) {
                ...
                z10 = z9;
                Track trak = AtomParsers.parseTrak(containerAtom2, containerAtom.getLeafAtomOfType(Atom.TYPE_mvhd), C.TIME_UNSET, null, z10, this.isQuickTime);
                if (trak != null) {
