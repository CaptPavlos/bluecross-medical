...
public class TextInputLayout extends LinearLayout implements ViewTreeObserver.OnGlobalLayoutListener {
    ...
    public TextInputLayout(@NonNull Context context, @Nullable AttributeSet attributeSet, int i10) {
        ...
        this.lengthCounter = new androidx.window.layout.c(21);
        ...
        this.focusedStrokeColor = tintTypedArrayObtainTintedStyledAttributes.getColor(i22, 0);
        ...
        this.counterTextAppearance = tintTypedArrayObtainTintedStyledAttributes.getResourceId(i12, 0);
        this.counterOverflowTextAppearance = tintTypedArrayObtainTintedStyledAttributes.getResourceId(i13, 0);
    ...
    private void assignBoxBackgroundByMode() {
        ...
        if (i10 == 0) {
            ...
            if (i10 != 2) {
                com.google.gson.internal.a.n(a3.a.n(new StringBuilder(), " is illegal; only @BoxBackgroundMode constants are supported.", this.boxBackgroundMode));
                return;
            }
    ...
    private Rect calculateCollapsedTextBounds(@NonNull Rect rect) {
        ...
        int i11 = rect.left;
        if (i10 != 2) {
            rect2.left = getLabelLeftBoundAlignedWithPrefixAndSuffix(i11, zIsLayoutRtl);
            rect2.top = getPaddingTop();
            rect2.right = getLabelRightBoundAlignedWithPrefixAndSuffix(rect.right, zIsLayoutRtl);
            return rect2;
        }
        rect2.left = this.editText.getPaddingLeft() + i11;
    ...
    private MaterialShapeDrawable getDropDownMaterialShapeDrawable(boolean z9) throws Resources.NotFoundException {
    ...
    private int getLabelLeftBoundAlignedWithPrefixAndSuffix(int i10, boolean z9) {
        ...
        if (!z9 && getPrefixText() != null) {
            ...
            if (!z9 || getSuffixText() == null) {
                return this.editText.getCompoundPaddingLeft() + i10;
            }
            suffixTextEndOffset = this.endLayout.getSuffixTextEndOffset();
        }
        return i10 + suffixTextEndOffset;
    }

    private int getLabelRightBoundAlignedWithPrefixAndSuffix(int i10, boolean z9) {
        return i10 - ((z9 || getSuffixText() == null) ? (!z9 || getPrefixText() == null) ? this.editText.getCompoundPaddingRight() : this.startLayout.getPrefixTextStartOffset() : this.endLayout.getSuffixTextEndOffset());
    }
    ...
    private void setEditText(EditText editText) {
        if (this.editText != null) {
            com.google.gson.internal.a.n("We already have an EditText, can only have one");
            return;
        }
        ...
        this.editText.addTextChangedListener(new TextWatcher(editText) { // from class: com.google.android.material.textfield.TextInputLayout.1
            ...
            public void afterTextChanged(@NonNull Editable editable) {
                ...
                int i12 = this.previousLineCount;
                if (lineCount != i12) {
                    if (lineCount < i12) {
                        int minimumHeight = this.val$editText.getMinimumHeight();
                        int i13 = TextInputLayout.this.originalEditTextMinimumHeight;
                        if (minimumHeight != i13) {
                            this.val$editText.setMinimumHeight(i13);
                        }
                    }
    ...
    private void updateCollapsingTextDimens(int i10) {
        this.collapsingTextHelper.updateTextHeights(i10);
        Rect rect = this.tmpRect;
        DescendantOffsetUtils.getDescendantRect(this, this.editText, rect);
        this.collapsingTextHelper.setCollapsedBounds(calculateCollapsedTextBounds(rect));
        updateInputLayoutMargins();
        adjustFilledEditTextPaddingForLargeFont();
        updateEditTextHeight(i10);
    }
    ...
    private void updateEditTextHeight(int i10) {
        if (this.editText == null) {
            return;
        }
            ...
            try {
                height = StaticLayoutBuilderCompat.obtain(this.placeholderText, textPaint, i10).setIsRtl(getLayoutDirection() == 1).setIncludePad(true).setLineSpacing(this.placeholderTextView.getLineSpacingExtra(), this.placeholderTextView.getLineSpacingMultiplier()).setStaticLayoutBuilderConfigurer(new StaticLayoutBuilderConfigurer() { // from class: com.google.android.material.textfield.h
                    ...
                    public final void configure(StaticLayout.Builder builder) {
                        this.f2410a.lambda$updateEditTextHeight$2(builder);
                    }
    ...
    public void setEndIconMinSize(@IntRange(from = FabTransformationScrimBehavior.COLLAPSE_DELAY) int i10) {
    ...
    public void setHintMaxLines(int i10) {
        this.collapsingTextHelper.setCollapsedMaxLines(i10);
        this.collapsingTextHelper.setExpandedMaxLines(i10);
        requestLayout();
    }
    ...
    public void setStartIconMinSize(@IntRange(from = FabTransformationScrimBehavior.COLLAPSE_DELAY) int i10) {
    ...
    public void updateCounter(@Nullable Editable editable) {
        ...
        if (i10 == -1) {
            ...
            this.counterOverflowed = iCountLength > i10;
