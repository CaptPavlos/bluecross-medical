...
public class WindowDecorActionBar extends ActionBar implements ActionBarOverlayLayout.ActionBarVisibilityCallback {
    ...
    private void configureTab(ActionBar.Tab tab, int i10) {
        ...
        if (tabImpl.getCallback() == null) {
            androidx.window.layout.c.g("Action Bar Tab must have a Callback");
            return;
        }
    ...
    private void init(View view) {
        ...
        if (decorToolbar == null || this.mContextView == null || actionBarContainer == null) {
            androidx.window.layout.c.g(getClass().getSimpleName().concat(" can only be used with a compatible window decor layout"));
            return;
        }
    ...
    public void dispatchMenuVisibilityChanged(boolean z9) {
        ...
        for (int i10 = 0; i10 < size; i10++) {
            this.mMenuVisibilityListeners.get(i10).onMenuVisibilityChanged(z9);
        }
    }
    ...
    public void setHideOffset(int i10) {
        if (i10 == 0 || this.mOverlayLayout.isInOverlayMode()) {
            ...
            androidx.window.layout.c.g("Action bar must be in overlay mode (Window.FEATURE_OVERLAY_ACTION_BAR) to set a non-zero hide offset");
        }
    }
    ...
    public void setHideOnContentScrollEnabled(boolean z9) {
        if (z9 && !this.mOverlayLayout.isInOverlayMode()) {
            androidx.window.layout.c.g("Action bar must be in overlay mode (Window.FEATURE_OVERLAY_ACTION_BAR) to enable hide on content scroll");
        } else {
    ...
    public void setSelectedNavigationItem(int i10) {
        ...
        if (navigationMode == 1) {
            ...
            androidx.window.layout.c.g("setSelectedNavigationIndex not valid for current navigation mode");
        }
    }
    ...
    public void addTab(ActionBar.Tab tab, int i10, boolean z9) {
        ensureTabsExist();
        this.mTabScrollView.addTab(tab, i10, z9);
