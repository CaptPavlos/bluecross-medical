...
public class GuidedActionAdapter extends RecyclerView.Adapter {
    ...
    public void handleCheckedActions(GuidedActionsStylist.ViewHolder viewHolder) {
        ...
        if (checkSetId != -1) {
            ...
            for (int i10 = 0; i10 < size; i10++) {
                GuidedAction guidedAction = this.mActions.get(i10);
                if (guidedAction != action && guidedAction.getCheckSetId() == checkSetId && guidedAction.isChecked()) {
                    guidedAction.setChecked(false);
                    GuidedActionsStylist.ViewHolder viewHolder2 = (GuidedActionsStylist.ViewHolder) this.mRecyclerView.findViewHolderForPosition(i10);
                    if (viewHolder2 != null) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i10) {
        GuidedActionsStylist.ViewHolder viewHolderOnCreateViewHolder = this.mStylist.onCreateViewHolder(viewGroup, i10);
        ...
        if (this.mDiffCallback == null) {
            ...
            DiffUtil.calculateDiff(new DiffUtil.Callback() { // from class: androidx.leanback.widget.GuidedActionAdapter.2
                ...
                public boolean areContentsTheSame(int i10, int i11) {
                    return GuidedActionAdapter.this.mDiffCallback.areContentsTheSame((GuidedAction) arrayList.get(i10), GuidedActionAdapter.this.mActions.get(i11));
                }

                @Override // androidx.recyclerview.widget.DiffUtil.Callback
                public boolean areItemsTheSame(int i10, int i11) {
                    return GuidedActionAdapter.this.mDiffCallback.areItemsTheSame((GuidedAction) arrayList.get(i10), GuidedActionAdapter.this.mActions.get(i11));
                }

                @Override // androidx.recyclerview.widget.DiffUtil.Callback
                public Object getChangePayload(int i10, int i11) {
                    return GuidedActionAdapter.this.mDiffCallback.getChangePayload((GuidedAction) arrayList.get(i10), GuidedActionAdapter.this.mActions.get(i11));
                }
