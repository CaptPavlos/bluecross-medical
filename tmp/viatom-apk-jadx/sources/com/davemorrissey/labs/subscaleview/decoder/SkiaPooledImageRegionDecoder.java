...
public class SkiaPooledImageRegionDecoder implements ImageRegionDecoder {
    ...
    public void initialiseDecoder() throws Exception {
        ...
        if (string.startsWith(RESOURCE_PREFIX)) {
            ...
            try {
                ...
                try {
                    AssetFileDescriptor assetFileDescriptorOpenAssetFileDescriptor = contentResolver.openAssetFileDescriptor(this.uri, CampaignEx.JSON_KEY_AD_R);
    ...
    public boolean allowAdditionalDecoder(int i10, long j10) {
        if (i10 >= 4) {
        ...
        if (i10 >= getNumberOfCores()) {
            debug(a.n(new StringBuilder("No additional encoders allowed, limited by CPU cores ("), ")", getNumberOfCores()));
            return false;
        }
        if (isLowMemory()) {
        ...
        debug(a.l(a.r(i10, "Additional decoder allowed, current count is ", ", estimated native memory "), j11 / 1048576, "Mb"));
        return true;
    }

    @Override // com.davemorrissey.labs.subscaleview.decoder.ImageRegionDecoder
    @NonNull
    public Bitmap decodeRegion(@NonNull Rect rect, int i10) {
