...
public final class DirectedAcyclicGraph<T> {
    ...
    private void dfs(T t, ArrayList<T> arrayList, HashSet<T> hashSet) {
        ...
        if (hashSet.contains(t)) {
            a.j("This graph contains cyclic dependencies");
            return;
        }
        hashSet.add(t);
    ...
    public void addEdge(@NonNull T t, @NonNull T t9) {
        if (!this.mGraph.containsKey(t) || !this.mGraph.containsKey(t9)) {
            com.google.gson.internal.a.n("All nodes must be present in the graph before being added as an edge");
            return;
        }
    ...
    public void clear() {
        ...
        while (true) {
            ...
            ArrayList<T> arrayListValueAt = simpleArrayMap.valueAt(i10);
