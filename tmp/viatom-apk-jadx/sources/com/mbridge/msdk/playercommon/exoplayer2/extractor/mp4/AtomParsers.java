...
final class AtomParsers {
    ...
    public static final class ChunkIterator {
        ...
        public final boolean moveNext() {
            ...
            boolean z9 = this.chunkOffsetsAreLongs;
            ParsableByteArray parsableByteArray = this.chunkOffsets;
            this.offset = z9 ? parsableByteArray.readUnsignedLongToLong() : parsableByteArray.readUnsignedInt();
    ...
    private static void parseAudioSampleEntry(ParsableByteArray parsableByteArray, int i10, int i11, int i12, int i13, String str, boolean z9, DrmInitData drmInitData, StsdData stsdData, int i14) throws ParserException {
        int unsignedShort;
        ...
        while (i25 - i19 < i20) {
            ...
            Assertions.checkArgument(i26 > 0 ? z11 : false, "childAtomSize should be positive");
            int i27 = parsableByteArray.readInt();
            int i28 = Atom.TYPE_esds;
            if (i27 == i28 || (z9 && i27 == Atom.TYPE_wave)) {
                i15 = i25;
    ...
    private static TrackEncryptionBox parseSchiFromParent(ParsableByteArray parsableByteArray, int i10, int i11, String str) {
        ...
        while (true) {
            ...
            if (parsableByteArray.readInt() == Atom.TYPE_tenc) {
                ...
                return new TrackEncryptionBox(z9, str, unsignedByte2, bArr2, i13, i12, bArr);
            }
            i14 += i15;
        }
    }
    ...
    */
    ...
    private static StsdData parseStsd(ParsableByteArray parsableByteArray, int i10, int i11, String str, DrmInitData drmInitData, boolean z9) throws ParserException {
        parsableByteArray.setPosition(12);
        int i12 = parsableByteArray.readInt();
        ...
        while (i13 < i12) {
            ...
            if (i15 == Atom.TYPE_avc1 || i15 == Atom.TYPE_avc3 || i15 == Atom.TYPE_encv || i15 == Atom.TYPE_mp4v || i15 == Atom.TYPE_hvc1 || i15 == Atom.TYPE_hev1 || i15 == Atom.TYPE_s263 || i15 == Atom.TYPE_vp08 || i15 == Atom.TYPE_vp09) {
                ...
                parseAudioSampleEntry(parsableByteArray, i15, position, i14, i10, str, z9, drmInitData, stsdData3, i13);
                stsdData = stsdData3;
    ...
    public static Track parseTrak(Atom.ContainerAtom containerAtom, Atom.LeafAtom leafAtom, long j10, DrmInitData drmInitData, boolean z9, boolean z10) throws ParserException {
        long[] jArr;
        long[] jArr2;
        ...
        StsdData stsd = parseStsd(containerAtomOfType2.getLeafAtomOfType(Atom.TYPE_stsd).data, tkhd.id, tkhd.rotationDegrees, (String) mdhd.second, drmInitData, z10);
        if (z9) {
            jArr = null;
            jArr2 = null;
        } else {
    ...
    public static Metadata parseUdta(Atom.LeafAtom leafAtom, boolean z9) {
        if (z9) {
            return null;
        }
        ParsableByteArray parsableByteArray = leafAtom.data;
    ...
    /* JADX WARN: Removed duplicated region for block: B:80:0x0140 A[PHI: r13
      0x0140: PHI (r13v2 int) = (r13v1 int), (r13v3 int) binds: [B:74:0x0135, B:76:0x0138] A[DONT_GENERATE, DONT_INLINE]] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
