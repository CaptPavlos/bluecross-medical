...
public class MaterialButton extends AppCompatButton implements Checkable, Shapeable {
    ...
    public MaterialButton(@NonNull Context context, @Nullable AttributeSet attributeSet, int i10) {
        ...
        super(MaterialThemeOverlay.wrap(context, attributeSet, i10, i11, new int[]{MATERIAL_SIZE_OVERLAY_ATTR}), attributeSet, i10);
        ...
        ShapeAppearanceModel defaultShape = stateListShapeAppearanceModelCreate != null ? stateListShapeAppearanceModelCreate.getDefaultShape(true) : ShapeAppearanceModel.builder(context2, attributeSet, i10, i11).build();
    ...
    public /* synthetic */ void lambda$setOpticalCenterEnabled$0(float f) {
        int i10 = (int) (f * OPTICAL_CENTER_RATIO);
        if (this.opticalCenterShift != i10) {
            this.opticalCenterShift = i10;
    ...
    private void updateIconPosition(int i10, int i11) {
        ...
        int textLayoutWidth = ((((i10 - getTextLayoutWidth()) - getPaddingEnd()) - intrinsicWidth) - this.iconPadding) - getPaddingStart();
    ...
    private void updatePaddingsAndSizeForWidthAnimation() {
        int i10 = (int) (this.displayedWidthIncrease - this.displayedWidthDecrease);
        int i11 = (i10 / 2) + this.opticalCenterShift;
        getLayoutParams().width = (int) (this.originalWidth + i10);
        setPaddingRelative(this.originalPaddingStart + i11, getPaddingTop(), (this.originalPaddingEnd + i10) - i11, getPaddingBottom());
    }
    ...
    public ShapeAppearanceModel getShapeAppearanceModel() {
        ...
        c.g("Attempted to get ShapeAppearanceModel from a MaterialButton which has an overwritten background.");
        return null;
    }
    ...
    public StateListShapeAppearanceModel getStateListShapeAppearanceModel() {
        ...
        c.g("Attempted to get StateListShapeAppearanceModel from a MaterialButton which has an overwritten background.");
        return null;
    }
    ...
    public void onLayout(boolean z9, int i10, int i11, int i12, int i13) {
        ...
        if (this.allowedWidthDecrease == -1) {
            ...
            this.allowedWidthDecrease = (getMeasuredWidth() - getTextLayoutWidth()) - i14;
        }
    ...
    public void setDisplayedWidthDecrease(int i10) {
        this.displayedWidthDecrease = Math.min(i10, this.allowedWidthDecrease);
        updatePaddingsAndSizeForWidthAnimation();
        invalidate();
    }
    ...
    public void setIconSize(@Px int i10) {
        if (i10 < 0) {
            com.google.gson.internal.a.n("iconSize cannot be less than 0");
    ...
    public void setOpticalCenterEnabled(boolean z9) {
        if (this.opticalCenterEnabled != z9) {
            ...
            MaterialButtonHelper materialButtonHelper = this.materialButtonHelper;
            if (z9) {
                materialButtonHelper.setCornerSizeChangeListener(new androidx.core.view.inputmethod.a(this, 3));
            } else {
    ...
    public void setShapeAppearanceModel(@NonNull ShapeAppearanceModel shapeAppearanceModel) {
        if (isUsingOriginalBackground()) {
            ...
            c.g("Attempted to set ShapeAppearanceModel on a MaterialButton which has an overwritten background.");
        }
    }
    ...
    public void setStateListShapeAppearanceModel(@NonNull StateListShapeAppearanceModel stateListShapeAppearanceModel) {
        if (!isUsingOriginalBackground()) {
            c.g("Attempted to set StateListShapeAppearanceModel on a MaterialButton which has an overwritten background.");
            return;
        }
    ...
    public void setWidthChangeMax(@Px int i10) {
        if (this.widthChangeMax != i10) {
            this.widthChangeMax = i10;
            maybeAnimateSize(true);
        }
    }
