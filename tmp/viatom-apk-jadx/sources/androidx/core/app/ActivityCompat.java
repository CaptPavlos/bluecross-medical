...
public class ActivityCompat extends ContextCompat {
    ...
    public interface PermissionCompatDelegate {
        boolean onActivityResult(@NonNull Activity activity, @IntRange(from = FabTransformationScrimBehavior.COLLAPSE_DELAY) int i10, int i11, @Nullable Intent intent);

        boolean requestPermissions(@NonNull Activity activity, @NonNull String[] strArr, @IntRange(from = FabTransformationScrimBehavior.COLLAPSE_DELAY) int i10);
    }
    ...
    public static void requestPermissions(@NonNull Activity activity, @NonNull String[] strArr, @IntRange(from = FabTransformationScrimBehavior.COLLAPSE_DELAY) int i10) {
        ...
        if (permissionCompatDelegate == null || !permissionCompatDelegate.requestPermissions(activity, strArr, i10)) {
            ...
            for (int i11 = 0; i11 < strArr.length; i11++) {
                if (TextUtils.isEmpty(strArr[i11])) {
                    com.google.gson.internal.a.n(a3.a.o(new StringBuilder("Permission request for permissions "), Arrays.toString(strArr), " must not contain null or empty values"));
                    return;
                }
    ...
    public static <T extends View> T requireViewById(@NonNull Activity activity, @IdRes int i10) {
        ...
        com.google.gson.internal.a.n("ID does not reference a View inside this Activity");
        return null;
    }
