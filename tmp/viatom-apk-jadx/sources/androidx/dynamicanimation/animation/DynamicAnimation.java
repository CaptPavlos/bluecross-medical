...
public abstract class DynamicAnimation<T extends DynamicAnimation<T>> implements AnimationHandler.AnimationFrameCallback {
        ...
        while (true) {
            ...
            if (i10 >= size) {
                ...
                if (arrayList.get(i10) != null) {
                    this.mEndListeners.get(i10).onAnimationEnd(this, z9, this.mValue, this.mVelocity);
                }
                i10++;
            }
        }
    ...
    private void startAnimationInternal() {
        ...
        if (f > this.mMaxValue || f < this.mMinValue) {
            com.google.gson.internal.a.n("Starting value need to be in between min value and max value");
        } else {
    ...
    public T addUpdateListener(OnAnimationUpdateListener onAnimationUpdateListener) {
        if (isRunning()) {
            a2.a.m("Error: Update listeners must be added beforethe animation.");
            return null;
        }
    ...
    public boolean doAnimationFrame(long j10) {
        ...
        boolean zUpdateValueAndVelocity = updateValueAndVelocity(durationScale == 0.0f ? 2147483647L : (long) (j12 / durationScale));
    ...
    public T setMinimumVisibleChange(@FloatRange(from = 0.0d, fromInclusive = false) float f) {
        if (f <= 0.0f) {
            com.google.gson.internal.a.n("Minimum visible change must be positive.");
            return null;
        }
