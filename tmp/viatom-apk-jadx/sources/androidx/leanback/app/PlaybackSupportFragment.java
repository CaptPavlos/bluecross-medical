...
public class PlaybackSupportFragment extends Fragment {
    ...
    private static ValueAnimator loadAnimator(Context context, int i10) {
        ...
        ValueAnimator.AnimatorUpdateListener animatorUpdateListener = new ValueAnimator.AnimatorUpdateListener() { // from class: androidx.leanback.app.PlaybackSupportFragment.9
            ...
            public void onAnimationUpdate(ValueAnimator valueAnimator) {
                ...
                for (int i10 = 0; i10 < childCount; i10++) {
                    View childAt = PlaybackSupportFragment.this.getVerticalGridView().getChildAt(i10);
    ...
    private void startFadeTimer(int i10) {
    ...
    private void updateBackground() {
        ...
        if (view != null) {
            int i10 = this.mBgDarkColor;
            int i11 = this.mBackgroundType;
            if (i11 == 0) {
                i10 = 0;
            } else if (i11 == 2) {
                i10 = this.mBgLightColor;
            }
    ...
    public void setBackgroundType(int i10) {
        if (i10 != 0 && i10 != 1 && i10 != 2) {
            a.n("Invalid background type");
        } else if (i10 != this.mBackgroundType) {
