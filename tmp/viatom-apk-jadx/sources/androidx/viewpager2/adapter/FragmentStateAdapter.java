...
public abstract class FragmentStateAdapter extends RecyclerView.Adapter<FragmentViewHolder> implements StatefulAdapter {
    ...
    public class FragmentMaxLifecycleEnforcer {
        ...
        private ViewPager2 inferViewPager(@NonNull RecyclerView recyclerView) {
            ...
            a.h(parent, "Expected ViewPager2 instance. Got: ");
            return null;
        }
        ...
        public void updateFragmentMaxLifecycle(boolean z9) {
            ...
            if ((itemId != this.mPrimaryItemId || z9) && (fragment = FragmentStateAdapter.this.mFragments.get(itemId)) != null && fragment.isAdded()) {
                ...
                for (int i11 = 0; i11 < FragmentStateAdapter.this.mFragments.size(); i11++) {
                    long jKeyAt = FragmentStateAdapter.this.mFragments.keyAt(i11);
                    Fragment fragmentValueAt = FragmentStateAdapter.this.mFragments.valueAt(i11);
    ...
    private Long itemForViewHolder(int i10) {
        ...
        for (int i11 = 0; i11 < this.mItemIdToViewHolder.size(); i11++) {
            if (this.mItemIdToViewHolder.valueAt(i11).intValue() == i10) {
                if (lValueOf != null) {
                    c.g("Design assumption violated: a ViewHolder can only be bound to one item at a time.");
                    return null;
                }
    ...
    public final void restoreState(@NonNull Parcelable parcelable) {
        if (!this.mSavedStates.isEmpty() || !this.mFragments.isEmpty()) {
            c.g("Expected the adapter to be 'fresh' while restoring state.");
            return;
        }
        ...
        for (String str : bundle.keySet()) {
            if (isValidKey(str, KEY_PREFIX_FRAGMENT)) {
                ...
                if (!isValidKey(str, KEY_PREFIX_STATE)) {
                    a.n(a3.a.i("Unexpected key in savedState: ", str));
                    return;
                }
