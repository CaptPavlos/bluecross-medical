...
public abstract class BaseRenderer implements Renderer, RendererCapabilities {
    ...
    @Override // com.mbridge.msdk.playercommon.exoplayer2.Renderer
    public final void enable(RendererConfiguration rendererConfiguration, Format[] formatArr, SampleStream sampleStream, long j10, boolean z9, long j11) throws ExoPlaybackException {
    ...
    public final int readSource(FormatHolder formatHolder, DecoderInputBuffer decoderInputBuffer, boolean z9) {
        int data = this.stream.readData(formatHolder, decoderInputBuffer, z9);
        if (data == -4) {
