...
final class DvbParser {
    ...
    public static final class ObjectData {
        ...
        public ObjectData(int i10, boolean z9, byte[] bArr, byte[] bArr2) {
            this.id = i10;
    ...
    public static final class RegionComposition {
        ...
        public RegionComposition(int i10, boolean z9, int i11, int i12, int i13, int i14, int i15, int i16, int i17, int i18, SparseArray<RegionObject> sparseArray) {
            this.id = i10;
            this.fillFlag = z9;
            this.width = i11;
            this.height = i12;
            ...
            if (bits != 240) {
                switch (bits) {
                    case 16:
                        ...
                        if (i10 != 3) {
                            if (i10 != 2) {
                                ...
                                bArr3 = bArrBuildClutMapTable == null ? defaultMap2To4 : bArrBuildClutMapTable;
                            }
                        } else {
                            bArr3 = bArrBuildClutMapTable2 == null ? defaultMap2To8 : bArrBuildClutMapTable2;
                        }
                        paint2 = paint3;
                        bArr2 = bArr3;
                        iPaint2BitPixelCodeString = paint2BitPixelCodeString(parsableBitArray, iArr2, bArr2, iPaint2BitPixelCodeString, i13, paint2, canvas2);
                    ...
                    case 17:
                        ...
                        canvas2 = canvas;
                        paint2 = paint;
                        iPaint2BitPixelCodeString = paint4BitPixelCodeString(parsableBitArray, iArr2, i10 == 3 ? defaultMap4To8 : null, iPaint2BitPixelCodeString, i13, paint2, canvas2);
                        parsableBitArray.byteAlign();
                        break;
                    case 18:
                        iArr2 = iArr;
    ...
    private static ClutDefinition parseClutDefinition(ParsableBitArray parsableBitArray, int i10) {
        ...
        while (i14 > 0) {
            ...
            double d8 = bits3;
            double d10 = bits4 + WorkInfo.STOP_REASON_FOREGROUND_SERVICE_TIMEOUT;
            double d11 = bits + WorkInfo.STOP_REASON_FOREGROUND_SERVICE_TIMEOUT;
            iArr[bits6] = getColor((byte) (255 - (bits2 & 255)), Util.constrainValue((int) ((1.402d * d10) + d8), 0, 255), Util.constrainValue((int) ((d8 - (0.34414d * d11)) - (d10 * 0.71414d)), 0, 255), Util.constrainValue((int) ((d11 * 1.772d) + d8), 0, 255));
            i14 = i11;
            bits5 = bits5;
            i12 = 8;
            i13 = 2;
    ...
    public final List<Cue> decode(byte[] bArr, int i10) {
        ...
        for (int i11 = 0; i11 < sparseArray.size(); i11++) {
            ...
            float f = i12;
            float f10 = i13;
            this.canvas.clipRect(f, f10, Math.min(regionComposition.width + i12, displayDefinition.horizontalPositionMaximum), Math.min(regionComposition.height + i13, displayDefinition.verticalPositionMaximum), Region.Op.REPLACE);
            ...
            if (regionComposition.fillFlag) {
                ...
                this.canvas.drawRect(f, f10, regionComposition.width + i12, regionComposition.height + i13, this.fillRegionPaint);
            }
            ...
            arrayList.add(new Cue(bitmapCreateBitmap2, f / i16, 0, f10 / i17, 0, regionComposition.width / i16, regionComposition.height / i17));
