    ...
    public static <T> T[] readParcelableArray(@NonNull Parcel parcel, @Nullable ClassLoader classLoader, @NonNull Class<T> cls) {
        ...
        for (int i10 = 0; i10 < tArr.length; i10++) {
            try {
                ...
                StringBuilder sbR = a.r(i10, "Parcelable at index ", " is not a subclass of required class ");
                sbR.append(cls.getName());
                sbR.append(" provided in the parameter");
                throw new BadParcelableException(sbR.toString());
            }
        }
        return tArr2;
    }
