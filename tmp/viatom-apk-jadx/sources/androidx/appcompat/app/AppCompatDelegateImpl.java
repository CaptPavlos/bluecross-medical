...
class AppCompatDelegateImpl extends AppCompatDelegate implements MenuBuilder.Callback, LayoutInflater.Factory2 {
    ...
    public static class Api33Impl {
        ...
        public static OnBackInvokedCallback registerOnBackPressedCallback(Object obj, final AppCompatDelegateImpl appCompatDelegateImpl) {
            ...
            a2.a.d(obj).registerOnBackInvokedCallback(1000000, onBackInvokedCallback);
            return onBackInvokedCallback;
        }

        @DoNotInline
        public static void unregisterOnBackInvokedCallback(Object obj, Object obj2) {
            a2.a.d(obj).unregisterOnBackInvokedCallback((OnBackInvokedCallback) obj2);
        }
    }
    ...
    private boolean applyApplicationSpecificConfig(boolean z9, boolean z10) throws IllegalAccessException, NoSuchFieldException, PackageManager.NameNotFoundException, SecurityException, IllegalArgumentException {
        if (this.mDestroyed) {
            return false;
        }
    ...
    private void attachToWindow(@NonNull Window window) {
        if (this.mWindow != null) {
            androidx.window.layout.c.g("AppCompat has already installed itself into the Window");
            return;
        }
    ...
    @NonNull
    private Configuration createOverrideAppConfiguration(@NonNull Context context, int i10, @Nullable LocaleListCompat localeListCompat, @Nullable Configuration configuration, boolean z9) {
    ...
    private ViewGroup createSubDecor() throws IllegalAccessException, NoSuchMethodException, SecurityException, IllegalArgumentException, InvocationTargetException {
        ...
        if (!typedArrayObtainStyledAttributes.hasValue(i10)) {
            typedArrayObtainStyledAttributes.recycle();
            androidx.window.layout.c.g("You need to use a Theme.AppCompat theme (or descendant) with this activity.");
            return null;
        }
    ...
    private void ensureWindow() {
        ...
        androidx.window.layout.c.g("We have not been given a Window");
    }
    ...
    */
    ...
    private void updateResourcesConfiguration(int i10, @Nullable LocaleListCompat localeListCompat, boolean z9, @Nullable Configuration configuration) throws IllegalAccessException, NoSuchFieldException, SecurityException, IllegalArgumentException {
    ...
    public PanelFeatureState getPanelState(int i10, boolean z9) {
        PanelFeatureState[] panelFeatureStateArr = this.mPanels;
    ...
    public int mapNightMode(@NonNull Context context, int i10) {
        ...
        if (i10 != -1) {
            ...
            if (i10 != 1 && i10 != 2) {
                ...
                androidx.window.layout.c.g("Unknown value set for night mode. Please use one of the MODE_NIGHT values from AppCompatDelegate.");
                return 0;
            }
        }
        return i10;
    ...
    */
    ...
    public void setSupportActionBar(Toolbar toolbar) {
        if (this.mHost instanceof Activity) {
            ...
            if (supportActionBar instanceof WindowDecorActionBar) {
                androidx.window.layout.c.g("This Activity already has an action bar supplied by the window decor. Do not request Window.FEATURE_SUPPORT_ACTION_BAR and set windowActionBar to false in your theme to use a Toolbar instead.");
                return;
            }
    ...
    public ActionMode startSupportActionMode(@NonNull ActionMode.Callback callback) {
        ...
        if (callback == null) {
            com.google.gson.internal.a.n("ActionMode callback can not be null.");
            return null;
        }
        ActionMode actionMode = this.mActionMode;
        if (actionMode != null) {
