...
class GhostViewPort extends ViewGroup implements GhostView {
    ...
    public static GhostViewPort addGhost(View view, ViewGroup viewGroup, Matrix matrix) throws IllegalAccessException, NoSuchMethodException, SecurityException, IllegalArgumentException, InvocationTargetException {
        ...
        if (!(view.getParent() instanceof ViewGroup)) {
            com.google.gson.internal.a.n("Ghosted views must be parented by a ViewGroup");
            return null;
        }
    ...
    public void setVisibility(int i10) throws IllegalAccessException, NoSuchFieldException, SecurityException, IllegalArgumentException {
