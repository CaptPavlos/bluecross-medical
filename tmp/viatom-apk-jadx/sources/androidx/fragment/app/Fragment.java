...
public class Fragment implements ComponentCallbacks, View.OnCreateContextMenuListener, LifecycleOwner, ViewModelStoreOwner, HasDefaultViewModelProviderFactory, SavedStateRegistryOwner, ActivityResultCaller {
    ...
    public static Fragment instantiate(@NonNull Context context, @NonNull String str, @Nullable Bundle bundle) throws IllegalAccessException, java.lang.InstantiationException, IllegalArgumentException, InvocationTargetException {
        try {
            ...
            throw new InstantiationException(androidx.constraintlayout.core.widgets.analyzer.a.x("Unable to instantiate fragment ", str, ": make sure class name exists, is public, and has an empty constructor that is public"), e);
        } catch (java.lang.InstantiationException e3) {
            throw new InstantiationException(androidx.constraintlayout.core.widgets.analyzer.a.x("Unable to instantiate fragment ", str, ": make sure class name exists, is public, and has an empty constructor that is public"), e3);
        } catch (NoSuchMethodException e7) {
            throw new InstantiationException(androidx.constraintlayout.core.widgets.analyzer.a.x("Unable to instantiate fragment ", str, ": could not find Fragment constructor"), e7);
        } catch (InvocationTargetException e10) {
            throw new InstantiationException(androidx.constraintlayout.core.widgets.analyzer.a.x("Unable to instantiate fragment ", str, ": calling Fragment constructor caused an exception"), e10);
        }
    }
    ...
    private <I, O> ActivityResultLauncher<I> prepareCallInternal(@NonNull final ActivityResultContract<I, O> activityResultContract, @NonNull final Function<Void, ActivityResultRegistry> function, @NonNull final ActivityResultCallback<O> activityResultCallback) {
        if (this.mState > 1) {
            androidx.window.layout.c.g(androidx.constraintlayout.core.widgets.analyzer.a.w("Fragment ", this, " is attempting to registerForActivityResult after being created. Fragments must call registerForActivityResult() before they are created (i.e. initialization, onAttach(), or onCreate())."));
            return null;
        }
        ...
        return new ActivityResultLauncher<I>() { // from class: androidx.fragment.app.Fragment.10
            ...
            public void launch(I i10, @Nullable ActivityOptionsCompat activityOptionsCompat) {
                ...
                if (activityResultLauncher != null) {
                    ...
                    androidx.window.layout.c.g("Operation cannot be started before fragment is in created state");
                }
            }
    ...
    public FragmentContainer createFragmentContainer() {
        return new FragmentContainer() { // from class: androidx.fragment.app.Fragment.5
            ...
            public View onFindViewById(int i10) {
                ...
                androidx.core.view.accessibility.a.q(Fragment.this, "Fragment ", " does not have a view");
                return null;
            }
    ...
    public void dump(@NonNull String str, @Nullable FileDescriptor fileDescriptor, @NonNull PrintWriter printWriter, @Nullable String[] strArr) {
        ...
        this.mChildFragmentManager.dump(a3.a.C(str, "  "), fileDescriptor, printWriter, strArr);
    }
    ...
    public final FragmentManager getChildFragmentManager() {
        ...
        androidx.window.layout.c.g(androidx.constraintlayout.core.widgets.analyzer.a.w("Fragment ", this, " has not been attached yet."));
        return null;
    }
    ...
    public ViewModelProvider.Factory getDefaultViewModelProviderFactory() {
        Application application;
        if (this.mFragmentManager == null) {
            androidx.window.layout.c.g("Can't access ViewModels from detached fragment");
            return null;
        }
    ...
    public LayoutInflater getLayoutInflater(@Nullable Bundle bundle) {
        FragmentHostCallback<?> fragmentHostCallback = this.mHost;
        if (fragmentHostCallback == null) {
            androidx.window.layout.c.g("onGetLayoutInflater() cannot be executed until the Fragment is attached to the FragmentManager.");
            return null;
        }
    ...
    public final FragmentManager getParentFragmentManager() {
        ...
        androidx.window.layout.c.g(androidx.constraintlayout.core.widgets.analyzer.a.w("Fragment ", this, " not associated with a fragment manager."));
        return null;
    }
    ...
    public LifecycleOwner getViewLifecycleOwner() {
        ...
        androidx.window.layout.c.g("Can't access the Fragment View's LifecycleOwner when getView() is null i.e., before onCreateView() or after onDestroyView()");
        return null;
    }
    ...
    public ViewModelStore getViewModelStore() {
        ...
        androidx.window.layout.c.g("Calling getViewModelStore() before a Fragment reaches onCreate() when using setMaxLifecycle(INITIALIZED) is not supported");
        return null;
    }
    ...
    public void performActivityCreated(Bundle bundle) {
        ...
        if (!this.mCalled) {
            throw new SuperNotCalledException(androidx.constraintlayout.core.widgets.analyzer.a.w("Fragment ", this, " did not call through to super.onActivityCreated()"));
        }
        restoreViewState();
    ...
    public void performAttach() {
        ...
        int i10 = 0;
        while (i10 < size) {
            OnPreAttachedListener onPreAttachedListener = arrayList.get(i10);
            i10++;
            onPreAttachedListener.onPreAttached();
        }
        ...
        if (!this.mCalled) {
            throw new SuperNotCalledException(androidx.constraintlayout.core.widgets.analyzer.a.w("Fragment ", this, " did not call through to super.onAttach()"));
        }
    ...
    public void performCreate(Bundle bundle) {
        ...
        if (!this.mCalled) {
            throw new SuperNotCalledException(androidx.constraintlayout.core.widgets.analyzer.a.w("Fragment ", this, " did not call through to super.onCreate()"));
        }
    ...
    public void performCreateView(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, @Nullable Bundle bundle) {
        ...
        if (viewOnCreateView == null) {
            if (fragmentViewLifecycleOwner.isInitialized()) {
                androidx.window.layout.c.g("Called getViewLifecycleOwner() but onCreateView() returned null");
                return;
            } else {
    ...
    public void performDestroy() {
        ...
        onDestroy();
        if (!this.mCalled) {
            throw new SuperNotCalledException(androidx.constraintlayout.core.widgets.analyzer.a.w("Fragment ", this, " did not call through to super.onDestroy()"));
        }
    }
    ...
    public void performDestroyView() {
        ...
        onDestroyView();
        if (!this.mCalled) {
            throw new SuperNotCalledException(androidx.constraintlayout.core.widgets.analyzer.a.w("Fragment ", this, " did not call through to super.onDestroyView()"));
        }
    ...
    public void performDetach() {
        ...
        if (!this.mCalled) {
            throw new SuperNotCalledException(androidx.constraintlayout.core.widgets.analyzer.a.w("Fragment ", this, " did not call through to super.onDetach()"));
        }
    ...
    public void performPause() {
        ...
        onPause();
        if (!this.mCalled) {
            throw new SuperNotCalledException(androidx.constraintlayout.core.widgets.analyzer.a.w("Fragment ", this, " did not call through to super.onPause()"));
        }
    }
    ...
    public void performResume() {
        ...
        onResume();
        if (!this.mCalled) {
            throw new SuperNotCalledException(androidx.constraintlayout.core.widgets.analyzer.a.w("Fragment ", this, " did not call through to super.onResume()"));
        }
    ...
    public void performStart() {
        ...
        onStart();
        if (!this.mCalled) {
            throw new SuperNotCalledException(androidx.constraintlayout.core.widgets.analyzer.a.w("Fragment ", this, " did not call through to super.onStart()"));
        }
        LifecycleRegistry lifecycleRegistry = this.mLifecycleRegistry;
    ...
    public void performStop() {
        ...
        onStop();
        if (!this.mCalled) {
            throw new SuperNotCalledException(androidx.constraintlayout.core.widgets.analyzer.a.w("Fragment ", this, " did not call through to super.onStop()"));
        }
    }
    ...
    public final void requestPermissions(@NonNull String[] strArr, int i10) {
        if (this.mHost != null) {
            ...
            androidx.window.layout.c.g(androidx.constraintlayout.core.widgets.analyzer.a.w("Fragment ", this, " not attached to Activity"));
        }
    }
    ...
    public final FragmentActivity requireActivity() {
        ...
        androidx.window.layout.c.g(androidx.constraintlayout.core.widgets.analyzer.a.w("Fragment ", this, " not attached to an activity."));
        return null;
    }
    ...
    public final Bundle requireArguments() {
        ...
        androidx.window.layout.c.g(androidx.constraintlayout.core.widgets.analyzer.a.w("Fragment ", this, " does not have any arguments."));
        return null;
    }
    ...
    public final Context requireContext() {
        ...
        androidx.window.layout.c.g(androidx.constraintlayout.core.widgets.analyzer.a.w("Fragment ", this, " not attached to a context."));
        return null;
    }
    ...
    public final Object requireHost() {
        ...
        androidx.window.layout.c.g(androidx.constraintlayout.core.widgets.analyzer.a.w("Fragment ", this, " not attached to a host."));
        return null;
    }
    ...
    public final Fragment requireParentFragment() {
        ...
        if (getContext() == null) {
            androidx.window.layout.c.g(androidx.constraintlayout.core.widgets.analyzer.a.w("Fragment ", this, " is not attached to any Fragment or host"));
            return null;
        }
    ...
    public final View requireView() {
        ...
        androidx.window.layout.c.g(androidx.constraintlayout.core.widgets.analyzer.a.w("Fragment ", this, " did not return a View from onCreateView() or this was called before onCreateView()."));
        return null;
    }
    ...
    public final void restoreViewState(Bundle bundle) {
        ...
        if (!this.mCalled) {
            throw new SuperNotCalledException(androidx.constraintlayout.core.widgets.analyzer.a.w("Fragment ", this, " did not call through to super.onViewStateRestored()"));
        }
        if (this.mView != null) {
    ...
    public void setArguments(@Nullable Bundle bundle) {
        if (this.mFragmentManager == null || !isStateSaved()) {
            ...
            androidx.window.layout.c.g("Fragment already added and state has been saved");
        }
    }
    ...
    public void setInitialSavedState(@Nullable SavedState savedState) {
        Bundle bundle;
        if (this.mFragmentManager != null) {
            androidx.window.layout.c.g("Fragment already added");
            return;
        }
    ...
    public void setTargetFragment(@Nullable Fragment fragment, int i10) {
        ...
        if (fragmentManager != null && fragmentManager2 != null && fragmentManager != fragmentManager2) {
            com.google.gson.internal.a.n(androidx.constraintlayout.core.widgets.analyzer.a.w("Fragment ", fragment, " must share the same FragmentManager to be set as a target fragment"));
            return;
        }
        for (Fragment targetFragment = fragment; targetFragment != null; targetFragment = targetFragment.getTargetFragment(false)) {
            if (targetFragment.equals(this)) {
                androidx.core.view.accessibility.a.m("Setting ", fragment, " as the target of ", this, " would create a target cycle");
                return;
            }
        }
        if (fragment == null) {
