...
public final class Mp4WebvttDecoder extends SimpleSubtitleDecoder {
    ...
    public final Mp4WebvttSubtitle decode(byte[] bArr, int i10, boolean z9) throws SubtitleDecoderException {
        ...
        while (this.sampleData.bytesLeft() > 0) {
            ...
            int i12 = this.sampleData.readInt();
            int i13 = TYPE_vttc;
            ParsableByteArray parsableByteArray = this.sampleData;
            if (i12 == i13) {
                arrayList.add(parseVttCueBox(parsableByteArray, this.builder, i11 - 8));
            } else {
