...
public final class MutableIntFloatMap extends IntFloatMap {
    ...
    private final void resizeStorage(int i10) {
        ...
        while (i12 < i11) {
            if (((jArr2[i12 >> 3] >> ((i12 & 7) << 3)) & 255) < 128) {
                ...
                int i18 = mutableIntFloatMap._capacity;
    ...
    public final float getOrPut(int i10, g7.a aVar) {
        aVar.getClass();
    ...
    public final float put(int i10, float f, float f10) {
    ...
    public final boolean remove(int i10, float f) {
        int iFindKeyIndex = findKeyIndex(i10);
        ...
        while (true) {
            ...
            if ((((~j10) << 7) & j10 & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i12 = 0; i12 < i11; i12++) {
                    if ((255 & j10) < 128) {
                        int i13 = (i10 << 3) + i12;
                        if (((Boolean) pVar.invoke(Integer.valueOf(this.keys[i13]), Float.valueOf(this.values[i13]))).booleanValue()) {
                            removeValueAt(i13);
                        }
                    }
                    j10 >>= 8;
    ...
    public final void set(int i10, float f) {
        int iFindInsertIndex = findInsertIndex(i10);
        if (iFindInsertIndex < 0) {
            iFindInsertIndex = ~iFindInsertIndex;
        }
    ...
    public /* synthetic */ MutableIntFloatMap(int i10, int i11, g gVar) {
        this((i11 & 1) != 0 ? 6 : i10);
    }

    public final void put(int i10, float f) {
        set(i10, f);
    }
