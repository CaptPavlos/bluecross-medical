...
public final class MutableObjectLongMap<K> extends ObjectLongMap<K> {
    ...
    private final void resizeStorage(int i10) {
        ...
        while (i13 < i12) {
            if (((jArr[i13 >> 3] >> ((i13 & 7) << 3)) & 255) < 128) {
                ...
                jArr3[iFindFirstAvailableSlot] = jArr2[i11];
            } else {
                i11 = i13;
            }
            i13 = i11 + 1;
    ...
    public final long getOrPut(K k10, g7.a aVar) {
        aVar.getClass();
    ...
    public final long put(K k10, long j10, long j11) {
        ...
        if (iFindIndex < 0) {
            ...
            j11 = this.values[iFindIndex];
        }
        this.keys[iFindIndex] = k10;
        this.values[iFindIndex] = j10;
        return j11;
    }
        ...
        while (true) {
            ...
            if ((((~j10) << 7) & j10 & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i12 = 0; i12 < i11; i12++) {
                    if ((255 & j10) < 128) {
                        int i13 = (i10 << 3) + i12;
                        if (((Boolean) pVar.invoke(this.keys[i13], Long.valueOf(this.values[i13]))).booleanValue()) {
                            removeValueAt(i13);
                        }
                    }
                    j10 >>= 8;
    ...
    public /* synthetic */ MutableObjectLongMap(int i10, int i11, g gVar) {
        this((i11 & 1) != 0 ? 6 : i10);
    }
