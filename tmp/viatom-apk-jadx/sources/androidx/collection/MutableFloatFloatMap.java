...
public final class MutableFloatFloatMap extends FloatFloatMap {
    ...
    private final void resizeStorage(int i10) {
        ...
        while (i12 < i11) {
            if (((jArr2[i12 >> 3] >> ((i12 & 7) << 3)) & 255) < 128) {
                ...
                int i16 = mutableFloatFloatMap._capacity;
    ...
    public final float getOrPut(float f, g7.a aVar) {
        aVar.getClass();
        ...
        while (true) {
            ...
            if ((((~j10) << 7) & j10 & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i12 = 0; i12 < i11; i12++) {
                    if ((255 & j10) < 128) {
                        int i13 = (i10 << 3) + i12;
                        if (((Boolean) pVar.invoke(Float.valueOf(this.keys[i13]), Float.valueOf(this.values[i13]))).booleanValue()) {
                            removeValueAt(i13);
                        }
                    }
                    j10 >>= 8;
    ...
    public /* synthetic */ MutableFloatFloatMap(int i10, int i11, g gVar) {
        this((i11 & 1) != 0 ? 6 : i10);
    }
