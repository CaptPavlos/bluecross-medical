...
class DropDownListView extends ListView {
    ...
    public static class Api30Impl {
        ...
        public static void positionSelectorForHoveredItem(DropDownListView dropDownListView, int i10, View view) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
            try {
    ...
    public static class PreApi33Impl {
        ...
        public static void setSelectedChildViewEnabled(AbsListView absListView, boolean z9) throws IllegalAccessException, IllegalArgumentException {
            Field field = sIsChildViewEnabled;
            if (field != null) {
                try {
    ...
    private void positionSelectorCompat(int i10, View view) throws IllegalAccessException, IllegalArgumentException {
    ...
    private void positionSelectorLikeFocusCompat(int i10, View view) throws IllegalAccessException, IllegalArgumentException {
    ...
    private void positionSelectorLikeTouchCompat(int i10, View view, float f, float f10) throws IllegalAccessException, IllegalArgumentException {
    ...
    private void setPressedItem(View view, int i10, float f, float f10) throws IllegalAccessException, IllegalArgumentException {
        View childAt;
        ...
        positionSelectorLikeTouchCompat(i10, view, f, f10);
    ...
    private void superSetSelectedChildViewEnabled(boolean z9) throws IllegalAccessException, IllegalArgumentException {
    ...
    public int lookForSelectablePosition(int i10, boolean z9) {
        int iMin;
