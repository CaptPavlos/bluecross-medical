...
public final class u extends r {
    ...
    public final boolean a() {
        com.mbridge.msdk.newreward.function.c.a.a aVarC = super.c();
        if (aVarC == null) {
            return true;
        }
        return aVarC.k();
    ...
    public final String b() {
        ...
        if (super.c() == null || super.c().h() == null || (campaignExH = super.c().h()) == null || (rewardTemplateMode = campaignExH.getRewardTemplateMode()) == null) {
            return "";
        }
