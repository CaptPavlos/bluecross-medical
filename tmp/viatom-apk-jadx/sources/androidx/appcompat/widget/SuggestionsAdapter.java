...
class SuggestionsAdapter extends ResourceCursorAdapter implements View.OnClickListener {
    ...
    private Drawable getActivityIcon(ComponentName componentName) throws PackageManager.NameNotFoundException {
        ...
        try {
            ...
            StringBuilder sbR = a3.a.r(iconResource, "Invalid icon resource ", " for ");
            sbR.append(componentName.flattenToShortString());
            Log.w(LOG_TAG, sbR.toString());
            return null;
        ...
        try {
            ...
            if (size == 1) {
                try {
                    ...
                    f.e(uri, "Single path segment is not a resource ID: ");
                    return null;
                }
            } else {
                if (size != 2) {
                    f.e(uri, "More than two path segments: ");
                    return null;
                }
            ...
            f.e(uri, "No resource found for: ");
            return null;
        } catch (PackageManager.NameNotFoundException unused2) {
            f.e(uri, "No package found for authority: ");
            return null;
        }
    }
