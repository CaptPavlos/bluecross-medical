...
class Huffman {
    ...
    private void addCode(int i10, int i11, byte b10) {
        ...
        while (b10 > 8) {
            ...
            if (nodeArr == null) {
                c.g("invalid dictionary: prefix not unique");
                return;
            } else {
                if (nodeArr[i12] == null) {
