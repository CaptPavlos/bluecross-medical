...
public class AnimatedStateListDrawableCompat extends StateListDrawableCompat implements TintAwareDrawable {
    ...
    @Nullable
    public static AnimatedStateListDrawableCompat create(@NonNull Context context, @DrawableRes int i10, @Nullable Resources.Theme theme) throws XmlPullParserException, Resources.NotFoundException, IOException {
        int next;
        try {
    ...
    public <T extends Drawable & Animatable> void addTransition(int i10, int i11, @NonNull T t, boolean z9) {
        ObjectsCompat.requireNonNull(t);
        this.mState.addTransition(i10, i11, t, z9);
    }
    ...
    public static class AnimatedStateListState extends StateListDrawableCompat.StateListState {
        ...
        public int addTransition(int i10, int i11, @NonNull Drawable drawable, boolean z9) {
            int iAddChild = addChild(drawable);
            long jGenerateTransitionKey = generateTransitionKey(i10, i11);
            long j10 = z9 ? REVERSIBLE_FLAG_BIT : 0L;
            long j11 = iAddChild;
