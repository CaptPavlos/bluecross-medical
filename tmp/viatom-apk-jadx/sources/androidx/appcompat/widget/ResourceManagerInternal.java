...
public final class ResourceManagerInternal {
    ...
    private void checkVectorDrawableSetup(@NonNull Context context) {
        ...
        if (drawable == null || !isVectorDrawable(drawable)) {
            ...
            androidx.window.layout.c.g("This app has been built with an incorrect configuration. Please configure your build for VectorDrawableCompat.");
        }
    }
    ...
    private Drawable createDrawableIfNeeded(@NonNull Context context, @DrawableRes int i10) throws Resources.NotFoundException {
    ...
    private Drawable loadDrawableFromDelegates(@NonNull Context context, @DrawableRes int i10) throws XmlPullParserException, Resources.NotFoundException, IOException {
        int next;
    ...
    public synchronized Drawable getDrawable(@NonNull Context context, @DrawableRes int i10, boolean z9) {
        ...
        try {
            ...
            if (drawableLoadDrawableFromDelegates != null) {
                drawableLoadDrawableFromDelegates = tintDrawable(context, i10, z9, drawableLoadDrawableFromDelegates);
            }
            if (drawableLoadDrawableFromDelegates != null) {
    ...
    private Drawable tintDrawable(@NonNull Context context, @DrawableRes int i10, boolean z9, @NonNull Drawable drawable) {
        ...
        ResourceManagerHooks resourceManagerHooks = this.mHooks;
        if ((resourceManagerHooks == null || !resourceManagerHooks.tintDrawable(context, i10, drawable)) && !tintDrawableUsingColorFilter(context, i10, drawable) && z9) {
            return null;
        }
        return drawable;
    }
