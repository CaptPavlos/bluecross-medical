...
public class ThemeUtils {
    ...
    public static int getThemeAttrColor(@NonNull Context context, int i10, float f) {
        return ColorUtils.setAlphaComponent(getThemeAttrColor(context, i10), Math.round(Color.alpha(r0) * f));
    }
}
