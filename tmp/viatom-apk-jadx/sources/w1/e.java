...
public final class e {
    ...
    public static final String f13330b = g.h(UUID.randomUUID().toString() + System.currentTimeMillis());

    /* renamed from: c, reason: collision with root package name */
    public static final AtomicLong f13331c = new AtomicLong(0);
    ...
    public e() {
        ...
        byte b14 = bArrA[0];
        byte b15 = bArrA[1];
        byte[] bArrA2 = a(f13331c.incrementAndGet());
        byte b16 = bArrA2[0];
        byte b17 = bArrA2[1];
        ...
        this.f13332a = String.format(locale, "%s%s%s%s", strE.substring(0, 12), strE.substring(12, 16), strE.subSequence(16, 20), f13330b.substring(0, 12)).toUpperCase(locale);
    }
