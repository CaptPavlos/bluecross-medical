...
final class FieldInfo implements Comparable<FieldInfo> {
    ...
    private FieldInfo(java.lang.reflect.Field field, int i10, FieldType fieldType, Class<?> cls, java.lang.reflect.Field field2, int i11, boolean z9, boolean z10, OneofInfo oneofInfo, Class<?> cls2, Object obj, Internal.EnumVerifier enumVerifier, java.lang.reflect.Field field3) {
        this.field = field;
        this.type = fieldType;
    ...
    private static void checkFieldNumber(int i10) {
        ...
        a.n(a3.a.f(i10, "fieldNumber must be positive: "));
    }

    public static FieldInfo forExplicitPresenceField(java.lang.reflect.Field field, int i10, FieldType fieldType, java.lang.reflect.Field field2, int i11, boolean z9, Internal.EnumVerifier enumVerifier) {
        checkFieldNumber(i10);
        Internal.checkNotNull(field, "field");
        Internal.checkNotNull(fieldType, "fieldType");
        Internal.checkNotNull(field2, "presenceField");
        if (field2 == null || isExactlyOneBitSet(i11)) {
            return new FieldInfo(field, i10, fieldType, null, field2, i11, false, z9, null, null, null, enumVerifier, null);
        }
        a.n(a3.a.f(i11, "presenceMask must have exactly one bit set: "));
        return null;
    }

    public static FieldInfo forField(java.lang.reflect.Field field, int i10, FieldType fieldType, boolean z9) {
        checkFieldNumber(i10);
        Internal.checkNotNull(field, "field");
        Internal.checkNotNull(fieldType, "fieldType");
        if (fieldType != FieldType.MESSAGE_LIST && fieldType != FieldType.GROUP_LIST) {
            return new FieldInfo(field, i10, fieldType, null, null, 0, false, z9, null, null, null, null, null);
        }
        c.g("Shouldn't be called for repeated message fields.");
        return null;
    }
    ...
    public static FieldInfo forLegacyRequiredField(java.lang.reflect.Field field, int i10, FieldType fieldType, java.lang.reflect.Field field2, int i11, boolean z9, Internal.EnumVerifier enumVerifier) {
        checkFieldNumber(i10);
        Internal.checkNotNull(field, "field");
        Internal.checkNotNull(fieldType, "fieldType");
        Internal.checkNotNull(field2, "presenceField");
        if (field2 == null || isExactlyOneBitSet(i11)) {
            return new FieldInfo(field, i10, fieldType, null, field2, i11, true, z9, null, null, null, enumVerifier, null);
        }
        a.n(a3.a.f(i11, "presenceMask must have exactly one bit set: "));
        return null;
    }
    ...
    public static FieldInfo forOneofMemberField(int i10, FieldType fieldType, OneofInfo oneofInfo, Class<?> cls, boolean z9, Internal.EnumVerifier enumVerifier) {
        checkFieldNumber(i10);
        Internal.checkNotNull(fieldType, "fieldType");
        Internal.checkNotNull(oneofInfo, "oneof");
        Internal.checkNotNull(cls, "oneofStoredType");
        if (fieldType.isScalar()) {
            return new FieldInfo(null, i10, fieldType, null, null, 0, false, z9, oneofInfo, cls, null, enumVerifier, null);
        }
    ...
    public static final class Builder {
        ...
        public Builder withField(java.lang.reflect.Field field) {
            ...
            c.g("Cannot set field when building a oneof.");
            return null;
        }
        ...
        public Builder withOneof(OneofInfo oneofInfo, Class<?> cls) {
            if (this.field != null || this.presenceField != null) {
                c.g("Cannot set oneof when field or presenceField have been provided");
                return null;
            }
            this.oneof = oneofInfo;
