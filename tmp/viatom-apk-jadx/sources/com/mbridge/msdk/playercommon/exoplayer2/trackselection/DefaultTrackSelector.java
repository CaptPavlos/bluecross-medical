...
public class DefaultTrackSelector extends MappingTrackSelector {
    ...
    private static int[] getAdaptiveAudioTracks(TrackGroup trackGroup, int[] iArr, boolean z9) {
        ...
        for (int i11 = 0; i11 < trackGroup.length; i11++) {
            ...
            AudioConfigurationTuple audioConfigurationTuple2 = new AudioConfigurationTuple(format.channelCount, format.sampleRate, z9 ? null : format.sampleMimeType);
    ...
    private static int[] getAdaptiveVideoTracksForGroup(TrackGroup trackGroup, int[] iArr, boolean z9, int i10, int i11, int i12, int i13, int i14, int i15, boolean z10) {
        int i16;
        int i17;
        int i18;
        String str;
        ...
        List<Integer> viewportFilteredTrackIndices = getViewportFilteredTrackIndices(trackGroup, i14, i15, z10);
    ...
    */
    ...
    private static TrackSelection selectAdaptiveVideoTrack(TrackGroupArray trackGroupArray, int[][] iArr, int i10, Parameters parameters, TrackSelection.Factory factory) throws ExoPlaybackException {
        ...
        boolean z9 = parameters.allowMixedMimeAdaptiveness && (i10 & i11) != 0;
        for (int i12 = 0; i12 < trackGroupArray.length; i12++) {
            TrackGroup trackGroup = trackGroupArray.get(i12);
            int[] adaptiveVideoTracksForGroup = getAdaptiveVideoTracksForGroup(trackGroup, iArr[i12], z9, i11, parameters.maxVideoWidth, parameters.maxVideoHeight, parameters.maxVideoBitrate, parameters.viewportWidth, parameters.viewportHeight, parameters.viewportOrientationMayChange);
    ...
    */
        ...
        while (true) {
            ...
            if (2 == mappedTrackInfo.getRendererType(i10)) {
                if (!z9) {
                    ...
                    z9 = trackSelectionSelectVideoTrack != null;
                }
                z10 |= mappedTrackInfo.getTrackGroups(i10).length > 0;
            }
            i10++;
        }
        boolean z11 = false;
            ...
            if (rendererType != 1) {
                if (rendererType != 2) {
                    if (rendererType != 3) {
                        ...
                        z12 = trackSelectionSelectTextTrack != null;
                    }
                }
            } else if (!z11) {
                TrackSelection trackSelectionSelectAudioTrack = selectAudioTrack(mappedTrackInfo.getTrackGroups(i11), iArr[i11], iArr2[i11], parameters, z10 ? null : this.adaptiveTrackSelectionFactory);
                trackSelectionArr[i11] = trackSelectionSelectAudioTrack;
                z11 = trackSelectionSelectAudioTrack != null;
            }
        }
    ...
    public final void setRendererDisabled(int i10, boolean z9) {
        setParameters(buildUponParameters().setRendererDisabled(i10, z9));
    }
    ...
    public static final class ParametersBuilder {
        ...
        public final ParametersBuilder setAllowMixedMimeAdaptiveness(boolean z9) {
            this.allowMixedMimeAdaptiveness = z9;
            return this;
        }

        public final ParametersBuilder setAllowNonSeamlessAdaptiveness(boolean z9) {
            this.allowNonSeamlessAdaptiveness = z9;
            return this;
        }
        ...
        public final ParametersBuilder setExceedRendererCapabilitiesIfNecessary(boolean z9) {
            this.exceedRendererCapabilitiesIfNecessary = z9;
            return this;
        }

        public final ParametersBuilder setExceedVideoConstraintsIfNecessary(boolean z9) {
            this.exceedVideoConstraintsIfNecessary = z9;
            return this;
        }

        public final ParametersBuilder setForceLowestBitrate(boolean z9) {
        ...
        public final ParametersBuilder setRendererDisabled(int i10, boolean z9) {
            if (this.rendererDisabledFlags.get(i10) == z9) {
                return this;
            }
        ...
        public final ParametersBuilder setSelectUndeterminedTextLanguage(boolean z9) {
        ...
        public final ParametersBuilder setViewportSize(int i10, int i11, boolean z9) {
        ...
        public final ParametersBuilder setViewportSizeToPhysicalDisplaySize(Context context, boolean z9) {
            Point physicalDisplaySize = Util.getPhysicalDisplaySize(context);
            return setViewportSize(physicalDisplaySize.x, physicalDisplaySize.y, z9);
        }
    ...
    public static final class Parameters implements Parcelable {
        ...
        public Parameters(SparseArray<Map<TrackGroupArray, SelectionOverride>> sparseArray, SparseBooleanArray sparseBooleanArray, @Nullable String str, @Nullable String str2, boolean z9, int i10, boolean z10, boolean z11, boolean z12, int i11, int i12, int i13, boolean z13, boolean z14, int i14, int i15, boolean z15, int i16) {
