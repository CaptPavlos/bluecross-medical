...
final class BackStackRecordState implements Parcelable {
    ...
    public BackStackRecordState(BackStackRecord backStackRecord) {
        ...
        if (!backStackRecord.mAddToBackStack) {
            androidx.window.layout.c.g("Not on back stack");
            throw null;
        }
    ...
    public BackStackRecord instantiate(@NonNull FragmentManager fragmentManager, @NonNull Map<String, Fragment> map) {
        ...
        for (int i10 = 0; i10 < this.mFragmentWhos.size(); i10++) {
            ...
            if (str != null) {
                ...
                if (fragment == null) {
                    androidx.window.layout.c.i("Restoring FragmentTransaction ", this.mName, " failed due to missing saved state for Fragment (", str, ")");
                    return null;
                }
