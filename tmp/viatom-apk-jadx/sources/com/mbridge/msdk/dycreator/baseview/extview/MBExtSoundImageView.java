...
public class MBExtSoundImageView extends SoundImageView {
    ...
    public static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            try {
                f3125a[c.src.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f3125a[c.background.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f3125a[c.contentDescription.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f3125a[c.tag.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f3125a[c.visibility.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f3125a[c.scaleType.ordinal()] = 7;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                f3125a[c.padding.ordinal()] = 8;
            } catch (NoSuchFieldError unused8) {
            }
            try {
                f3125a[c.paddingTop.ordinal()] = 9;
            } catch (NoSuchFieldError unused9) {
            }
            try {
                f3125a[c.paddingBottom.ordinal()] = 10;
            } catch (NoSuchFieldError unused10) {
            }
            try {
                f3125a[c.paddingLeft.ordinal()] = 11;
            } catch (NoSuchFieldError unused11) {
            }
            try {
                f3125a[c.paddingRight.ordinal()] = 12;
            } catch (NoSuchFieldError unused12) {
            }
            try {
                f3125a[c.layout_width.ordinal()] = 13;
            } catch (NoSuchFieldError unused13) {
            }
            try {
                f3125a[c.layout_height.ordinal()] = 14;
            } catch (NoSuchFieldError unused14) {
            }
            try {
                f3125a[c.gravity.ordinal()] = 15;
            } catch (NoSuchFieldError unused15) {
            }
            try {
                f3125a[c.layout_gravity.ordinal()] = 16;
    ...
    public ViewGroup.LayoutParams generateLayoutParams(Context context, AttributeSet attributeSet) {
        ...
        for (int i10 = 0; i10 < attributeCount; i10++) {
            ...
            if (cVar != null) {
                int i11 = AnonymousClass1.f3125a[cVar.ordinal()];
                if (i11 == 6) {
    ...
    public void setAttributeSet(AttributeSet attributeSet) throws NumberFormatException {
        ...
        for (int i10 = 0; i10 < attributeCount; i10++) {
            c cVar = mapC.get(attributeSet.getAttributeName(i10));
            if (cVar != null) {
                switch (AnonymousClass1.f3125a[cVar.ordinal()]) {
                    case 1:
                        String attributeValue = attributeSet.getAttributeValue(i10);
                    ...
                    case 9:
                        ...
                        this.f3122b = iB2;
                        setPadding(this.f3121a, iB2, this.f3123c, this.f3124d);
                        break;
                    case 10:
                        int iB3 = b.a().b(attributeSet.getAttributeValue(i10));
                        this.f3124d = iB3;
                        setPadding(this.f3121a, this.f3122b, this.f3123c, iB3);
                        break;
                    case 11:
                        int iB4 = b.a().b(attributeSet.getAttributeValue(i10));
                        this.f3121a = iB4;
                        setPadding(iB4, this.f3122b, this.f3123c, this.f3124d);
                        break;
                    case 12:
                        int iB5 = b.a().b(attributeSet.getAttributeValue(i10));
                        this.f3123c = iB5;
                        setPadding(this.f3121a, this.f3122b, iB5, this.f3124d);
                        break;
                }
            }
        }
