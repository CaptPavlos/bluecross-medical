...
public final class SectionReader implements TsPayloadReader {
    ...
    public final void consume(ParsableByteArray parsableByteArray, boolean z9) {
        int position = z9 ? parsableByteArray.getPosition() + parsableByteArray.readUnsignedByte() : -1;
        ...
        while (parsableByteArray.bytesLeft() > 0) {
            ...
            if (i10 < 3) {
                ...
                if (i13 == i14) {
                    boolean z10 = this.sectionSyntaxIndicator;
                    ParsableByteArray parsableByteArray3 = this.sectionData;
                    if (!z10) {
                        parsableByteArray3.reset(i14);
                    } else {
                        if (Util.crc(parsableByteArray3.data, 0, i14, -1) != 0) {
                            this.waitingForPayloadStart = true;
                            return;
                        }
