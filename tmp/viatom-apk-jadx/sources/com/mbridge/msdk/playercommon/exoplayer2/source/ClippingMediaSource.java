...
public final class ClippingMediaSource extends CompositeMediaSource<Void> {
    ...
    public static final class ClippingTimeline extends ForwardingTimeline {
        ...
        public final Timeline.Window getWindow(int i10, Timeline.Window window, boolean z9, long j10) {
            this.timeline.getWindow(0, window, z9, 0L);
    ...
    public final long getMediaTimeForChildMediaTime(Void r72, long j10) {
        if (j10 == C.TIME_UNSET) {
            return C.TIME_UNSET;
        }
        long jUsToMs = C.usToMs(this.startUs);
    ...
    @Deprecated
    public ClippingMediaSource(MediaSource mediaSource, long j10, long j11, boolean z9) {
        this(mediaSource, j10, j11, z9, false, false);
    }
