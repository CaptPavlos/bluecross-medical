...
public class AdaptiveTrackSelection extends BaseTrackSelection {
    ...
    public AdaptiveTrackSelection(TrackGroup trackGroup, int[] iArr, BandwidthMeter bandwidthMeter, long j10, long j11, long j12, float f, float f10, long j13, Clock clock) {
    ...
    public static final class Factory implements TrackSelection.Factory {
        ...
        public Factory(BandwidthMeter bandwidthMeter, int i10, int i11, int i12, float f) {
            this(bandwidthMeter, i10, i11, i12, f, 0.75f, AdaptiveTrackSelection.DEFAULT_MIN_TIME_BETWEEN_BUFFER_REEVALUTATION_MS, Clock.DEFAULT);
        }

        public Factory(BandwidthMeter bandwidthMeter, int i10, int i11, int i12, float f, float f10, long j10, Clock clock) {
            this.bandwidthMeter = bandwidthMeter;
