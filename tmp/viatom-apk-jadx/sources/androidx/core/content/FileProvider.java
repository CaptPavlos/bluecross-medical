...
public class FileProvider extends ContentProvider {
    ...
    public static class SimplePathStrategy implements PathStrategy {
        ...
        public void addRoot(String str, File file) throws IOException {
            if (TextUtils.isEmpty(str)) {
                com.google.gson.internal.a.n("Name must not be empty");
                return;
            }
            try {
        ...
        public File getFileForUri(Uri uri) throws IOException {
            ...
            if (file == null) {
                androidx.window.layout.c.j(uri, "Unable to find configured root for ");
                return null;
            }
            ...
            try {
                ...
                androidx.window.layout.c.j(file2, "Failed to resolve canonical path for ");
                return null;
            }
        }
        ...
        public Uri getUriForFile(File file) throws IOException {
            try {
                ...
                if (entry == null) {
                    com.google.gson.internal.a.n(a3.a.i("Failed to find configured root that contains ", canonicalPath));
                    return null;
                }
                ...
                androidx.window.layout.c.j(file, "Failed to resolve canonical path for ");
                return null;
            }
        }
    }
    ...
    public static XmlResourceParser getFileProviderPathsMetaData(Context context, String str, @Nullable ProviderInfo providerInfo, int i10) {
        if (providerInfo == null) {
            com.google.gson.internal.a.n(a3.a.i("Couldn't find meta-data for provider with authority ", str));
            return null;
        }
        ...
        com.google.gson.internal.a.n("Missing android.support.FILE_PROVIDER_PATHS meta-data");
        return null;
    }
    ...
    private static int modeToMode(String str) {
        ...
        com.google.gson.internal.a.n(a3.a.i("Invalid mode: ", str));
        return 0;
    }
