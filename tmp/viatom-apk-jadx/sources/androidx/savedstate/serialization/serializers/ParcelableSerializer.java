...
public abstract class ParcelableSerializer<T extends Parcelable> implements b {
    private final e descriptor = a.a.i("android.os.Parcelable", new e[0]);
    ...
    public final T deserialize(f8.e eVar) {
        ...
        T t = (T) SavedStateReader.m143getParcelableimpl(SavedStateReader.m97constructorimpl(savedStateDecoder.getSavedState$savedstate_release()), savedStateDecoder.getKey$savedstate_release(), y.a(Parcelable.class));
        t.getClass();
        return t;
    }
    ...
    public final void serialize(f8.f fVar, T t) {
        ...
        if (!(fVar instanceof SavedStateEncoder)) {
            ...
            SavedStateWriter.m207putParcelableimpl(SavedStateWriter.m183constructorimpl(savedStateEncoder.getSavedState$savedstate_release()), savedStateEncoder.getKey$savedstate_release(), t);
        }
    }
}
