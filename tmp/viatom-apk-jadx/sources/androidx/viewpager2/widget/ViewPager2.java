...
public final class ViewPager2 extends ViewGroup {
    ...
    private RecyclerView.OnChildAttachStateChangeListener enforceChildFillListener() {
        return new RecyclerView.OnChildAttachStateChangeListener() { // from class: androidx.viewpager2.widget.ViewPager2.4
            ...
            public void onChildViewAttachedToWindow(@NonNull View view) {
                ...
                c.g("Pages must fill the whole ViewPager2 (use match_parent)");
            }
    ...
    public void requestTransform() {
        ...
        float f = (float) (relativeScrollPosition - i10);
        this.mPageTransformerAdapter.onPageScrolled(i10, f, Math.round(getPageSize() * f));
    }
    ...
    public void setCurrentItem(int i10, boolean z9) {
        if (isFakeDragging()) {
            c.g("Cannot change current item when ViewPager2 is fake dragging");
        } else {
            setCurrentItemInternal(i10, z9);
        }
    }

    public void setCurrentItemInternal(int i10, boolean z9) {
        ...
        double d8 = iMin;
        double dAbs = Math.abs(d8 - relativeScrollPosition);
        RecyclerView recyclerView = this.mRecyclerView;
        if (dAbs <= 3.0d) {
            recyclerView.smoothScrollToPosition(iMin);
            return;
        }
        recyclerView.scrollToPosition(d8 > relativeScrollPosition ? iMin - 3 : iMin + 3);
    ...
    public void setOffscreenPageLimit(int i10) {
        if (i10 < 1 && i10 != -1) {
            a.n("Offscreen page limit must be OFFSCREEN_PAGE_LIMIT_DEFAULT or a number > 0");
        } else {
    ...
    public void updateCurrentItem() {
        ...
        if (pagerSnapHelper == null) {
            c.g("Design assumption violated.");
            return;
        }
    ...
    public ViewPager2(@NonNull Context context, @Nullable AttributeSet attributeSet, int i10) throws IllegalStateException {
    ...
    @RequiresApi(21)
    @SuppressLint({"ClassVerificationFailure"})
    public ViewPager2(@NonNull Context context, @Nullable AttributeSet attributeSet, int i10, int i11) throws IllegalStateException {
