...
public final class Cea708Decoder extends CeaDecoder {
    ...
    public Cea708Decoder(int i10) {
        ...
        while (true) {
            ...
            if (i11 >= 8) {
                ...
                cueBuilderArr[i11] = new CueBuilder();
                i11++;
            }
        }
    }
    ...
    private void handleC0Command(int i10) {
        if (i10 != 0) {
            ...
            switch (i10) {
                ...
                default:
                    if (i10 >= 17 && i10 <= 23) {
                        a.B(i10, "Currently unsupported COMMAND_EXT1 Command: ", TAG);
                        this.serviceBlockPacket.skipBits(8);
                        break;
                    } else if (i10 >= 24 && i10 <= 31) {
                        a.B(i10, "Currently unsupported COMMAND_P16 Command: ", TAG);
                        this.serviceBlockPacket.skipBits(16);
                        break;
                    } else {
                        a.B(i10, "Invalid C0 command: ", TAG);
                        break;
                    }
                    break;
            }
    ...
    private void handleC1Command(int i10) {
        ...
        switch (i10) {
            ...
            case 150:
            default:
                a.B(i10, "Invalid C1 command: ", TAG);
                break;
    ...
    private void handleG0Character(int i10) {
        ...
        if (i10 == 127) {
            ...
            cueBuilder.append((char) (i10 & 255));
        }
    }
            ...
            default:
                switch (i10) {
                    ...
                    case 127:
                        ...
                        break;
                    default:
                        a.B(i10, "Invalid G2 character: ", TAG);
                        break;
                }
        }
    }
    ...
    private void handleG3Character(int i10) {
        if (i10 == 160) {
            ...
            a.B(i10, "Invalid G3 character: ", TAG);
            ...
            if (bits3 == 16) {
                ...
                if (bits4 <= 31) {
                    ...
                    if (bits4 <= 127) {
                        ...
                        a.B(bits4, "Invalid extended command: ", TAG);
                    }
                    z9 = true;
                }
            } else if (bits3 <= 31) {
                ...
                if (bits3 <= 127) {
                    ...
                    a.B(bits3, "Invalid base command: ", TAG);
                }
                z9 = true;
            }
        }
        ...
        */
        ...
        public final Cea708Cue build() {
            ...
            if (i13 == 0) {
                ...
                if (i13 != 3) {
                    androidx.core.view.accessibility.a.f(this.justification, "Unexpected justification value: ");
                    return null;
                }
                alignment = Layout.Alignment.ALIGN_NORMAL;
            } else {
            ...
            boolean z9 = this.relativePositioning;
            int i15 = this.horizontalAnchor;
            if (z9) {
                f = i15 / 99.0f;
            ...
            float f12 = (f * 0.9f) + 0.05f;
            float f13 = (f10 * 0.9f) + 0.05f;
            int i16 = this.anchorId;
            if (i16 % 3 == 0) {
                i10 = i16;
                f11 = f12;
                i11 = 0;
            ...
            return new Cea708Cue(spannableStringBuilder, alignment, f13, 0, i11, f11, i14, Float.MIN_VALUE, i17 != COLOR_SOLID_BLACK, i17, this.priority);
        }
        ...
        public final void defineWindow(boolean z9, boolean z10, boolean z11, int i10, boolean z12, int i11, int i12, int i13, int i14, int i15, int i16, int i17) {
            this.defined = true;
            this.visible = z9;
            this.rowLock = z10;
            this.priority = i10;
        ...
        public final void setPenAttributes(int i10, int i11, int i12, boolean z9, boolean z10, int i13, int i14) {
            if (this.italicsStartPosition != -1) {
                if (!z9) {
        ...
        public final void setWindowAttributes(int i10, int i11, boolean z9, int i12, int i13, int i14, int i15) {
            this.windowFillColor = i10;
