...
public final class CharSequenceArraySerializer implements b {
    ...
    private static final e descriptor = a.a.i("kotlin.Array<kotlin.CharSequence>", new e[0]);
    ...
    public CharSequence[] deserialize(f8.e eVar) {
        ...
        if (eVar instanceof SavedStateDecoder) {
            ...
            return SavedStateReader.m115getCharSequenceArrayimpl(SavedStateReader.m97constructorimpl(savedStateDecoder.getSavedState$savedstate_release()), savedStateDecoder.getKey$savedstate_release());
        }
    ...
    @Override // c8.g
    public void serialize(f8.f fVar, CharSequence[] charSequenceArr) {
        fVar.getClass();
        ...
        if (!(fVar instanceof SavedStateEncoder)) {
            ...
            SavedStateWriter.m194putCharSequenceArrayimpl(SavedStateWriter.m183constructorimpl(savedStateEncoder.getSavedState$savedstate_release()), savedStateEncoder.getKey$savedstate_release(), charSequenceArr);
        }
    }
}
