...
public abstract class Visibility extends Transition {
    ...
    public Animator createAnimator(@NonNull ViewGroup viewGroup, @Nullable TransitionValues transitionValues, @Nullable TransitionValues transitionValues2) {
        ...
        int i10 = visibilityChangeInfo.mStartVisibility;
        return z9 ? onAppear(viewGroup, transitionValues, i10, transitionValues2, visibilityChangeInfo.mEndVisibility) : onDisappear(viewGroup, transitionValues, i10, transitionValues2, visibilityChangeInfo.mEndVisibility);
    }
    ...
    */
    ...
    public void setMode(int i10) {
        if ((i10 & (-4)) == 0) {
            ...
            com.google.gson.internal.a.n("Only MODE_IN and MODE_OUT flags are allowed");
        }
    }
    ...
    public static class DisappearListener extends AnimatorListenerAdapter implements Transition.TransitionListener {
        ...
        public void onAnimationEnd(@NonNull Animator animator, boolean z9) throws IllegalAccessException, NoSuchFieldException, SecurityException, IllegalArgumentException {
            if (z9) {
                return;
            }
        ...
        @Override // android.animation.Animator.AnimatorListener
        public void onAnimationStart(@NonNull Animator animator, boolean z9) throws IllegalAccessException, NoSuchFieldException, SecurityException, IllegalArgumentException {
            if (z9) {
