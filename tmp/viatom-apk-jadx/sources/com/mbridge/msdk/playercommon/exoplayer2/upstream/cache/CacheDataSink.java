...
public final class CacheDataSink implements DataSink {
    ...
    public CacheDataSink(Cache cache, long j10, int i10, boolean z9) {
        this.cache = (Cache) Assertions.checkNotNull(cache);
        this.maxCacheFileSize = j10;
        this.bufferSize = i10;
        this.syncFileDescriptor = z9;
    }
    ...
    public CacheDataSink(Cache cache, long j10, boolean z9) {
        this(cache, j10, DEFAULT_BUFFER_SIZE, z9);
    }
