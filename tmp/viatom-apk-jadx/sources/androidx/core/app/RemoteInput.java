...
public final class RemoteInput {
    ...
    public static final class Builder {
        ...
        public Builder(@NonNull String str) {
            if (str != null) {
                ...
                com.google.gson.internal.a.n("Result key can't be null");
                throw null;
            }
        }
    ...
    public RemoteInput(String str, CharSequence charSequence, CharSequence[] charSequenceArr, boolean z9, int i10, Bundle bundle, Set<String> set) {
        ...
        com.google.gson.internal.a.n("setEditChoicesBeforeSending requires setAllowFreeFormInput");
        throw null;
    }
    ...
    private static String getExtraResultsKeyForData(String str) {
        return a3.a.i(EXTRA_DATA_TYPE_RESULTS_DATA, str);
    }
