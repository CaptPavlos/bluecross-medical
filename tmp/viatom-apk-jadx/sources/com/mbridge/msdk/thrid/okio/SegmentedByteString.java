...
final class SegmentedByteString extends ByteString {
    ...
    public byte getByte(int i10) {
        ...
        int iSegment = segment(i10);
        int i11 = iSegment == 0 ? 0 : this.directory[iSegment - 1];
        int[] iArr = this.directory;
        byte[][] bArr = this.segments;
        return bArr[iSegment][(i10 - i11) + iArr[bArr.length + iSegment]];
    }
    ...
    public boolean rangeEquals(int i10, byte[] bArr, int i11, int i12) {
        ...
        int iSegment = segment(i10);
        while (i12 > 0) {
            int i13 = iSegment == 0 ? 0 : this.directory[iSegment - 1];
            int iMin = Math.min(i12, ((this.directory[iSegment] - i13) + i13) - i10);
            int[] iArr = this.directory;
            byte[][] bArr2 = this.segments;
            if (!Util.arrayRangeEquals(bArr2[iSegment], (i10 - i13) + iArr[bArr2.length + iSegment], bArr, i11, iMin)) {
                return false;
            }
            i10 += iMin;
            i11 += iMin;
    ...
    public boolean rangeEquals(int i10, ByteString byteString, int i11, int i12) {
        ...
        while (i12 > 0) {
            ...
            int[] iArr = this.directory;
            byte[][] bArr = this.segments;
            if (!byteString.rangeEquals(i11, bArr[iSegment], (i10 - i13) + iArr[bArr.length + iSegment], iMin)) {
                return false;
            }
            i10 += iMin;
            i11 += iMin;
