...
public final class e extends b implements Set, Collection {
    ...
    public final boolean add(Object obj) {
        ...
        return this.f9372a.f(entry.getKey(), entry.getValue(), false) == null;
    }
    ...
    public final boolean contains(Object obj) {
        ...
        Object obj2;
        Object value;
        if (!(obj instanceof Map.Entry) || (key = (entry = (Map.Entry) obj).getKey()) == null || (obj2 = this.f9372a.get(key)) == null || (value = entry.getValue()) == null) {
            return false;
        }
    ...
    public final boolean remove(Object obj) {
        ...
        Object key;
        Object value;
        return (obj instanceof Map.Entry) && (key = (entry = (Map.Entry) obj).getKey()) != null && (value = entry.getValue()) != null && this.f9372a.remove(key, value);
    }

    @Override // j$.util.concurrent.b, java.util.Collection, java.lang.Iterable
    public final Iterator iterator() {
        ConcurrentHashMap concurrentHashMap = this.f9372a;
        l[] lVarArr = concurrentHashMap.f9362a;
    ...
    public final boolean addAll(java.util.Collection collection) {
        ...
        while (it.hasNext()) {
            ...
            if (this.f9372a.f(entry.getKey(), entry.getValue(), false) == null) {
                z9 = true;
            }
        }
        return z9;
    ...
    public final void forEach(Consumer consumer) {
        ...
        while (true) {
            ...
            if (lVarA == null) {
                ...
                consumer.n(new k(lVarA.f9382b, lVarA.f9383c, this.f9372a));
            }
        }
    }
}
