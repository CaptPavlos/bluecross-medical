...
public class ConstraintLayout extends ViewGroup {
    ...
    */
    ...
    public boolean dynamicUpdateConstraints(int i10, int i11) {
        ...
        while (i12 < size3) {
            int i13 = i12 + 1;
            ValueModifier valueModifier = arrayList.get(i12);
            ArrayList<ConstraintWidget> children = this.mLayoutWidget.getChildren();
            int size4 = children.size();
            for (int i14 = 0; i14 < size4; i14++) {
                View view = (View) children.get(i14).getCompanionWidget();
    ...
    public void onLayout(boolean z9, int i10, int i11, int i12, int i13) {
        ...
        for (int i14 = 0; i14 < childCount; i14++) {
            ...
            if ((childAt.getVisibility() != 8 || layoutParams.mIsGuideline || layoutParams.mIsHelper || layoutParams.mIsVirtualGroup || zIsInEditMode) && !layoutParams.mIsInPlaceholder) {
                ...
                childAt.layout(x3, y, width, height);
                if ((childAt instanceof Placeholder) && (content = ((Placeholder) childAt).getContent()) != null) {
                    content.setVisibility(0);
                    content.layout(x3, y, width, height);
                }
            }
        }
        int size = this.mConstraintHelpers.size();
    ...
    */
    ...
    @TargetApi(21)
    public ConstraintLayout(@NonNull Context context, @Nullable AttributeSet attributeSet, int i10, int i11) throws XmlPullParserException, IOException, NumberFormatException {
