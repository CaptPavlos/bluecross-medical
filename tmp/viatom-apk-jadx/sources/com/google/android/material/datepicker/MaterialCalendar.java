...
public final class MaterialCalendar<S> extends PickerFragment<S> {
    ...
    private void addActionsToMonthNavigation(@NonNull View view, @NonNull final MonthsPagerAdapter monthsPagerAdapter) {
        ...
        this.recyclerView.addOnScrollListener(new RecyclerView.OnScrollListener() { // from class: com.google.android.material.datepicker.MaterialCalendar.7
            ...
            public void onScrolled(@NonNull RecyclerView recyclerView, int i10, int i11) {
                MaterialCalendar materialCalendar = MaterialCalendar.this;
                int iFindFirstVisibleItemPosition = i10 < 0 ? materialCalendar.getLayoutManager().findFirstVisibleItemPosition() : materialCalendar.getLayoutManager().findLastVisibleItemPosition();
                        ...
                        if (l10 != null && pair.second != null) {
                            ...
                            for (int i10 = spanCount; i10 <= spanCount2; i10++) {
                                ...
                                if (viewFindViewByPosition3 != null) {
                                    ...
                                    canvas.drawRect((i10 != spanCount || viewFindViewByPosition == null) ? 0 : (viewFindViewByPosition.getWidth() / 2) + viewFindViewByPosition.getLeft(), top, (i10 != spanCount2 || viewFindViewByPosition2 == null) ? recyclerView.getWidth() : (viewFindViewByPosition2.getWidth() / 2) + viewFindViewByPosition2.getLeft(), bottom, MaterialCalendar.this.calendarStyle.rangeFill);
                                }
                            }
                        }
                    }
    ...
    public void updateNavigationButtonsEnabled(int i10) {
        this.monthNext.setEnabled(i10 + 1 < this.recyclerView.getAdapter().getItemCount());
        this.monthPrev.setEnabled(i10 - 1 >= 0);
    }
