...
public class FontResourcesParserCompat {
    ...
    public static final class FontFileResourceEntry {
        ...
        public FontFileResourceEntry(@NonNull String str, int i10, boolean z9, @Nullable String str2, int i11, int i12) {
            this.mFileName = str;
            this.mWeight = i10;
            this.mItalic = z9;
    ...
    @NonNull
    public static List<List<byte[]>> readCerts(@NonNull Resources resources, @ArrayRes int i10) throws Resources.NotFoundException {
        if (i10 == 0) {
    ...
    private static FontFileResourceEntry readFont(XmlPullParser xmlPullParser, Resources resources) throws XmlPullParserException, IOException {
        ...
        int i11 = typedArrayObtainAttributes.getInt(i10, NORMAL_WEIGHT);
        ...
        boolean z9 = 1 == typedArrayObtainAttributes.getInt(i12, 0);
        ...
        return new FontFileResourceEntry(string2, i11, z9, string, i15, resourceId);
    }
