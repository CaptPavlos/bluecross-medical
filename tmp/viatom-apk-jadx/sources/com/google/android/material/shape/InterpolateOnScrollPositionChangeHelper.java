...
public class InterpolateOnScrollPositionChangeHelper {
    ...
    public void updateInterpolationForScreenPosition() {
        ...
        if (scrollView.getChildCount() == 0) {
            c.g("Scroll bar must contain a child to calculate interpolation.");
            return;
        }
        ...
        if (i10 > height2) {
            materialShapeDrawable.setInterpolation(Math.max(0.0f, Math.min(1.0f, 1.0f - ((i10 - height2) / height))));
            this.shapedView.invalidate();
