    ...
    public void attach() {
        ...
        if (fragment2 != null) {
            ...
            if (str != null && (fragmentStateManager = this.mFragmentStore.getFragmentStateManager(str)) == null) {
                ...
                androidx.window.layout.c.g(a3.a.o(sb2, this.mFragment.mTargetWho, " that does not belong to this FragmentManager!"));
                return;
            }
        }
    ...
    public int computeExpectedState() {
        ...
        if (fragment2.mFromLayout) {
            ...
            if (z9) {
                ...
                iMin = i11 < 4 ? Math.min(iMin, fragment2.mState) : Math.min(iMin, 1);
            }
        }
        ...
        if (FragmentManager.isLoggingEnabled(2)) {
            StringBuilder sbR = a3.a.r(iMin, "computeExpectedState() of ", " for ");
    ...
    public void createView() throws Resources.NotFoundException {
        ...
        if (viewGroup == null) {
            ...
            if (i10 == 0) {
                ...
                if (i10 == -1) {
                    androidx.constraintlayout.core.state.b.j(this.mFragment, "Cannot create fragment ", " for a container view with no id");
                    return;
                }
        ...
        try {
            ...
            while (true) {
                ...
                if (iComputeExpectedState == i10) {
                    if (!z9 && i10 == -1 && fragment.mRemoving && !fragment.isInBackStack() && !this.mFragment.mBeingSaved) {
                        if (FragmentManager.isLoggingEnabled(3)) {
