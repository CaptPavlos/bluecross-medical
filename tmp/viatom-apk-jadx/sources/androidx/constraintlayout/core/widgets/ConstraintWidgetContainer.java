...
public class ConstraintWidgetContainer extends WidgetContainer {
    ...
    public boolean addChildrenToSolver(LinearSystem linearSystem) {
        ...
        if (LinearSystem.USE_DEPENDENCY_ORDERING) {
            ...
            for (int i14 = 0; i14 < size; i14++) {
                ConstraintWidget constraintWidget5 = constraintWidgetContainer.mChildren.get(i14);
    ...
    /* JADX WARN: Removed duplicated region for block: B:132:0x0242 A[ADDED_TO_REGION] */
    ...
    /* JADX WARN: Removed duplicated region for block: B:168:0x032f A[PHI: r13 r19
      0x032f: PHI (r13v9 boolean) = (r13v8 boolean), (r13v11 boolean), (r13v11 boolean), (r13v11 boolean) binds: [B:154:0x02eb, B:163:0x0314, B:164:0x0316, B:166:0x031c] A[DONT_GENERATE, DONT_INLINE]
      0x032f: PHI (r19v4 boolean) = (r19v3 boolean), (r19v6 boolean), (r19v6 boolean), (r19v6 boolean) binds: [B:154:0x02eb, B:163:0x0314, B:164:0x0316, B:166:0x031c] A[DONT_GENERATE, DONT_INLINE]] */
