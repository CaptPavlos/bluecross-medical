...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
        ...
        public boolean onTouchEvent(MotionEvent motionEvent) {
            ...
            if (action != 0) {
                if (action == 1 || action == 2) {
                    ...
                    if (z10 && !this.mSlopBounds.contains(x3, y)) {
                        z11 = z10;
                        z9 = false;
                    }
                } else {
                ...
                z11 = z10;
                z9 = true;
            } else if (this.mTargetBounds.contains(x3, y)) {
            ...
            if (!z9 || this.mActualBounds.contains(x3, y)) {
    ...
    public void adjustDropDownSizeAndPosition() {
        if (this.mDropDownAnchor.getWidth() > 1) {
            ...
            int i10 = rect.left;
            this.mSearchSrcTextView.setDropDownHorizontalOffset(zIsLayoutRtl ? -i10 : paddingLeft - (i10 + dimensionPixelSize));
    ...
    public boolean onSuggestionsKey(View view, int i10, KeyEvent keyEvent) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
    ...
    public static class SearchAutoComplete extends AppCompatAutoCompleteTextView {
        ...
        public void onFocusChanged(boolean z9, int i10, Rect rect) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        ...
        @Override // android.widget.AutoCompleteTextView, android.widget.TextView, android.view.View
        public void onWindowFocusChanged(boolean z9) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
            super.onWindowFocusChanged(z9);
