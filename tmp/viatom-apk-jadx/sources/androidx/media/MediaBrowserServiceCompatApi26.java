...
class MediaBrowserServiceCompatApi26 {
    ...
    public static class ResultWrapper {
        ...
        public void sendResult(List<Parcel> list, int i10) throws IllegalAccessException, IllegalArgumentException {
            try {
                MediaBrowserServiceCompatApi26.sResultFlags.setInt(this.mResultObj, i10);
