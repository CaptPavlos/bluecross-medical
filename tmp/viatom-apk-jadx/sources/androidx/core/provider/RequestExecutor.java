...
class RequestExecutor {
    ...
    public static ThreadPoolExecutor createDefaultExecutor(@NonNull String str, int i10, @IntRange(from = FabTransformationScrimBehavior.COLLAPSE_DELAY) int i11) {
    ...
    public static <T> T submit(@NonNull ExecutorService executorService, @NonNull Callable<T> callable, @IntRange(from = FabTransformationScrimBehavior.COLLAPSE_DELAY) int i10) throws InterruptedException {
        try {
