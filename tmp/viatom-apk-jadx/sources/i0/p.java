...
public abstract class p {
    ...
    public static final SimpleArrayMap f8937a = new SimpleArrayMap();

    /* renamed from: b, reason: collision with root package name */
    public static Locale f8938b;

    public static String a(Context context) {
        String packageName = context.getPackageName();
        try {
            Context context2 = p0.c.a(context).f11875a;
    ...
    public static String b(Context context, int i10) {
        ...
        if (i10 == 2) {
            return n0.b.c(context) ? resources.getString(R.string.common_google_play_services_wear_update_text) : resources.getString(R.string.common_google_play_services_update_text, strA);
        }
        if (i10 == 3) {
    ...
    public static String e(Context context, String str) {
        ...
        SimpleArrayMap simpleArrayMap = f8937a;
        synchronized (simpleArrayMap) {
            try {
                Locale locale = ConfigurationCompat.getLocales(context.getResources().getConfiguration()).get(0);
                if (!locale.equals(f8938b)) {
