...
class TooltipPopup {
    ...
    private void computePosition(View view, int i10, int i11, boolean z9, WindowManager.LayoutParams layoutParams) throws Resources.NotFoundException {
        int height;
        int i12;
    ...
    public void show(View view, int i10, int i11, boolean z9, CharSequence charSequence) throws Resources.NotFoundException {
        if (isShowing()) {
            hide();
        }
        this.mMessageView.setText(charSequence);
        computePosition(view, i10, i11, z9, this.mLayoutParams);
