...
public class MotionWidget implements TypedValues {
    ...
    */
    public int getId(java.lang.String r3) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.constraintlayout.core.motion.MotionWidget.getId(java.lang.String):int");
    }
    ...
    public void setCustomAttribute(String str, int i10, float f) {
        this.mWidgetFrame.setCustomAttribute(str, i10, f);
    }
    ...
    public boolean setValueAttributes(int i10, float f) {
        switch (i10) {
            case 303:
    ...
    public void setCustomAttribute(String str, int i10, boolean z9) {
        this.mWidgetFrame.setCustomAttribute(str, i10, z9);
    }
    ...
    public boolean setValue(int i10, float f) {
        if (setValueAttributes(i10, f)) {
            return true;
        }
        return setValueMotion(i10, f);
    }
    ...
    public boolean setValueMotion(int i10, float f) {
        switch (i10) {
            case 600:
