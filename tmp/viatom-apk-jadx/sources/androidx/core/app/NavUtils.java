...
public final class NavUtils {
    ...
    public static void navigateUpFromSameTask(@NonNull Activity activity) {
        ...
        if (parentActivityIntent != null) {
            ...
            androidx.constraintlayout.core.state.b.j(activity.getClass().getSimpleName(), "Activity ", " does not have a parent activity name specified. (Did you forget to add the android.support.PARENT_ACTIVITY <meta-data>  element in your manifest?)");
        }
    }
