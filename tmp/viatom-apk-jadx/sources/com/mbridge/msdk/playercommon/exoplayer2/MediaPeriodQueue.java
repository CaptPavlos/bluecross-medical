...
final class MediaPeriodQueue {
    ...
    private MediaPeriodInfo getFollowingMediaPeriodInfo(MediaPeriodHolder mediaPeriodHolder, long j10) {
        ...
        if (mediaPeriodInfo.isLastInTimelinePeriod) {
            ...
            long j13 = jLongValue;
            return getMediaPeriodInfo(resolveMediaPeriodIdForAds(nextPeriodIndex, j13, j12), j13, j13);
        }
        ...
        if (j14 != Long.MIN_VALUE) {
            int adGroupIndexForPositionUs = period.getAdGroupIndexForPositionUs(j14);
    ...
    private boolean isLastInTimeline(MediaSource.MediaPeriodId mediaPeriodId, boolean z9) {
        return !this.timeline.getWindow(this.timeline.getPeriod(mediaPeriodId.periodIndex, this.period).windowIndex, this.window).isDynamic && this.timeline.isLastPeriod(mediaPeriodId.periodIndex, this.period, this.window, this.repeatMode, this.shuffleModeEnabled) && z9;
    }
    ...
    public final void clear(boolean z9) {
        MediaPeriodHolder frontPeriod = getFrontPeriod();
        if (frontPeriod != null) {
            this.oldFrontPeriodUid = z9 ? frontPeriod.uid : null;
    ...
    @Nullable
    public final MediaPeriodInfo getNextMediaPeriodInfo(long j10, PlaybackInfo playbackInfo) {
        MediaPeriodHolder mediaPeriodHolder = this.loading;
    ...
    public final boolean updateQueuedPeriods(MediaSource.MediaPeriodId mediaPeriodId, long j10) {
    ...
    public final boolean updateShuffleModeEnabled(boolean z9) {
        this.shuffleModeEnabled = z9;
        return updateForPlaybackModeChange();
    }

    public final MediaSource.MediaPeriodId resolveMediaPeriodIdForAds(int i10, long j10) {
