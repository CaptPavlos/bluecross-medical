...
public class SwitchCompat extends CompoundButton implements EmojiCompatConfigurationView {
    ...
    private boolean hitThumb(float f, float f10) {
        ...
        Rect rect = this.mTempRect;
        return f > ((float) i13) && f < ((float) (((i14 + rect.left) + rect.right) + i11)) && f10 > ((float) i12) && f10 < ((float) (this.mSwitchBottom + i11));
    }
    ...
    */
    ...
    public void setChecked(boolean z9) throws Resources.NotFoundException {
        super.setChecked(z9);
        boolean zIsChecked = isChecked();
        if (zIsChecked) {
