...
public class LinearLayoutCompat extends ViewGroup {
    ...
    */
    ...
    public int getBaseline() {
        ...
        if (childCount <= i11) {
            a2.a.j("mBaselineAlignedChildIndex of LinearLayout set to an index that is out of bounds.");
            return 0;
        }
        ...
        if (baseline == -1) {
            ...
            a2.a.j("mBaselineAlignedChildIndex of LinearLayout points to a View that doesn't know how to get its baseline.");
            return 0;
        }
