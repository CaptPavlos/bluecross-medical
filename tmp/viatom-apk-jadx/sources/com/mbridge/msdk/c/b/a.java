...
public class a {
    ...
    private String c() {
        try {
            ...
            return (file.exists() && file.canRead()) ? ad.b(file) : "";
        } catch (Exception e) {
            af.a("MraidJSController", e.getMessage());
            return "";
        }
    }
            ...
            try {
                new com.mbridge.msdk.c.a.a(context).get(0, str, (com.mbridge.msdk.foundation.same.net.f.e) null, new com.mbridge.msdk.foundation.same.net.b.a() { // from class: com.mbridge.msdk.c.b.a.1
                    ...
                    public final void a(String str2) {
                        androidx.constraintlayout.core.widgets.analyzer.a.E("fail request mraid js. ", str2, "MraidJSController");
                    }

                    @Override // com.mbridge.msdk.foundation.same.net.b.a
                    public final void b(String str2) {
                        af.a("MraidJSController", "request mraid js success, content = " + str2);
                ...
                af.b("MraidJSController", e.getMessage());
            }
        }
    }
    ...
    public final String b() {
        try {
            ...
            if (gVarB != null && !TextUtils.isEmpty(gVarB.U())) {
                a(com.mbridge.msdk.foundation.controller.c.m().c(), gVarB.U());
            }
            return f2665a;
