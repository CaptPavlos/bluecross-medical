...
final class MultiDexExtractor implements Closeable {
    ...
    private static boolean isModified(Context context, File file, long j10, String str) {
        ...
        sb.append(str);
        sb.append(KEY_CRC);
        return multiDexPreferences.getLong(sb.toString(), -1L) != j10;
    }
    ...
    private static void putStoredApkInfo(Context context, String str, long j10, long j11, List<ExtractedDex> list) {
        ...
        editorEdit.putLong(a.o(new StringBuilder(), str, KEY_CRC), j11);
    ...
    public List<? extends File> load(Context context, String str, boolean z9) throws IOException {
        ...
        if (!this.cacheLock.isValid()) {
            c.g("MultiDexExtractor was closed");
            return null;
        }
