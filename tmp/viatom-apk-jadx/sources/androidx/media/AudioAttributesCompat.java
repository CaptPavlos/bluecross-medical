...
public class AudioAttributesCompat implements VersionedParcelable {
    ...
    public static int toVolumeStreamType(boolean z9, int i10, int i11) {
        if ((i10 & 1) == 1) {
            return z9 ? 1 : 7;
        }
        if ((i10 & 4) == 4) {
        ...
        switch (i11) {
            ...
            default:
                ...
                com.google.gson.internal.a.n(a3.a.g(i11, "Unknown usage value ", " in audio attributes"));
                return 0;
        }
    }
    ...
    public static String usageToString(int i10) {
        switch (i10) {
            ...
            case 15:
            default:
                return a3.a.f(i10, "unknown usage ");
            case 16:
    ...
    public static class Builder {
        ...
        public Builder setLegacyStreamType(int i10) {
            ...
            com.google.gson.internal.a.n("STREAM_ACCESSIBILITY is not a legacy stream type that was used for audio playback");
            return null;
        }
