...
class LoadingIndicatorDrawingDelegate {
    ...
    static {
        ...
        while (true) {
            ...
            int i11 = i10 + 1;
            INDETERMINATE_MORPH_SEQUENCE[i10] = new Morph(roundedPolygonArr2[i10], roundedPolygonArr2[i11 % roundedPolygonArr2.length]);
            i10 = i11;
        }
    }
    ...
    public void drawContainer(@NonNull Canvas canvas, @NonNull Paint paint, @ColorInt int i10, @IntRange(from = FabTransformationScrimBehavior.COLLAPSE_DELAY, to = ScatterMapKt.Sentinel) int i11) {
    ...
    public void drawIndicator(@NonNull Canvas canvas, @NonNull Paint paint, @NonNull IndicatorState indicatorState, @IntRange(from = FabTransformationScrimBehavior.COLLAPSE_DELAY, to = ScatterMapKt.Sentinel) int i10) {
        paint.setColor(MaterialColors.compositeARGBWithAlpha(indicatorState.color, i10));
        paint.setStyle(Paint.Style.FILL);
        canvas.save();
        ...
        int i11 = this.specs.indicatorSize;
