...
public final class MediaCodecUtil {
    ...
    public static final class CodecKey {
        ...
        public CodecKey(String str, boolean z9) {
            this.mimeType = str;
            this.secure = z9;
        }
    ...
    static {
        ...
        a.n(1, map, "L30", 4, "L60");
        a.n(16, map, "L63", 64, "L90");
        a.n(256, map, "L93", 1024, "L120");
        a.n(4096, map, "L123", 16384, "L150");
        a.n(65536, map, "L153", 262144, "L156");
        a.n(1048576, map, "L180", 4194304, "L183");
        a.n(16777216, map, "L186", 2, "H30");
        a.n(8, map, "H60", 32, "H63");
        a.n(128, map, "H90", 512, "H93");
        a.n(2048, map, "H120", 8192, "H123");
        a.n(32768, map, "H150", 131072, "H153");
        a.n(524288, map, "H156", 2097152, "H180");
        a.n(8388608, map, "H183", 33554432, "H186");
    }
    ...
    */
    ...
    @Nullable
    public static MediaCodecInfo getDecoderInfo(String str, boolean z9) throws DecoderQueryException {
        List<MediaCodecInfo> decoderInfos = getDecoderInfos(str, z9);
    ...
    public static synchronized List<MediaCodecInfo> getDecoderInfos(String str, boolean z9) throws DecoderQueryException {
        try {
            CodecKey codecKey = new CodecKey(str, z9);
            ...
            MediaCodecListCompat mediaCodecListCompatV21 = i10 >= 21 ? new MediaCodecListCompatV21(z9) : new MediaCodecListCompatV16();
            ArrayList<MediaCodecInfo> decoderInfosInternal = getDecoderInfosInternal(codecKey, mediaCodecListCompatV21, str);
            if (z9 && decoderInfosInternal.isEmpty() && 21 <= i10 && i10 <= 23) {
    ...
    */
    ...
    public static void warmDecoderInfoCache(String str, boolean z9) {
        try {
            getDecoderInfos(str, z9);
