...
final class AudioTrackPositionTracker {
    ...
    public final int getAvailableBufferSize(long j10) {
    ...
    public final long getCurrentPositionUs(boolean z9) {
        ...
        return !z9 ? playbackHeadPositionUs - this.latencyUs : playbackHeadPositionUs;
    }

    public final void handleEndOfStream(long j10) {
        this.stopPlaybackHeadPosition = getPlaybackHeadPosition();
        this.stopTimestampUs = SystemClock.elapsedRealtime() * 1000;
        this.endPlaybackHeadPosition = j10;
    }

    public final boolean hasPendingData(long j10) {
    ...
    public final boolean isStalled(long j10) {
    ...
    public final boolean mayHandleBuffer(long j10) {
        Listener listener;
        int playState = this.audioTrack.getPlayState();
        if (this.needsPassthroughWorkarounds) {
            if (playState == 2) {
        ...
        if (z9 && !zHasPendingData && playState != 1 && (listener = this.listener) != null) {
