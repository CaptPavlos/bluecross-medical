...
public abstract class c {
    ...
    public static void f(AccessibleObject accessibleObject) {
        try {
            ...
            StringBuilder sbY = a3.a.y("Failed making ", d(accessibleObject, false), " accessible; either increase its visibility or write a custom TypeAdapter for its declaring type.");
            sbY.append(e(e));
            throw new e(sbY.toString(), e);
        }
    }
}
