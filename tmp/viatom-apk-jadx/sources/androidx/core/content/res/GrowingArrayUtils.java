...
final class GrowingArrayUtils {
    ...
    public static <T> T[] append(T[] tArr, int i10, T t) {
    ...
    public static <T> T[] insert(T[] tArr, int i10, int i11, T t) {
        if (i10 + 1 <= tArr.length) {
    ...
    public static boolean[] append(boolean[] zArr, int i10, boolean z9) {
    ...
    public static boolean[] insert(boolean[] zArr, int i10, int i11, boolean z9) {
        if (i10 + 1 <= zArr.length) {
