...
public final class AmrExtractor implements Extractor {
    ...
    private int getFrameSizeInBytes(int i10) throws ParserException {
        boolean zIsValidFrameType = isValidFrameType(i10);
        boolean z9 = this.isWideBand;
        if (zIsValidFrameType) {
            return z9 ? frameSizeBytesByTypeWb[i10] : frameSizeBytesByTypeNb[i10];
        }
    ...
    private void maybeOutputFormat() {
        ...
        boolean z9 = this.isWideBand;
        this.trackOutput.format(Format.createAudioSampleFormat(null, z9 ? MimeTypes.AUDIO_AMR_WB : MimeTypes.AUDIO_AMR_NB, null, -1, MAX_FRAME_SIZE_BYTES, 1, z9 ? SAMPLE_RATE_WB : 8000, -1, null, null, 0, null));
    }
    ...
    private int readNextSampleSize(ExtractorInput extractorInput) throws InterruptedException, IOException {
        ...
        a.i(a3.a.f(b10, "Invalid padding bits for frame header "));
        return 0;
    }
