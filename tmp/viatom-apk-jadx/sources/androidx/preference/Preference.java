...
public class Preference implements Comparable<Preference> {
    ...
    public void assignParent(@Nullable PreferenceGroup preferenceGroup) {
        if (preferenceGroup == null || this.mParentGroup == null) {
            ...
            c.g("This preference already has a parent. You must remove the existing parent before assigning a new one.");
        }
    }
    ...
    public void dispatchRestoreInstanceState(@NonNull Bundle bundle) {
        ...
        c.g("Derived class did not call super.onRestoreInstanceState()");
    }
    ...
    public void dispatchSaveInstanceState(@NonNull Bundle bundle) {
        if (hasKey()) {
            ...
            if (!this.mBaseMethodCalled) {
                c.g("Derived class did not call super.onSaveInstanceState()");
    ...
    public void onRestoreInstanceState(@Nullable Parcelable parcelable) {
        ...
        com.google.gson.internal.a.n("Wrong state class -- expecting Preference State");
    }
    ...
    public void requireKey() {
        if (TextUtils.isEmpty(this.mKey)) {
            c.g("Preference does not have a key assigned.");
        } else {
    ...
    public void setSummary(@Nullable CharSequence charSequence) {
        if (getSummaryProvider() != null) {
            c.g("Preference already has a SummaryProvider set.");
        } else {
