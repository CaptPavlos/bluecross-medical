...
public class AppCompatTextView extends TextView implements TintableBackgroundView, TintableCompoundDrawablesView, AutoSizeableTextView, EmojiCompatConfigurationView {
    ...
    public interface SuperCaller {
        ...
        void setLineHeight(int i10, @FloatRange(from = 0.0d) float f);
    ...
    public class SuperCallerApi34 extends SuperCallerApi28 {
        ...
        @Override // androidx.appcompat.widget.AppCompatTextView.SuperCallerApi26, androidx.appcompat.widget.AppCompatTextView.SuperCaller
        public void setLineHeight(int i10, float f) {
            AppCompatTextView.super.setLineHeight(i10, f);
        }
    }
    ...
    public void onLayout(boolean z9, int i10, int i11, int i12, int i13) {
        ...
        AppCompatTextHelper appCompatTextHelper = this.mTextHelper;
        if (appCompatTextHelper != null) {
            appCompatTextHelper.onLayout(z9, i10, i11, i12, i13);
        }
    }
    ...
    @Override // android.widget.TextView
    public void setFirstBaselineToTopHeight(@IntRange(from = FabTransformationScrimBehavior.COLLAPSE_DELAY) @Px int i10) {
    ...
    @Override // android.widget.TextView
    public void setLastBaselineToBottomHeight(@IntRange(from = FabTransformationScrimBehavior.COLLAPSE_DELAY) @Px int i10) {
        if (Build.VERSION.SDK_INT >= 28) {
    ...
    @Override // android.widget.TextView
    public void setLineHeight(int i10, @FloatRange(from = 0.0d) float f) {
        if (Build.VERSION.SDK_INT >= 34) {
            getSuperCaller().setLineHeight(i10, f);
        } else {
            TextViewCompat.setLineHeight(this, i10, f);
        }
    }
    ...
    public void setTextSize(int i10, float f) {
        ...
        AppCompatTextHelper appCompatTextHelper = this.mTextHelper;
        if (appCompatTextHelper != null) {
            appCompatTextHelper.setTextSize(i10, f);
        }
    }
    ...
    @Override // android.widget.TextView
    public void setLineHeight(@IntRange(from = FabTransformationScrimBehavior.COLLAPSE_DELAY) @Px int i10) {
